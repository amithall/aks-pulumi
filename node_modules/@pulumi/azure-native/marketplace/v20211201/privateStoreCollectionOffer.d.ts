 ...
 */
export declare class PrivateStoreCollectionOffer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateStoreCollectionOffer;
    /**
     ...
     */
    static isInstance(obj: any): obj is PrivateStoreCollectionOffer;
    /**
     ...
     * Offer plans
     */
    readonly plans: pulumi.Output<outputs.marketplace.v20211201.PlanResponse[] | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.marketplace.v20211201.SystemDataResponse>;
    /**
...
export interface PrivateStoreCollectionOfferArgs {
     ...
     * Offer plans
     */
    plans?: pulumi.Input<pulumi.Input<inputs.marketplace.v20211201.PlanArgs>[]>;
    /**
