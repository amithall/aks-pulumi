...
export declare class ScriptExecution extends pulumi.CustomResource {
     ...
     */
    readonly hiddenParameters: pulumi.Output<(outputs.avs.v20211201.PSCredentialExecutionParameterResponse | outputs.avs.v20211201.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20211201.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
     ...
     */
    readonly parameters: pulumi.Output<(outputs.avs.v20211201.PSCredentialExecutionParameterResponse | outputs.avs.v20211201.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20211201.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
...
export interface ScriptExecutionArgs {
     ...
     * Parameters that will be hidden/not visible to ARM, such as passwords and credentials
     */
    hiddenParameters?: pulumi.Input<pulumi.Input<inputs.avs.v20211201.PSCredentialExecutionParameterArgs | inputs.avs.v20211201.ScriptSecureStringExecutionParameterArgs | inputs.avs.v20211201.ScriptStringExecutionParameterArgs>[]>;
    /**
     * User-defined dictionary.
     */
     ...
     * Parameters the script will accept
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.avs.v20211201.PSCredentialExecutionParameterArgs | inputs.avs.v20211201.ScriptSecureStringExecutionParameterArgs | inputs.avs.v20211201.ScriptStringExecutionParameterArgs>[]>;
    /**
