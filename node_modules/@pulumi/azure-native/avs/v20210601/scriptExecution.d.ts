...
export declare class ScriptExecution extends pulumi.CustomResource {
     ...
     */
    readonly hiddenParameters: pulumi.Output<(outputs.avs.v20210601.PSCredentialExecutionParameterResponse | outputs.avs.v20210601.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20210601.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
     ...
     */
    readonly parameters: pulumi.Output<(outputs.avs.v20210601.PSCredentialExecutionParameterResponse | outputs.avs.v20210601.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20210601.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
