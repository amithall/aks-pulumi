 ...
 */
export declare class WebPubSubSharedPrivateLinkResource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebPubSubSharedPrivateLinkResource;
    /**
     ...
     */
    static isInstance(obj: any): obj is WebPubSubSharedPrivateLinkResource;
    /**
