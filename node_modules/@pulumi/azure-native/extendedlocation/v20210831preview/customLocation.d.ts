...
export declare class CustomLocation extends pulumi.CustomResource {
     ...
     */
    readonly authentication: pulumi.Output<outputs.extendedlocation.v20210831preview.CustomLocationPropertiesResponseAuthentication | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.extendedlocation.v20210831preview.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.extendedlocation.v20210831preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface CustomLocationArgs {
     ...
     * This is optional input that contains the authentication that should be used to generate the namespace.
     */
    authentication?: pulumi.Input<inputs.extendedlocation.v20210831preview.CustomLocationPropertiesAuthenticationArgs>;
    /**
     * Contains the reference to the add-on that contains charts to deploy CRDs and operators.
     */
     ...
     * Type of host the Custom Locations is referencing (Kubernetes, etc...).
     */
    hostType?: pulumi.Input<string | enums.extendedlocation.v20210831preview.HostType>;
    /**
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.extendedlocation.v20210831preview.IdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
