...
export declare class Service extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.search.v20191001preview.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly networkRuleSet: pulumi.Output<outputs.search.v20191001preview.NetworkRuleSetResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.search.v20191001preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.search.v20191001preview.SkuResponse | undefined>;
    /**
...
export interface ServiceArgs {
     ...
     * Applicable only for the standard3 SKU. You can set this property to enable up to 3 high density partitions that allow up to 1000 indexes, which is much higher than the maximum indexes allowed for any other SKU. For the standard3 SKU, the value is either 'default' or 'highDensity'. For all other SKUs, this value must be 'default'.
     */
    hostingMode?: pulumi.Input<enums.search.v20191001preview.HostingMode>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.search.v20191001preview.IdentityArgs>;
    /**
     * The geographic location of the resource. This must be one of the supported and registered Azure Geo Regions (for example, West US, East US, Southeast Asia, and so forth). This property is required when creating a new resource.
     */
     ...
     * Network specific rules that determine how the Azure Cognitive Search service may be reached.
     */
    networkRuleSet?: pulumi.Input<inputs.search.v20191001preview.NetworkRuleSetArgs>;
    /**
     * The number of partitions in the Search service; if specified, it can be 1, 2, 3, 4, 6, or 12. Values greater than 1 are only valid for standard SKUs. For 'standard3' services with hostingMode set to 'highDensity', the allowed values are between 1 and 3.
     */
     ...
     * The SKU of the Search Service, which determines price tier and capacity limits. This property is required when creating a new Search Service.
     */
    sku?: pulumi.Input<inputs.search.v20191001preview.SkuArgs>;
    /**
     * Tags to help categorize the resource in the Azure portal.
     */
    tags?: pulumi.Input<{
