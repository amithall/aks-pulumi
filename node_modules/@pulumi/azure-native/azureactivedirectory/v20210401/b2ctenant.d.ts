...
export declare class B2CTenant extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): B2CTenant;
    /**
     * Returns true if the given object is an instance of B2CTenant.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is B2CTenant;
    /**
     * The billing configuration for the tenant.
     */
    readonly billingConfig: pulumi.Output<outputs.azureactivedirectory.v20210401.B2CTenantResourcePropertiesResponseBillingConfig | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.azureactivedirectory.v20210401.B2CResourceSKUResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: pulumi.Output<outputs.azureactivedirectory.v20210401.SystemDataResponse>;
    /**
     * Resource Tags
     */
...
export interface B2CTenantArgs {
     ...
     * SKU properties of the Azure AD B2C tenant. Learn more about Azure AD B2C billing at [aka.ms/b2cBilling](https://aka.ms/b2cBilling).
     */
    sku: pulumi.Input<inputs.azureactivedirectory.v20210401.B2CResourceSKUArgs>;
    /**
     * Resource Tags
     */
    tags?: pulumi.Input<{
