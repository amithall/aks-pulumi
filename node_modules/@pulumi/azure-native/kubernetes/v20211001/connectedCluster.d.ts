...
export declare class ConnectedCluster extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.kubernetes.v20211001.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.kubernetes.v20211001.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ConnectedClusterArgs {
     ...
     * The identity of the connected cluster.
     */
    identity: pulumi.Input<inputs.kubernetes.v20211001.ConnectedClusterIdentityArgs>;
    /**
     * The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
     */
     ...
     * Provisioning state of the connected cluster resource.
     */
    provisioningState?: pulumi.Input<string | enums.kubernetes.v20211001.ProvisioningState>;
    /**
