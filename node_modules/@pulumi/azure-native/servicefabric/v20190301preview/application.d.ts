...
export declare class Application extends pulumi.CustomResource {
     ...
     */
    readonly metrics: pulumi.Output<outputs.servicefabric.v20190301preview.ApplicationMetricDescriptionResponse[] | undefined>;
    /**
     ...
     */
    readonly upgradePolicy: pulumi.Output<outputs.servicefabric.v20190301preview.ApplicationUpgradePolicyResponse | undefined>;
    /**
...
export interface ApplicationArgs {
     ...
     * List of application capacity metric description.
     */
    metrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20190301preview.ApplicationMetricDescriptionArgs>[]>;
    /**
     * The minimum number of nodes where Service Fabric will reserve capacity for this application. Note that this does not mean that the services of this application will be placed on all of those nodes. If this property is set to zero, no capacity will be reserved. The value of this property cannot be more than the value of the MaximumNodes property.
     */
     ...
     * Describes the policy for a monitored application upgrade.
     */
    upgradePolicy?: pulumi.Input<inputs.servicefabric.v20190301preview.ApplicationUpgradePolicyArgs>;
}
