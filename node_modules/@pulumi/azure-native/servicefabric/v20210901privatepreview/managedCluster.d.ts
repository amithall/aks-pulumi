...
export declare class ManagedCluster extends pulumi.CustomResource {
     ...
     */
    readonly applicationTypeVersionsCleanupPolicy: pulumi.Output<outputs.servicefabric.v20210901privatepreview.ApplicationTypeVersionsCleanupPolicyResponse | undefined>;
    /**
     * The AAD authentication settings of the cluster.
     */
    readonly azureActiveDirectory: pulumi.Output<outputs.servicefabric.v20210901privatepreview.AzureActiveDirectoryResponse | undefined>;
    /**
     ...
     */
    readonly clients: pulumi.Output<outputs.servicefabric.v20210901privatepreview.ClientCertificateResponse[] | undefined>;
    /**
     ...
     */
    readonly fabricSettings: pulumi.Output<outputs.servicefabric.v20210901privatepreview.SettingsSectionDescriptionResponse[] | undefined>;
    /**
     ...
     */
    readonly ipTags: pulumi.Output<outputs.servicefabric.v20210901privatepreview.IPTagResponse[] | undefined>;
    /**
     ...
     */
    readonly loadBalancingRules: pulumi.Output<outputs.servicefabric.v20210901privatepreview.LoadBalancingRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly networkSecurityRules: pulumi.Output<outputs.servicefabric.v20210901privatepreview.NetworkSecurityRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.servicefabric.v20210901privatepreview.SkuResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.servicefabric.v20210901privatepreview.SystemDataResponse>;
    /**
     * Azure resource tags.
     */
...
export interface ManagedClusterArgs {
     ...
     * The policy used to clean up unused versions.
     */
    applicationTypeVersionsCleanupPolicy?: pulumi.Input<inputs.servicefabric.v20210901privatepreview.ApplicationTypeVersionsCleanupPolicyArgs>;
    /**
     * The AAD authentication settings of the cluster.
     */
    azureActiveDirectory?: pulumi.Input<inputs.servicefabric.v20210901privatepreview.AzureActiveDirectoryArgs>;
    /**
     * The port used for client connections to the cluster.
     */
     ...
     * Client certificates that are allowed to manage the cluster.
     */
    clients?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210901privatepreview.ClientCertificateArgs>[]>;
    /**
     * The Service Fabric runtime version of the cluster. This property is required when **clusterUpgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
     */
     ...
     * Indicates when new cluster runtime version upgrades will be applied after they are released. By default is Wave0. Only applies when **clusterUpgradeMode** is set to 'Automatic'.
     */
    clusterUpgradeCadence?: pulumi.Input<string | enums.servicefabric.v20210901privatepreview.ClusterUpgradeCadence>;
    /**
     * The upgrade mode of the cluster when new Service Fabric runtime version is available.
     */
    clusterUpgradeMode?: pulumi.Input<string | enums.servicefabric.v20210901privatepreview.ClusterUpgradeMode>;
    /**
     * The cluster dns name.
     */
     ...
     * The list of custom fabric settings to configure the cluster.
     */
    fabricSettings?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210901privatepreview.SettingsSectionDescriptionArgs>[]>;
    /**
     * The port used for HTTP connections to the cluster.
     */
     ...
     * The list of IP tags associated with the default public IP address of the cluster.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210901privatepreview.IPTagArgs>[]>;
    /**
     * Load balancing rules that are applied to the public load balancer of the cluster.
     */
    loadBalancingRules?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210901privatepreview.LoadBalancingRuleArgs>[]>;
    /**
     * Azure resource location.
     */
     ...
     * The sku of the managed cluster
     */
    sku?: pulumi.Input<inputs.servicefabric.v20210901privatepreview.SkuArgs>;
    /**
     * If specified, the node types for the cluster are created in this subnet instead of the default VNet. The **networkSecurityRules** specified for the cluster are also applied to this subnet. This setting cannot be changed once the cluster is created.
     */
