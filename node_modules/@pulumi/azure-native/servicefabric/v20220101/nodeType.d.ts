...
export declare class NodeType extends pulumi.CustomResource {
     ...
     */
    readonly additionalDataDisks: pulumi.Output<outputs.servicefabric.v20220101.VmssDataDiskResponse[] | undefined>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    readonly applicationPorts: pulumi.Output<outputs.servicefabric.v20220101.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly ephemeralPorts: pulumi.Output<outputs.servicefabric.v20220101.EndpointRangeDescriptionResponse | undefined>;
    /**
     * Indicates the node type uses its own frontend configurations instead of the default one for the cluster. This setting can only be specified for non-primary node types and can not be added or removed after the node type is created.
     */
    readonly frontendConfigurations: pulumi.Output<outputs.servicefabric.v20220101.FrontendConfigurationResponse[] | undefined>;
    /**
     ...
     * The node type sku.
     */
    readonly sku: pulumi.Output<outputs.servicefabric.v20220101.NodeTypeSkuResponse | undefined>;
    /**
     ...
     */
    readonly vmExtensions: pulumi.Output<outputs.servicefabric.v20220101.VMSSExtensionResponse[] | undefined>;
    /**
     ...
     */
    readonly vmManagedIdentity: pulumi.Output<outputs.servicefabric.v20220101.VmManagedIdentityResponse | undefined>;
    /**
     * The secrets to install in the virtual machines.
     */
    readonly vmSecrets: pulumi.Output<outputs.servicefabric.v20220101.VaultSecretGroupResponse[] | undefined>;
    /**
...
export interface NodeTypeArgs {
     ...
     * Additional managed data disks.
     */
    additionalDataDisks?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.VmssDataDiskArgs>[]>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    applicationPorts?: pulumi.Input<inputs.servicefabric.v20220101.EndpointRangeDescriptionArgs>;
    /**
     * The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much resource a node has.
     */
     ...
     * Managed data disk type. Specifies the storage account type for the managed disk
     */
    dataDiskType?: pulumi.Input<string | enums.servicefabric.v20220101.DiskType>;
    /**
     * Specifies whether the network interface is accelerated networking-enabled.
     */
     ...
     * The range of ephemeral ports that nodes in this node type should be configured with.
     */
    ephemeralPorts?: pulumi.Input<inputs.servicefabric.v20220101.EndpointRangeDescriptionArgs>;
    /**
     * Indicates the node type uses its own frontend configurations instead of the default one for the cluster. This setting can only be specified for non-primary node types and can not be added or removed after the node type is created.
     */
    frontendConfigurations?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.FrontendConfigurationArgs>[]>;
    /**
     * Indicates the Service Fabric system services for the cluster will run on this node type. This setting cannot be changed once the node type is created.
     */
     ...
     * The node type sku.
     */
    sku?: pulumi.Input<inputs.servicefabric.v20220101.NodeTypeSkuArgs>;
    /**
     * Azure resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * Set of extensions that should be installed onto the virtual machines.
     */
    vmExtensions?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.VMSSExtensionArgs>[]>;
    /**
     * The offer type of the Azure Virtual Machines Marketplace image. For example, UbuntuServer or WindowsServer.
     */
     ...
     * Identities to assign to the virtual machine scale set under the node type.
     */
    vmManagedIdentity?: pulumi.Input<inputs.servicefabric.v20220101.VmManagedIdentityArgs>;
    /**
     * The secrets to install in the virtual machines.
     */
    vmSecrets?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.VaultSecretGroupArgs>[]>;
    /**
     * The size of virtual machines in the pool. All virtual machines in a pool are the same size. For example, Standard_D3.
     */
