...
export declare class NodeType extends pulumi.CustomResource {
     ...
     */
    readonly applicationPorts: pulumi.Output<outputs.servicefabric.v20210501.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly ephemeralPorts: pulumi.Output<outputs.servicefabric.v20210501.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.servicefabric.v20210501.SystemDataResponse>;
    /**
     * Azure resource tags.
     */
     ...
     */
    readonly vmExtensions: pulumi.Output<outputs.servicefabric.v20210501.VMSSExtensionResponse[] | undefined>;
    /**
     ...
     */
    readonly vmManagedIdentity: pulumi.Output<outputs.servicefabric.v20210501.VmManagedIdentityResponse | undefined>;
    /**
     * The secrets to install in the virtual machines.
     */
    readonly vmSecrets: pulumi.Output<outputs.servicefabric.v20210501.VaultSecretGroupResponse[] | undefined>;
    /**
...
export interface NodeTypeArgs {
     ...
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    applicationPorts?: pulumi.Input<inputs.servicefabric.v20210501.EndpointRangeDescriptionArgs>;
    /**
     * The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much resource a node has.
     */
     ...
     * Managed data disk type. IOPS and throughput are given by the disk size, to see more information go to https://docs.microsoft.com/en-us/azure/virtual-machines/disks-types.
     */
    dataDiskType?: pulumi.Input<string | enums.servicefabric.v20210501.DiskType>;
    /**
     * The range of ephemeral ports that nodes in this node type should be configured with.
     */
    ephemeralPorts?: pulumi.Input<inputs.servicefabric.v20210501.EndpointRangeDescriptionArgs>;
    /**
     * The node type on which system services will run. Only one node type should be marked as primary. Primary node type cannot be deleted or changed for existing clusters.
     */
     ...
     * Set of extensions that should be installed onto the virtual machines.
     */
    vmExtensions?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210501.VMSSExtensionArgs>[]>;
    /**
     * The offer type of the Azure Virtual Machines Marketplace image. For example, UbuntuServer or WindowsServer.
     */
     ...
     * Identities for the virtual machine scale set under the node type.
     */
    vmManagedIdentity?: pulumi.Input<inputs.servicefabric.v20210501.VmManagedIdentityArgs>;
    /**
     * The secrets to install in the virtual machines.
     */
    vmSecrets?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210501.VaultSecretGroupArgs>[]>;
    /**
     * The size of virtual machines in the pool. All virtual machines in a pool are the same size. For example, Standard_D3.
     */
