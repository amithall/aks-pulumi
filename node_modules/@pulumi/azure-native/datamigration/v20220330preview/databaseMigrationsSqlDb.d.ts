 ...
 */
export declare class DatabaseMigrationsSqlDb extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseMigrationsSqlDb;
    /**
     * Returns true if the given object is an instance of DatabaseMigrationsSqlDb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatabaseMigrationsSqlDb;
    readonly name: pulumi.Output<string>;
    /**
     * Database Migration Resource properties for SQL database.
     */
    readonly properties: pulumi.Output<outputs.datamigration.v20220330preview.DatabaseMigrationPropertiesSqlDbResponse>;
    /**
