...
export interface GetDiagnosticSettingResult {
     ...
     */
    readonly logs?: outputs.aadiam.v20170401preview.LogSettingsResponse[];
    /**
     * Azure resource name
     */
...
export declare function getDiagnosticSettingOutput(args: GetDiagnosticSettingOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDiagnosticSettingResult>;
