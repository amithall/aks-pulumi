...
export declare class DiagnosticSetting extends pulumi.CustomResource {
     ...
     */
    readonly logs: pulumi.Output<outputs.aadiam.v20170401preview.LogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
...
export interface DiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<inputs.aadiam.v20170401preview.LogSettingsArgs>[]>;
    /**
