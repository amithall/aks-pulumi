...
export declare class DeploymentAtSubscriptionScope extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.resources.v20180501.DeploymentPropertiesExtendedResponse>;
    /**
...
export interface DeploymentAtSubscriptionScopeArgs {
     ...
     */
    properties: pulumi.Input<inputs.resources.v20180501.DeploymentPropertiesArgs>;
}
