 ...
 *
 * @deprecated Version v20170714 will be removed in the next major version of the provider. Upgrade to version v20170801 or later.
 */
export declare class ServerDetails extends pulumi.CustomResource {
     ...
     */
    readonly asAdministrators: pulumi.Output<outputs.analysisservices.v20170714.ServerAdministratorsResponse | undefined>;
    /**
     ...
     */
    readonly gatewayDetails: pulumi.Output<outputs.analysisservices.v20170714.GatewayDetailsResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.analysisservices.v20170714.ResourceSkuResponse>;
    /**
...
export interface ServerDetailsArgs {
     ...
     * A collection of AS server administrators
     */
    asAdministrators?: pulumi.Input<inputs.analysisservices.v20170714.ServerAdministratorsArgs>;
    /**
     * The SAS container URI to the backup container.
     */
     ...
     * The gateway details configured for the AS server.
     */
    gatewayDetails?: pulumi.Input<inputs.analysisservices.v20170714.GatewayDetailsArgs>;
    /**
     * Location of the Analysis Services resource.
     */
     ...
     * The SKU of the Analysis Services resource.
     */
    sku: pulumi.Input<inputs.analysisservices.v20170714.ResourceSkuArgs>;
    /**
     * Key-value pairs of additional resource provisioning properties.
     */
    tags?: pulumi.Input<{
