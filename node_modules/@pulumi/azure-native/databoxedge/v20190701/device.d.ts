...
export declare class Device extends pulumi.CustomResource {
     ...
     * The SKU type.
     */
    readonly sku: pulumi.Output<outputs.databoxedge.v20190701.SkuResponse | undefined>;
    /**
...
export interface DeviceArgs {
     ...
     * The status of the Data Box Edge/Gateway device.
     */
    dataBoxEdgeDeviceStatus?: pulumi.Input<string | enums.databoxedge.v20190701.DataBoxEdgeDeviceStatus>;
    /**
     * The Description of the Data Box Edge/Gateway device.
     */
     ...
     * The SKU type.
     */
    sku?: pulumi.Input<inputs.databoxedge.v20190701.SkuArgs>;
    /**
     * The list of tags that describe the device. These tags can be used to view and group this device (across resource groups).
     */
    tags?: pulumi.Input<{
