...
export declare class MonitoringConfig extends pulumi.CustomResource {
     ...
     */
    readonly metricConfigurations: pulumi.Output<outputs.databoxedge.v20200901preview.MetricConfigurationResponse[]>;
    /**
     * The object name.
     */
...
export interface MonitoringConfigArgs {
     ...
     * The metrics configuration details
     */
    metricConfigurations: pulumi.Input<pulumi.Input<inputs.databoxedge.v20200901preview.MetricConfigurationArgs>[]>;
    /**
