...
export declare class Device extends pulumi.CustomResource {
     ...
     */
    readonly edgeProfile: pulumi.Output<outputs.databoxedge.v20201201.EdgeProfileResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.databoxedge.v20201201.ResourceIdentityResponse | undefined>;
    /**
     * The etag for the devices.
     */
     ...
     */
    readonly resourceMoveDetails: pulumi.Output<outputs.databoxedge.v20201201.ResourceMoveDetailsResponse>;
    /**
     ...
     * The SKU type.
     */
    readonly sku: pulumi.Output<outputs.databoxedge.v20201201.SkuResponse | undefined>;
    /**
     * DataBoxEdge Resource
     */
    readonly systemData: pulumi.Output<outputs.databoxedge.v20201201.SystemDataResponse>;
    /**
...
export interface DeviceArgs {
     ...
     * The status of the Data Box Edge/Gateway device.
     */
    dataBoxEdgeDeviceStatus?: pulumi.Input<string | enums.databoxedge.v20201201.DataBoxEdgeDeviceStatus>;
    /**
     * The device name.
     */
     ...
     * Msi identity of the resource
     */
    identity?: pulumi.Input<inputs.databoxedge.v20201201.ResourceIdentityArgs>;
    /**
     * The location of the device. This is a supported and registered Azure geographical region (for example, West US, East US, or Southeast Asia). The geographical region of a device cannot be changed once it is created, but if an identical geographical region is specified on update, the request will succeed.
     */
     ...
     * The SKU type.
     */
    sku?: pulumi.Input<inputs.databoxedge.v20201201.SkuArgs>;
    /**
     * The list of tags that describe the device. These tags can be used to view and group this device (across resource groups).
     */
    tags?: pulumi.Input<{
