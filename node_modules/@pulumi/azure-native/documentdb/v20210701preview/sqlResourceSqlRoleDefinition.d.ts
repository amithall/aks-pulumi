 ...
 */
export declare class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlRoleDefinition;
    /**
     ...
     */
    static isInstance(obj: any): obj is SqlResourceSqlRoleDefinition;
    /**
     ...
     */
    readonly permissions: pulumi.Output<outputs.documentdb.v20210701preview.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210701preview.PermissionArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20210701preview.RoleDefinitionType>;
}
