...
export declare class DatabaseAccountMongoDBCollection extends pulumi.CustomResource {
     ...
     * List of index keys
     */
    readonly indexes: pulumi.Output<outputs.documentdb.v20160319.MongoIndexResponse[] | undefined>;
    /**
...
export interface DatabaseAccountMongoDBCollectionArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20160319.MongoDBCollectionResourceArgs>;
    /**
