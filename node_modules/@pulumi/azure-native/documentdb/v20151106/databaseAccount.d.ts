...
export declare class DatabaseAccount extends pulumi.CustomResource {
     ...
     */
    readonly capabilities: pulumi.Output<outputs.documentdb.v20151106.CapabilityResponse[] | undefined>;
    /**
     ...
     */
    readonly consistencyPolicy: pulumi.Output<outputs.documentdb.v20151106.ConsistencyPolicyResponse | undefined>;
    /**
     ...
     */
    readonly failoverPolicies: pulumi.Output<outputs.documentdb.v20151106.FailoverPolicyResponse[]>;
    /**
     ...
     */
    readonly readLocations: pulumi.Output<outputs.documentdb.v20151106.LocationResponse[]>;
    /**
     ...
     */
    readonly virtualNetworkRules: pulumi.Output<outputs.documentdb.v20151106.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    readonly writeLocations: pulumi.Output<outputs.documentdb.v20151106.LocationResponse[]>;
    /**
...
export interface DatabaseAccountArgs {
     ...
     * List of Cosmos DB capabilities for the account
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.v20151106.CapabilityArgs>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
    connectorOffer?: pulumi.Input<string | enums.documentdb.v20151106.ConnectorOffer>;
    /**
     * The consistency policy for the Cosmos DB account.
     */
    consistencyPolicy?: pulumi.Input<inputs.documentdb.v20151106.ConsistencyPolicyArgs>;
    /**
     * The offer type for the database
     */
    databaseAccountOfferType: pulumi.Input<enums.documentdb.v20151106.DatabaseAccountOfferType>;
    /**
     * Enables automatic failover of the write region in the rare event that the region is unavailable due to an outage. Automatic failover will result in a new write region for the account and is chosen based on the failover priorities configured for the account.
     */
     ...
     * Indicates the type of database account. This can only be set at database account creation.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20151106.DatabaseAccountKind>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    locations: pulumi.Input<pulumi.Input<inputs.documentdb.v20151106.LocationArgs>[]>;
    /**
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20151106.VirtualNetworkRuleArgs>[]>;
}
