...
export declare class MongoDBResourceMongoRoleDefinition extends pulumi.CustomResource {
     ...
     */
    readonly privileges: pulumi.Output<outputs.documentdb.PrivilegeResponse[] | undefined>;
    /**
     ...
     */
    readonly roles: pulumi.Output<outputs.documentdb.RoleResponse[] | undefined>;
    /**
...
export interface MongoDBResourceMongoRoleDefinitionArgs {
     ...
     * A set of privileges contained by the Role Definition. This will allow application of this Role Definition on the entire database account or any underlying Database / Collection. Scopes higher than Database are not enforceable as privilege.
     */
    privileges?: pulumi.Input<pulumi.Input<inputs.documentdb.PrivilegeArgs>[]>;
    /**
     ...
     * The set of roles inherited by this Role Definition.
     */
    roles?: pulumi.Input<pulumi.Input<inputs.documentdb.RoleArgs>[]>;
    /**
     * Indicates whether the Role Definition was built-in or user created.
     */
    type?: pulumi.Input<enums.documentdb.MongoRoleDefinitionType>;
}
