 ...
 */
export declare class DatabaseAccountTable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccountTable;
    /**
     * Returns true if the given object is an instance of DatabaseAccountTable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatabaseAccountTable;
    /**
...
export interface DatabaseAccountTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20160331.TableResourceArgs>;
    /**
