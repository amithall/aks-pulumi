...
export declare class DatabaseAccount extends pulumi.CustomResource {
     ...
     */
    readonly capabilities: pulumi.Output<outputs.documentdb.v20191212.CapabilityResponse[] | undefined>;
    /**
     ...
     */
    readonly consistencyPolicy: pulumi.Output<outputs.documentdb.v20191212.ConsistencyPolicyResponse | undefined>;
    /**
     ...
     */
    readonly failoverPolicies: pulumi.Output<outputs.documentdb.v20191212.FailoverPolicyResponse[]>;
    /**
     ...
     */
    readonly locations: pulumi.Output<outputs.documentdb.v20191212.LocationResponse[]>;
    /**
     ...
     */
    readonly readLocations: pulumi.Output<outputs.documentdb.v20191212.LocationResponse[]>;
    /**
     ...
     */
    readonly virtualNetworkRules: pulumi.Output<outputs.documentdb.v20191212.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    readonly writeLocations: pulumi.Output<outputs.documentdb.v20191212.LocationResponse[]>;
    /**
...
export interface DatabaseAccountArgs {
     ...
     * List of Cosmos DB capabilities for the account
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.v20191212.CapabilityArgs>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
    connectorOffer?: pulumi.Input<string | enums.documentdb.v20191212.ConnectorOffer>;
    /**
     * The consistency policy for the Cosmos DB account.
     */
    consistencyPolicy?: pulumi.Input<inputs.documentdb.v20191212.ConsistencyPolicyArgs>;
    /**
     * The offer type for the database
     */
    databaseAccountOfferType: pulumi.Input<enums.documentdb.v20191212.DatabaseAccountOfferType>;
    /**
     * Disable write operations on metadata resources (databases, containers, throughput) via account keys
     */
     ...
     * Indicates the type of database account. This can only be set at database account creation.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20191212.DatabaseAccountKind>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    locations: pulumi.Input<pulumi.Input<inputs.documentdb.v20191212.LocationArgs>[]>;
    /**
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20191212.VirtualNetworkRuleArgs>[]>;
}
