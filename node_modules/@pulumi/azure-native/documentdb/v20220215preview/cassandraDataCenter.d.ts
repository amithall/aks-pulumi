...
export declare class CassandraDataCenter extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraDataCenter;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.documentdb.v20220215preview.DataCenterResourceResponseProperties>;
    /**
...
export interface CassandraDataCenterArgs {
     ...
     * Properties of a managed Cassandra data center.
     */
    properties?: pulumi.Input<inputs.documentdb.v20220215preview.DataCenterResourcePropertiesArgs>;
    /**
