...
__exportStar(require("./cassandraResourceCassandraView"), exports);
...
__exportStar(require("./getCassandraResourceCassandraView"), exports);
__exportStar(require("./getDatabaseAccount"), exports);
__exportStar(require("./getGraphResourceGraph"), exports);
...
__exportStar(require("./getMongoDBResourceMongoRoleDefinition"), exports);
__exportStar(require("./getMongoDBResourceMongoUserDefinition"), exports);
...
__exportStar(require("./graphResourceGraph"), exports);
...
__exportStar(require("./mongoDBResourceMongoRoleDefinition"), exports);
__exportStar(require("./mongoDBResourceMongoUserDefinition"), exports);
...
// Export enums:
__exportStar(require("../../types/enums/documentdb/v20211115preview"), exports);
...
const cassandraResourceCassandraView_1 = require("./cassandraResourceCassandraView");
const databaseAccount_1 = require("./databaseAccount");
const graphResourceGraph_1 = require("./graphResourceGraph");
...
const mongoDBResourceMongoRoleDefinition_1 = require("./mongoDBResourceMongoRoleDefinition");
const mongoDBResourceMongoUserDefinition_1 = require("./mongoDBResourceMongoUserDefinition");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure-native:documentdb/v20211115preview:CassandraResourceCassandraView":
                return new cassandraResourceCassandraView_1.CassandraResourceCassandraView(name, undefined, { urn });
            ...
            case "azure-native:documentdb/v20211115preview:GraphResourceGraph":
                return new graphResourceGraph_1.GraphResourceGraph(name, undefined, { urn });
            ...
            case "azure-native:documentdb/v20211115preview:MongoDBResourceMongoRoleDefinition":
                return new mongoDBResourceMongoRoleDefinition_1.MongoDBResourceMongoRoleDefinition(name, undefined, { urn });
            case "azure-native:documentdb/v20211115preview:MongoDBResourceMongoUserDefinition":
                return new mongoDBResourceMongoUserDefinition_1.MongoDBResourceMongoUserDefinition(name, undefined, { urn });
...
pulumi.runtime.registerResourceModule("azure-native", "documentdb/v20211115preview", _module);
//# sourceMappingURL=data:application/json;base64,