...
export interface ListDatabaseAccountConnectionStringsResult {
     ...
     */
    readonly connectionStrings?: outputs.documentdb.v20211115preview.DatabaseAccountConnectionStringResponse[];
}
export declare function listDatabaseAccountConnectionStringsOutput(args: ListDatabaseAccountConnectionStringsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListDatabaseAccountConnectionStringsResult>;
