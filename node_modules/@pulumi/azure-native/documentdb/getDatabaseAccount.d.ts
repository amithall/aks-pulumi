...
export interface GetDatabaseAccountResult {
     ...
     */
    readonly backupPolicy?: outputs.documentdb.ContinuousModeBackupPolicyResponse | outputs.documentdb.PeriodicModeBackupPolicyResponse;
    /**
     ...
     */
    readonly consistencyPolicy?: outputs.documentdb.ConsistencyPolicyResponse;
    /**
     ...
     */
    readonly failoverPolicies: outputs.documentdb.FailoverPolicyResponse[];
    /**
     ...
     */
    readonly locations: outputs.documentdb.LocationResponse[];
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.documentdb.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: outputs.documentdb.VirtualNetworkRuleResponse[];
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    readonly writeLocations: outputs.documentdb.LocationResponse[];
}
