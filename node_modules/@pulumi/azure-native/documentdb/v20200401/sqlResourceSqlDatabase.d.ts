...
export declare class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    readonly options: pulumi.Output<outputs.documentdb.v20200401.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    readonly resource: pulumi.Output<outputs.documentdb.v20200401.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20200401.SqlDatabaseResourceArgs>;
    /**
