...
export declare class TableResourceTable extends pulumi.CustomResource {
    ...
    readonly options: pulumi.Output<outputs.documentdb.v20200401.TableGetPropertiesResponseOptions | undefined>;
    readonly resource: pulumi.Output<outputs.documentdb.v20200401.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20200401.TableResourceArgs>;
    /**
