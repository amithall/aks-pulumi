...
export declare class TableResourceTable extends pulumi.CustomResource {
    ...
    readonly options: pulumi.Output<outputs.documentdb.v20210115.TableGetPropertiesResponseOptions | undefined>;
    readonly resource: pulumi.Output<outputs.documentdb.v20210115.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20210115.TableResourceArgs>;
    /**
