...
export interface DatabaseAccountArgs {
     ...
     * List of Cosmos DB capabilities for the account
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.v20190801.CapabilityArgs>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
    connectorOffer?: pulumi.Input<string | enums.documentdb.v20190801.ConnectorOffer>;
    /**
     * The consistency policy for the Cosmos DB account.
     */
    consistencyPolicy?: pulumi.Input<inputs.documentdb.v20190801.ConsistencyPolicyArgs>;
    /**
     * The offer type for the database
     */
    databaseAccountOfferType: pulumi.Input<enums.documentdb.v20190801.DatabaseAccountOfferType>;
    /**
     * Disable write operations on metadata resources (databases, containers, throughput) via account keys
     */
     ...
     * Indicates the type of database account. This can only be set at database account creation.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20190801.DatabaseAccountKind>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    locations: pulumi.Input<pulumi.Input<inputs.documentdb.v20190801.LocationArgs>[]>;
    /**
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20190801.VirtualNetworkRuleArgs>[]>;
}
