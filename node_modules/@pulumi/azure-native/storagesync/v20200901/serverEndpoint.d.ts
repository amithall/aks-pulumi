...
export declare class ServerEndpoint extends pulumi.CustomResource {
     ...
     */
    readonly cloudTieringStatus: pulumi.Output<outputs.storagesync.v20200901.ServerEndpointCloudTieringStatusResponse>;
    /**
     * Friendly Name
     */
     ...
     */
    readonly initialDownloadPolicy: pulumi.Output<string | undefined>;
    /**
     * Policy for how the initial upload sync session is performed.
     */
    readonly initialUploadPolicy: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly localCacheMode: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly recallStatus: pulumi.Output<outputs.storagesync.v20200901.ServerEndpointRecallStatusResponse>;
    /**
     * Server Local path.
     */
     ...
     */
    readonly syncStatus: pulumi.Output<outputs.storagesync.v20200901.ServerEndpointSyncStatusResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.storagesync.v20200901.SystemDataResponse>;
    /**
...
export interface ServerEndpointArgs {
     ...
     * Cloud Tiering.
     */
    cloudTiering?: pulumi.Input<string | enums.storagesync.v20200901.FeatureStatus>;
    /**
     * Friendly Name
     */
     ...
     * Policy for how namespace and files are recalled during FastDr.
     */
    initialDownloadPolicy?: pulumi.Input<string | enums.storagesync.v20200901.InitialDownloadPolicy>;
    /**
     * Policy for how the initial upload sync session is performed.
     */
    initialUploadPolicy?: pulumi.Input<string | enums.storagesync.v20200901.InitialUploadPolicy>;
    /**
     * Policy for enabling follow-the-sun business models: link local cache to cloud behavior to pre-populate before local access.
     */
    localCacheMode?: pulumi.Input<string | enums.storagesync.v20200901.LocalCacheMode>;
    /**
     * Offline data transfer
     */
    offlineDataTransfer?: pulumi.Input<string | enums.storagesync.v20200901.FeatureStatus>;
    /**
     * Offline data transfer share name
     */
