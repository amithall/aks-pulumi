...
export declare class BatchAccount extends pulumi.CustomResource {
     ...
     */
    readonly autoStorage: pulumi.Output<outputs.batch.v20200301.AutoStoragePropertiesResponse>;
    /**
     ...
     */
    readonly dedicatedCoreQuotaPerVMFamily: pulumi.Output<outputs.batch.v20200301.VirtualMachineFamilyCoreQuotaResponse[]>;
    /**
    ...
    readonly encryption: pulumi.Output<outputs.batch.v20200301.EncryptionPropertiesResponse>;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    readonly keyVaultReference: pulumi.Output<outputs.batch.v20200301.KeyVaultReferenceResponse>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.batch.v20200301.PrivateEndpointConnectionResponse[]>;
    /**
...
export interface BatchAccountArgs {
     ...
     */
    autoStorage?: pulumi.Input<inputs.batch.v20200301.AutoStorageBasePropertiesArgs>;
    encryption?: pulumi.Input<inputs.batch.v20200301.EncryptionPropertiesArgs>;
    /**
     * A reference to the Azure key vault associated with the Batch account.
     */
    keyVaultReference?: pulumi.Input<inputs.batch.v20200301.KeyVaultReferenceArgs>;
    /**
     ...
     */
    poolAllocationMode?: pulumi.Input<enums.batch.v20200301.PoolAllocationMode>;
    /**
     * If not specified, the default value is 'enabled'.
     */
    publicNetworkAccess?: pulumi.Input<enums.batch.v20200301.PublicNetworkAccessType>;
    /**
