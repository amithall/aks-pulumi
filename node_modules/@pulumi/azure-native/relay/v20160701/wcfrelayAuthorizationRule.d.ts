 ...
 */
export declare class WCFRelayAuthorizationRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WCFRelayAuthorizationRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is WCFRelayAuthorizationRule;
    /**
     * Resource name
     */
