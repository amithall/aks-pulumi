...
export declare class PipelineRun extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PipelineRun;
    /**
     ...
     */
    readonly request: pulumi.Output<outputs.containerregistry.v20211201preview.PipelineRunRequestResponse | undefined>;
    /**
     * The response of a pipeline run.
     */
    readonly response: pulumi.Output<outputs.containerregistry.v20211201preview.PipelineRunResponseResponse>;
    /**
