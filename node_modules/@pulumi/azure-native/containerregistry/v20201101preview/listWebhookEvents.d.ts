...
export interface ListWebhookEventsResult {
     ...
     */
    readonly value?: outputs.containerregistry.v20201101preview.EventResponse[];
}
export declare function listWebhookEventsOutput(args: ListWebhookEventsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListWebhookEventsResult>;
