...
export declare class P2sVpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly p2SConnectionConfigurations: pulumi.Output<outputs.network.v20210501.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    readonly vpnClientConnectionHealth: pulumi.Output<outputs.network.v20210501.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    readonly vpnServerConfiguration: pulumi.Output<outputs.network.v20210501.SubResourceResponse | undefined>;
    /**
