...
export declare class VirtualHubIpConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly publicIPAddress: pulumi.Output<outputs.network.v20210501.PublicIPAddressResponse | undefined>;
    /**
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    privateIPAllocationMethod?: pulumi.Input<string | enums.network.v20210501.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    publicIPAddress?: pulumi.Input<inputs.network.v20210501.PublicIPAddressArgs>;
    /**
