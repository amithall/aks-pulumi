...
export declare class VirtualHubBgpConnection extends pulumi.CustomResource {
     ...
     */
    readonly hubVirtualNetworkConnection: pulumi.Output<outputs.network.v20210501.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<inputs.network.v20210501.SubResourceArgs>;
    /**
     * Resource ID.
     */
