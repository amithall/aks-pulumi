...
export declare class RouteFilter extends pulumi.CustomResource {
     ...
     */
    readonly ipv6Peerings: pulumi.Output<outputs.network.v20210501.ExpressRouteCircuitPeeringResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly peerings: pulumi.Output<outputs.network.v20210501.ExpressRouteCircuitPeeringResponse[]>;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.network.v20210501.RouteFilterRuleResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20210501.RouteFilterRuleArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
