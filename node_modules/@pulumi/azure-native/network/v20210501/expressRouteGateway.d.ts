...
export declare class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    readonly autoScaleConfiguration: pulumi.Output<outputs.network.v20210501.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    readonly expressRouteConnections: pulumi.Output<outputs.network.v20210501.ExpressRouteConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly virtualHub: pulumi.Output<outputs.network.v20210501.VirtualHubIdResponse>;
    /**
...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    autoScaleConfiguration?: pulumi.Input<inputs.network.v20210501.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>;
    /**
     * List of ExpressRoute connections to the ExpressRoute gateway.
     */
    expressRouteConnections?: pulumi.Input<pulumi.Input<inputs.network.v20210501.ExpressRouteConnectionArgs>[]>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    virtualHub: pulumi.Input<inputs.network.v20210501.VirtualHubIdArgs>;
}
