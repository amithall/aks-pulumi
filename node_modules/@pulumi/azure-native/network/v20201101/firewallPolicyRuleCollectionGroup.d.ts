...
export declare class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
     ...
     */
    readonly ruleCollections: pulumi.Output<(outputs.network.v20201101.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20201101.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20201101.FirewallPolicyFilterRuleCollectionArgs | inputs.network.v20201101.FirewallPolicyNatRuleCollectionArgs>[]>;
}
