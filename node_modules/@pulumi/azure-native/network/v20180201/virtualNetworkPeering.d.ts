...
export declare class VirtualNetworkPeering extends pulumi.CustomResource {
     ...
     */
    readonly remoteAddressSpace: pulumi.Output<outputs.network.v20180201.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    readonly remoteVirtualNetwork: pulumi.Output<outputs.network.v20180201.SubResourceResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering. Possible values are 'Initiated', 'Connected', and 'Disconnected'.
     */
    peeringState?: pulumi.Input<string | enums.network.v20180201.VirtualNetworkPeeringState>;
    /**
     * The provisioning state of the resource.
     */
     ...
     * The reference of the remote virtual network address space.
     */
    remoteAddressSpace?: pulumi.Input<inputs.network.v20180201.AddressSpaceArgs>;
    /**
     * The reference of the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    remoteVirtualNetwork?: pulumi.Input<inputs.network.v20180201.SubResourceArgs>;
    /**
