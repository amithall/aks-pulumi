...
export interface GetConnectivityConfigurationResult {
     ...
     */
    readonly appliesToGroups: outputs.network.v20220201preview.ConnectivityGroupItemResponse[];
    /**
     ...
     * List of hubItems
     */
    readonly hubs?: outputs.network.v20220201preview.HubResponse[];
    /**
     * Resource ID.
     */
    readonly id: string;
...
export declare function getConnectivityConfigurationOutput(args: GetConnectivityConfigurationOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetConnectivityConfigurationResult>;
