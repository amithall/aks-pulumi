...
export declare class UserRuleCollection extends pulumi.CustomResource {
     ...
     */
    readonly appliesToGroups: pulumi.Output<outputs.network.v20220201preview.NetworkManagerSecurityGroupItemResponse[]>;
    /**
...
export interface UserRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20220201preview.NetworkManagerSecurityGroupItemArgs>[]>;
    /**
