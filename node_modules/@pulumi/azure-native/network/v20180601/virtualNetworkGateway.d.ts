...
export declare class VirtualNetworkGateway extends pulumi.CustomResource {
     ...
     */
    readonly bgpSettings: pulumi.Output<outputs.network.v20180601.BgpSettingsResponse | undefined>;
    /**
     ...
     */
    readonly gatewayDefaultSite: pulumi.Output<outputs.network.v20180601.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20180601.VirtualNetworkGatewayIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20180601.VirtualNetworkGatewaySkuResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    readonly vpnClientConfiguration: pulumi.Output<outputs.network.v20180601.VpnClientConfigurationResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayArgs {
     ...
     * Virtual network gateway's BGP speaker settings.
     */
    bgpSettings?: pulumi.Input<inputs.network.v20180601.BgpSettingsArgs>;
    /**
     * Whether BGP is enabled for this virtual network gateway or not.
     */
     ...
     * The reference of the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    gatewayDefaultSite?: pulumi.Input<inputs.network.v20180601.SubResourceArgs>;
    /**
     * The type of this virtual network gateway. Possible values are: 'Vpn' and 'ExpressRoute'.
     */
    gatewayType?: pulumi.Input<string | enums.network.v20180601.VirtualNetworkGatewayType>;
    /**
     * Resource ID.
     */
     ...
     * IP configurations for virtual network gateway.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180601.VirtualNetworkGatewayIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference of the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
     */
    sku?: pulumi.Input<inputs.network.v20180601.VirtualNetworkGatewaySkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    vpnClientConfiguration?: pulumi.Input<inputs.network.v20180601.VpnClientConfigurationArgs>;
    /**
     * The type of this virtual network gateway. Possible values are: 'PolicyBased' and 'RouteBased'.
     */
    vpnType?: pulumi.Input<string | enums.network.v20180601.VpnType>;
}
