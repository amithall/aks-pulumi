...
export declare class VirtualNetwork extends pulumi.CustomResource {
     ...
     */
    readonly addressSpace: pulumi.Output<outputs.network.v20150615.AddressSpaceResponse | undefined>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    readonly dhcpOptions: pulumi.Output<outputs.network.v20150615.DhcpOptionsResponse | undefined>;
    /**
     ...
     */
    readonly subnets: pulumi.Output<outputs.network.v20150615.SubnetResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkArgs {
     ...
     * The AddressSpace that contains an array of IP address ranges that can be used by subnets.
     */
    addressSpace?: pulumi.Input<inputs.network.v20150615.AddressSpaceArgs>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    dhcpOptions?: pulumi.Input<inputs.network.v20150615.DhcpOptionsArgs>;
    /**
     * Resource Identifier.
     */
