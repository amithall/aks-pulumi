...
export declare class NetworkInterface extends pulumi.CustomResource {
     ...
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20160901.NetworkInterfaceDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20160901.NetworkInterfaceIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly networkSecurityGroup: pulumi.Output<outputs.network.v20160901.NetworkSecurityGroupResponse | undefined>;
    /**
     ...
     */
    readonly virtualMachine: pulumi.Output<outputs.network.v20160901.SubResourceResponse | undefined>;
    /**
...
export interface NetworkInterfaceArgs {
     ...
     * The DNS settings in network interface.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20160901.NetworkInterfaceDnsSettingsArgs>;
    /**
     * If the network interface is accelerated networking enabled.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20160901.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference of a virtual machine.
     */
    virtualMachine?: pulumi.Input<inputs.network.v20160901.SubResourceArgs>;
}
