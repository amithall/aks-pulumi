...
export declare class DdosProtectionPlan extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DdosProtectionPlan;
    /**
     ...
     */
    readonly virtualNetworks: pulumi.Output<outputs.network.v20210801.SubResourceResponse[]>;
    /**
