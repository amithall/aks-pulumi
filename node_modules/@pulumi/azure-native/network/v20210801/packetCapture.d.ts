...
export declare class PacketCapture extends pulumi.CustomResource {
     ...
     */
    readonly filters: pulumi.Output<outputs.network.v20210801.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.network.v20210801.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * A list of packet capture filters.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.network.v20210801.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * The storage location for a packet capture session.
     */
    storageLocation: pulumi.Input<inputs.network.v20210801.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
