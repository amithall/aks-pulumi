...
export declare class VirtualHubBgpConnection extends pulumi.CustomResource {
     ...
     */
    readonly hubVirtualNetworkConnection: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<inputs.network.v20210801.SubResourceArgs>;
    /**
     * Resource ID.
     */
