...
export interface GetVirtualWanResult {
     ...
     */
    readonly p2SVpnServerConfigurations?: outputs.network.v20181101.P2SVpnServerConfigurationResponse[];
    /**
     ...
     */
    readonly virtualHubs: outputs.network.v20181101.SubResourceResponse[];
    readonly vpnSites: outputs.network.v20181101.SubResourceResponse[];
}
