...
export interface ApplicationGatewayArgs {
     ...
     * Authentication certificates of the application gateway resource.
     */
    authenticationCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayAuthenticationCertificateArgs>[]>;
    /**
     * Backend address pool of the application gateway resource.
     */
    backendAddressPools?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayBackendAddressPoolArgs>[]>;
    /**
     * Backend http settings of the application gateway resource.
     */
    backendHttpSettingsCollection?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayBackendHttpSettingsArgs>[]>;
    /**
     * Whether HTTP2 is enabled on the application gateway resource.
     */
     ...
     * Frontend IP addresses of the application gateway resource.
     */
    frontendIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayFrontendIPConfigurationArgs>[]>;
    /**
     * Frontend ports of the application gateway resource.
     */
    frontendPorts?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayFrontendPortArgs>[]>;
    /**
     * Subnets of application the gateway resource.
     */
    gatewayIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayIPConfigurationArgs>[]>;
    /**
     * Http listeners of the application gateway resource.
     */
    httpListeners?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayHttpListenerArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Probes of the application gateway resource.
     */
    probes?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayProbeArgs>[]>;
    /**
     * Provisioning state of the application gateway resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
     ...
     * Redirect configurations of the application gateway resource.
     */
    redirectConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayRedirectConfigurationArgs>[]>;
    /**
     * Request routing rules of the application gateway resource.
     */
    requestRoutingRules?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayRequestRoutingRuleArgs>[]>;
    /**
     ...
     * SKU of the application gateway resource.
     */
    sku?: pulumi.Input<inputs.network.v20180101.ApplicationGatewaySkuArgs>;
    /**
     * SSL certificates of the application gateway resource.
     */
    sslCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewaySslCertificateArgs>[]>;
    /**
     * SSL policy of the application gateway resource.
     */
    sslPolicy?: pulumi.Input<inputs.network.v20180101.ApplicationGatewaySslPolicyArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * URL path map of the application gateway resource.
     */
    urlPathMaps?: pulumi.Input<pulumi.Input<inputs.network.v20180101.ApplicationGatewayUrlPathMapArgs>[]>;
    /**
     * Web application firewall configuration.
     */
    webApplicationFirewallConfiguration?: pulumi.Input<inputs.network.v20180101.ApplicationGatewayWebApplicationFirewallConfigurationArgs>;
}
