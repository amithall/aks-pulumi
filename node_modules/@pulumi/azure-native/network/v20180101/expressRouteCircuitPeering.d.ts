...
export declare class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    readonly ipv6PeeringConfig: pulumi.Output<outputs.network.v20180101.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly microsoftPeeringConfig: pulumi.Output<outputs.network.v20180101.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly routeFilter: pulumi.Output<outputs.network.v20180101.RouteFilterResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    readonly stats: pulumi.Output<outputs.network.v20180101.ExpressRouteCircuitStatsResponse | undefined>;
    /**
     * The VLAN ID.
     */
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The IPv6 peering configuration.
     */
    ipv6PeeringConfig?: pulumi.Input<inputs.network.v20180101.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets whether the provider or the customer last modified the peering.
     */
     ...
     * The Microsoft peering configuration.
     */
    microsoftPeeringConfig?: pulumi.Input<inputs.network.v20180101.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The PeeringType. Possible values are: 'AzurePublicPeering', 'AzurePrivatePeering', and 'MicrosoftPeering'.
     */
    peeringType?: pulumi.Input<string | enums.network.v20180101.ExpressRouteCircuitPeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference of the RouteFilter resource.
     */
    routeFilter?: pulumi.Input<inputs.network.v20180101.RouteFilterArgs>;
    /**
     * The secondary port.
     */
     ...
     * The state of peering. Possible values are: 'Disabled' and 'Enabled'
     */
    state?: pulumi.Input<string | enums.network.v20180101.ExpressRouteCircuitPeeringState>;
    /**
     * Gets peering stats.
     */
    stats?: pulumi.Input<inputs.network.v20180101.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
