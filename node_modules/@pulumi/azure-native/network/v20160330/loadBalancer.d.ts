...
export interface LoadBalancerArgs {
     ...
     * Gets or sets Pools of backend IP addresses
     */
    backendAddressPools?: pulumi.Input<pulumi.Input<inputs.network.v20160330.BackendAddressPoolArgs>[]>;
    /**
     * Gets or sets frontend IP addresses of the load balancer
     */
    frontendIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20160330.FrontendIPConfigurationArgs>[]>;
    /**
     * Resource Id
     */
     ...
     * Gets or sets inbound NAT pools
     */
    inboundNatPools?: pulumi.Input<pulumi.Input<inputs.network.v20160330.InboundNatPoolArgs>[]>;
    /**
     * Gets or sets list of inbound rules
     */
    inboundNatRules?: pulumi.Input<pulumi.Input<inputs.network.v20160330.InboundNatRuleArgs>[]>;
    /**
     ...
     * Gets or sets load balancing rules
     */
    loadBalancingRules?: pulumi.Input<pulumi.Input<inputs.network.v20160330.LoadBalancingRuleArgs>[]>;
    /**
     * Resource location
     */
     ...
     * Gets or sets outbound NAT rules
     */
    outboundNatRules?: pulumi.Input<pulumi.Input<inputs.network.v20160330.OutboundNatRuleArgs>[]>;
    /**
     * Gets or sets list of Load balancer probes
     */
    probes?: pulumi.Input<pulumi.Input<inputs.network.v20160330.ProbeArgs>[]>;
    /**
     * Gets or sets Provisioning state of the PublicIP resource Updating/Deleting/Failed
     */
