...
export declare class FirewallPolicyRuleGroup extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<(outputs.network.v20190801.FirewallPolicyFilterRuleResponse | outputs.network.v20190801.FirewallPolicyNatRuleResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * Group of Firewall Policy rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20190801.FirewallPolicyFilterRuleArgs | inputs.network.v20190801.FirewallPolicyNatRuleArgs>[]>;
}
