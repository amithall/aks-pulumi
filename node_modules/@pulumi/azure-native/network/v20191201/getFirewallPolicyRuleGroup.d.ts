...
export interface GetFirewallPolicyRuleGroupResult {
     ...
     */
    readonly rules?: (outputs.network.v20191201.FirewallPolicyFilterRuleResponse | outputs.network.v20191201.FirewallPolicyNatRuleResponse)[];
    /**
     * Rule Group type.
     */
    readonly type: string;
}
export declare function getFirewallPolicyRuleGroupOutput(args: GetFirewallPolicyRuleGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFirewallPolicyRuleGroupResult>;
