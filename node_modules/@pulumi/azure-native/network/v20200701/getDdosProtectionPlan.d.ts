...
export interface GetDdosProtectionPlanResult {
     ...
     */
    readonly virtualNetworks: outputs.network.v20200701.SubResourceResponse[];
}
export declare function getDdosProtectionPlanOutput(args: GetDdosProtectionPlanOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDdosProtectionPlanResult>;
