...
export declare class WebApplicationFirewallPolicy extends pulumi.CustomResource {
     ...
     */
    readonly applicationGateways: pulumi.Output<outputs.network.v20190201.ApplicationGatewayResponse[]>;
    /**
     * Describes custom rules inside the policy
     */
    readonly customRules: pulumi.Output<outputs.network.v20190201.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly policySettings: pulumi.Output<outputs.network.v20190201.PolicySettingsResponse | undefined>;
    /**
...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * Describes custom rules inside the policy
     */
    customRules?: pulumi.Input<pulumi.Input<inputs.network.v20190201.WebApplicationFirewallCustomRuleArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Describes  policySettings for policy
     */
    policySettings?: pulumi.Input<inputs.network.v20190201.PolicySettingsArgs>;
    /**
