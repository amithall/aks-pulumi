...
export interface GetPacketCaptureResult {
     ...
     */
    readonly filters?: outputs.network.v20190201.PacketCaptureFilterResponse[];
    /**
     ...
     */
    readonly storageLocation: outputs.network.v20190201.PacketCaptureStorageLocationResponse;
    /**
...
export declare function getPacketCaptureOutput(args: GetPacketCaptureOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPacketCaptureResult>;
