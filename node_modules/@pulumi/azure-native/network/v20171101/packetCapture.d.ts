...
export declare class PacketCapture extends pulumi.CustomResource {
    ...
    readonly filters: pulumi.Output<outputs.network.v20171101.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.network.v20171101.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.network.v20171101.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    storageLocation: pulumi.Input<inputs.network.v20171101.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
