 ...
 */
export declare class DnsForwardingRuleset extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DnsForwardingRuleset;
    /**
     * Returns true if the given object is an instance of DnsForwardingRuleset.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DnsForwardingRuleset;
    /**
     * The reference to the DNS resolver outbound endpoints that are used to route DNS queries matching the forwarding rules in the ruleset to the target DNS servers.
     */
    readonly dnsResolverOutboundEndpoints: pulumi.Output<outputs.network.v20200401preview.SubResourceResponse[] | undefined>;
    /**
...
export interface DnsForwardingRulesetArgs {
     ...
     * The reference to the DNS resolver outbound endpoints that are used to route DNS queries matching the forwarding rules in the ruleset to the target DNS servers.
     */
    dnsResolverOutboundEndpoints?: pulumi.Input<pulumi.Input<inputs.network.v20200401preview.SubResourceArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
