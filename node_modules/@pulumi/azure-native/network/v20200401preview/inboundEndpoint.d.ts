 ...
 */
export declare class InboundEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InboundEndpoint;
    /**
     * Returns true if the given object is an instance of InboundEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InboundEndpoint;
    /**
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20200401preview.InboundEndpointIPConfigurationResponse[] | undefined>;
    /**
...
export interface InboundEndpointArgs {
     ...
     * IP configurations for the inbound endpoint.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20200401preview.InboundEndpointIPConfigurationArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
