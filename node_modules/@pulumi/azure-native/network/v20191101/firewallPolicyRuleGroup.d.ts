...
export declare class FirewallPolicyRuleGroup extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<(outputs.network.v20191101.FirewallPolicyFilterRuleResponse | outputs.network.v20191101.FirewallPolicyNatRuleResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * Group of Firewall Policy rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20191101.FirewallPolicyFilterRuleArgs | inputs.network.v20191101.FirewallPolicyNatRuleArgs>[]>;
}
