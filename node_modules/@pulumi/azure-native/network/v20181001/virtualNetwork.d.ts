...
export declare class VirtualNetwork extends pulumi.CustomResource {
     ...
     */
    readonly ddosProtectionPlan: pulumi.Output<outputs.network.v20181001.SubResourceResponse | undefined>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    readonly dhcpOptions: pulumi.Output<outputs.network.v20181001.DhcpOptionsResponse | undefined>;
    /**
     ...
     */
    readonly subnets: pulumi.Output<outputs.network.v20181001.SubnetResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetworkPeerings: pulumi.Output<outputs.network.v20181001.VirtualNetworkPeeringResponse[] | undefined>;
    /**
...
export interface VirtualNetworkArgs {
     ...
     * The AddressSpace that contains an array of IP address ranges that can be used by subnets.
     */
    addressSpace?: pulumi.Input<inputs.network.v20181001.AddressSpaceArgs>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    ddosProtectionPlan?: pulumi.Input<inputs.network.v20181001.SubResourceArgs>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    dhcpOptions?: pulumi.Input<inputs.network.v20181001.DhcpOptionsArgs>;
    /**
     * Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
     */
     ...
     * A list of subnets in a Virtual Network.
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.network.v20181001.SubnetArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * A list of peerings in a Virtual Network.
     */
    virtualNetworkPeerings?: pulumi.Input<pulumi.Input<inputs.network.v20181001.VirtualNetworkPeeringArgs>[]>;
}
