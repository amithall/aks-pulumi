...
export declare class SecurityRule extends pulumi.CustomResource {
     ...
     */
    readonly destinationApplicationSecurityGroups: pulumi.Output<outputs.network.v20181001.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     ...
     */
    readonly sourceApplicationSecurityGroups: pulumi.Output<outputs.network.v20181001.ApplicationSecurityGroupResponse[] | undefined>;
    /**
...
export interface SecurityRuleArgs {
     ...
     * The network traffic is allowed or denied. Possible values are: 'Allow' and 'Deny'.
     */
    access: pulumi.Input<string | enums.network.v20181001.SecurityRuleAccess>;
    /**
     * A description for this rule. Restricted to 140 chars.
     */
     ...
     * The application security group specified as destination.
     */
    destinationApplicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20181001.ApplicationSecurityGroupArgs>[]>;
    /**
     * The destination port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
     */
     ...
     * Network protocol this rule applies to. Possible values are 'Tcp', 'Udp', and '*'.
     */
    protocol: pulumi.Input<string | enums.network.v20181001.SecurityRuleProtocol>;
    /**
     * The provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
     ...
     * The application security group specified as source.
     */
    sourceApplicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20181001.ApplicationSecurityGroupArgs>[]>;
    /**
     * The source port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
     */
