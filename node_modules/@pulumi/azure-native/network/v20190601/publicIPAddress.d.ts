...
export declare class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    readonly ddosSettings: pulumi.Output<outputs.network.v20190601.DdosSettingsResponse | undefined>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20190601.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfiguration: pulumi.Output<outputs.network.v20190601.IPConfigurationResponse>;
    /**
     ...
     */
    readonly publicIPPrefix: pulumi.Output<outputs.network.v20190601.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20190601.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The DDoS protection custom policy associated with the public IP address.
     */
    ddosSettings?: pulumi.Input<inputs.network.v20190601.DdosSettingsArgs>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20190601.PublicIPAddressDnsSettingsArgs>;
    /**
     * Resource ID.
     */
     ...
     * The list of tags associated with the public IP address.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.network.v20190601.IpTagArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The public IP address version.
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.network.v20190601.IPVersion>;
    /**
     * The public IP address allocation method.
     */
    publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20190601.IPAllocationMethod>;
    /**
     * The Public IP Prefix this Public IP Address should be allocated from.
     */
    publicIPPrefix?: pulumi.Input<inputs.network.v20190601.SubResourceArgs>;
    /**
     ...
     * The public IP address SKU.
     */
    sku?: pulumi.Input<inputs.network.v20190601.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
