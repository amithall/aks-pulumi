...
export declare class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
     ...
     */
    readonly ipsecPolicies: pulumi.Output<outputs.network.v20190601.IpsecPolicyResponse[] | undefined>;
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2: pulumi.Output<outputs.network.v20190601.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly peer: pulumi.Output<outputs.network.v20190601.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly tunnelConnectionStatus: pulumi.Output<outputs.network.v20190601.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualNetworkGateway1: pulumi.Output<outputs.network.v20190601.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2: pulumi.Output<outputs.network.v20190601.VirtualNetworkGatewayResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * Connection protocol used for this connection.
     */
    connectionProtocol?: pulumi.Input<string | enums.network.v20190601.VirtualNetworkGatewayConnectionProtocol>;
    /**
     * Gateway connection type.
     */
    connectionType: pulumi.Input<string | enums.network.v20190601.VirtualNetworkGatewayConnectionType>;
    /**
     * EnableBgp flag.
     */
     ...
     * The IPSec Policies to be considered by this connection.
     */
    ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20190601.IpsecPolicyArgs>[]>;
    /**
     * The reference to local network gateway resource.
     */
    localNetworkGateway2?: pulumi.Input<inputs.network.v20190601.LocalNetworkGatewayArgs>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    peer?: pulumi.Input<inputs.network.v20190601.SubResourceArgs>;
    /**
     ...
     * The reference to virtual network gateway resource.
     */
    virtualNetworkGateway1: pulumi.Input<inputs.network.v20190601.VirtualNetworkGatewayArgs>;
    /**
     * The reference to virtual network gateway resource.
     */
    virtualNetworkGateway2?: pulumi.Input<inputs.network.v20190601.VirtualNetworkGatewayArgs>;
    /**
