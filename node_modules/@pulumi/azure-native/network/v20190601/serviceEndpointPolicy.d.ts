...
export declare class ServiceEndpointPolicy extends pulumi.CustomResource {
     ...
     */
    readonly serviceEndpointPolicyDefinitions: pulumi.Output<outputs.network.v20190601.ServiceEndpointPolicyDefinitionResponse[] | undefined>;
    /**
...
export interface ServiceEndpointPolicyArgs {
     ...
     * A collection of service endpoint policy definitions of the service endpoint policy.
     */
    serviceEndpointPolicyDefinitions?: pulumi.Input<pulumi.Input<inputs.network.v20190601.ServiceEndpointPolicyDefinitionArgs>[]>;
    /**
