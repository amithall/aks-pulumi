...
export declare class InterfaceEndpoint extends pulumi.CustomResource {
     ...
     */
    readonly endpointService: pulumi.Output<outputs.network.v20181201.EndpointServiceResponse | undefined>;
    /**
     ...
     */
    readonly subnet: pulumi.Output<outputs.network.v20181201.SubnetResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface InterfaceEndpointArgs {
     ...
     * A reference to the service being brought into the virtual network.
     */
    endpointService?: pulumi.Input<inputs.network.v20181201.EndpointServiceArgs>;
    /**
     * A first-party service's FQDN that is mapped to the private IP allocated via this interface endpoint.
     */
     ...
     * The ID of the subnet from which the private IP will be allocated.
     */
    subnet?: pulumi.Input<inputs.network.v20181201.SubnetArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
