...
export declare class NetworkInterface extends pulumi.CustomResource {
     ...
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20170901.NetworkInterfaceDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20170901.NetworkInterfaceIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly virtualMachine: pulumi.Output<outputs.network.v20170901.SubResourceResponse | undefined>;
    /**
...
export interface NetworkInterfaceArgs {
     ...
     * The DNS settings in network interface.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20170901.NetworkInterfaceDnsSettingsArgs>;
    /**
     * If the network interface is accelerated networking enabled.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20170901.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference of the NetworkSecurityGroup resource.
     */
    networkSecurityGroup?: pulumi.Input<inputs.network.v20170901.NetworkSecurityGroupArgs>;
    /**
     * Gets whether this is a primary network interface on a virtual machine.
     */
     ...
     * The reference of a virtual machine.
     */
    virtualMachine?: pulumi.Input<inputs.network.v20170901.SubResourceArgs>;
}
