...
export interface SubnetArgs {
     ...
     * Gets an array of references to the external resources using subnet.
     */
    resourceNavigationLinks?: pulumi.Input<pulumi.Input<inputs.network.v20170901.ResourceNavigationLinkArgs>[]>;
    /**
     * The reference of the RouteTable resource.
     */
    routeTable?: pulumi.Input<inputs.network.v20170901.RouteTableArgs>;
    /**
     * An array of service endpoints.
     */
    serviceEndpoints?: pulumi.Input<pulumi.Input<inputs.network.v20170901.ServiceEndpointPropertiesFormatArgs>[]>;
    /**
