...
export declare class VirtualNetwork extends pulumi.CustomResource {
     ...
     */
    readonly addressSpace: pulumi.Output<outputs.network.v20170901.AddressSpaceResponse | undefined>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    readonly dhcpOptions: pulumi.Output<outputs.network.v20170901.DhcpOptionsResponse | undefined>;
    /**
     ...
     */
    readonly subnets: pulumi.Output<outputs.network.v20170901.SubnetResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetworkPeerings: pulumi.Output<outputs.network.v20170901.VirtualNetworkPeeringResponse[] | undefined>;
    /**
...
export interface VirtualNetworkArgs {
     ...
     * The AddressSpace that contains an array of IP address ranges that can be used by subnets.
     */
    addressSpace?: pulumi.Input<inputs.network.v20170901.AddressSpaceArgs>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    dhcpOptions?: pulumi.Input<inputs.network.v20170901.DhcpOptionsArgs>;
    /**
     * Indicates if DDoS protection is enabled for all the protected resources in a Virtual Network.
     */
     ...
     * A list of subnets in a Virtual Network.
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.network.v20170901.SubnetArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * A list of peerings in a Virtual Network.
     */
    virtualNetworkPeerings?: pulumi.Input<pulumi.Input<inputs.network.v20170901.VirtualNetworkPeeringArgs>[]>;
}
