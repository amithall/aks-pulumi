...
export declare class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20170901.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfiguration: pulumi.Output<outputs.network.v20170901.IPConfigurationResponse>;
    /**
     * Resource location.
     */
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20170901.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The FQDN of the DNS record associated with the public IP address.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20170901.PublicIPAddressDnsSettingsArgs>;
    /**
     * Resource ID.
     */
     ...
     * The public IP address version. Possible values are: 'IPv4' and 'IPv6'.
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.network.v20170901.IPVersion>;
    /**
     * The public IP allocation method. Possible values are: 'Static' and 'Dynamic'.
     */
    publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20170901.IPAllocationMethod>;
    /**
     ...
     * The public IP address SKU.
     */
    sku?: pulumi.Input<inputs.network.v20170901.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
