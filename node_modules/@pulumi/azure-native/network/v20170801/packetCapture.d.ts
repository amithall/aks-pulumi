...
export interface PacketCaptureArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.network.v20170801.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    storageLocation: pulumi.Input<inputs.network.v20170801.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
