...
export declare class RouteFilter extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<outputs.network.v20180401.RouteFilterRuleResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20180401.RouteFilterRuleArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
