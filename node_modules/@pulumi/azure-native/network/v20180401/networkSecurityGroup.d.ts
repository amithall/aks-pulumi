...
export declare class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    readonly defaultSecurityRules: pulumi.Output<outputs.network.v20180401.SecurityRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly networkInterfaces: pulumi.Output<outputs.network.v20180401.NetworkInterfaceResponse[]>;
    /**
     ...
     */
    readonly securityRules: pulumi.Output<outputs.network.v20180401.SecurityRuleResponse[] | undefined>;
    /**
     * A collection of references to subnets.
     */
    readonly subnets: pulumi.Output<outputs.network.v20180401.SubnetResponse[]>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityGroupArgs {
     ...
     * The default security rules of network security group.
     */
    defaultSecurityRules?: pulumi.Input<pulumi.Input<inputs.network.v20180401.SecurityRuleArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * A collection of security rules of the network security group.
     */
    securityRules?: pulumi.Input<pulumi.Input<inputs.network.v20180401.SecurityRuleArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
