...
export declare class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20180401.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfiguration: pulumi.Output<outputs.network.v20180401.IPConfigurationResponse>;
    /**
     * The list of tags associated with the public IP address.
     */
    readonly ipTags: pulumi.Output<outputs.network.v20180401.IpTagResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20180401.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The FQDN of the DNS record associated with the public IP address.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20180401.PublicIPAddressDnsSettingsArgs>;
    /**
     * Resource ID.
     */
     ...
     * The list of tags associated with the public IP address.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.network.v20180401.IpTagArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The public IP address version. Possible values are: 'IPv4' and 'IPv6'.
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.network.v20180401.IPVersion>;
    /**
     * The public IP allocation method. Possible values are: 'Static' and 'Dynamic'.
     */
    publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20180401.IPAllocationMethod>;
    /**
     ...
     * The public IP address SKU.
     */
    sku?: pulumi.Input<inputs.network.v20180401.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
