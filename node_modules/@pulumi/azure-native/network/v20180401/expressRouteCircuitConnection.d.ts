...
export declare class ExpressRouteCircuitConnection extends pulumi.CustomResource {
     ...
     */
    readonly expressRouteCircuitPeering: pulumi.Output<outputs.network.v20180401.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly peerExpressRouteCircuitPeering: pulumi.Output<outputs.network.v20180401.SubResourceResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitConnectionArgs {
     ...
     * Reference to Express Route Circuit Private Peering Resource of the circuit initiating connection.
     */
    expressRouteCircuitPeering?: pulumi.Input<inputs.network.v20180401.SubResourceArgs>;
    /**
     * Resource ID.
     */
     ...
     * Reference to Express Route Circuit Private Peering Resource of the peered circuit.
     */
    peerExpressRouteCircuitPeering?: pulumi.Input<inputs.network.v20180401.SubResourceArgs>;
    /**
