...
export interface ApplicationGatewayArgs {
     ...
     * Authentication certificates of the application gateway resource.
     */
    authenticationCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayAuthenticationCertificateArgs>[]>;
    /**
     * Autoscale Configuration.
     */
    autoscaleConfiguration?: pulumi.Input<inputs.network.v20180401.ApplicationGatewayAutoscaleConfigurationArgs>;
    /**
     * Backend address pool of the application gateway resource.
     */
    backendAddressPools?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayBackendAddressPoolArgs>[]>;
    /**
     * Backend http settings of the application gateway resource.
     */
    backendHttpSettingsCollection?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayBackendHttpSettingsArgs>[]>;
    /**
     * Whether FIPS is enabled on the application gateway resource.
     */
     ...
     * Frontend IP addresses of the application gateway resource.
     */
    frontendIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayFrontendIPConfigurationArgs>[]>;
    /**
     * Frontend ports of the application gateway resource.
     */
    frontendPorts?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayFrontendPortArgs>[]>;
    /**
     * Subnets of application the gateway resource.
     */
    gatewayIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayIPConfigurationArgs>[]>;
    /**
     * Http listeners of the application gateway resource.
     */
    httpListeners?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayHttpListenerArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Probes of the application gateway resource.
     */
    probes?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayProbeArgs>[]>;
    /**
     * Provisioning state of the application gateway resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
     ...
     * Redirect configurations of the application gateway resource.
     */
    redirectConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayRedirectConfigurationArgs>[]>;
    /**
     * Request routing rules of the application gateway resource.
     */
    requestRoutingRules?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayRequestRoutingRuleArgs>[]>;
    /**
     ...
     * SKU of the application gateway resource.
     */
    sku?: pulumi.Input<inputs.network.v20180401.ApplicationGatewaySkuArgs>;
    /**
     * SSL certificates of the application gateway resource.
     */
    sslCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewaySslCertificateArgs>[]>;
    /**
     * SSL policy of the application gateway resource.
     */
    sslPolicy?: pulumi.Input<inputs.network.v20180401.ApplicationGatewaySslPolicyArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * URL path map of the application gateway resource.
     */
    urlPathMaps?: pulumi.Input<pulumi.Input<inputs.network.v20180401.ApplicationGatewayUrlPathMapArgs>[]>;
    /**
     * Web application firewall configuration.
     */
    webApplicationFirewallConfiguration?: pulumi.Input<inputs.network.v20180401.ApplicationGatewayWebApplicationFirewallConfigurationArgs>;
    /**
     * A list of availability zones denoting where the resource needs to come from.
     */
