...
export declare class VirtualHub extends pulumi.CustomResource {
     ...
     */
    readonly hubVirtualNetworkConnections: pulumi.Output<outputs.network.v20180401.HubVirtualNetworkConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface VirtualHubArgs {
     ...
     * list of all vnet connections with this VirtualHub.
     */
    hubVirtualNetworkConnections?: pulumi.Input<pulumi.Input<inputs.network.v20180401.HubVirtualNetworkConnectionArgs>[]>;
    /**
     * Resource ID.
     */
