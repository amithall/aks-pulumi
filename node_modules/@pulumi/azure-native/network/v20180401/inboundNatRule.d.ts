...
export declare class InboundNatRule extends pulumi.CustomResource {
     ...
     */
    readonly backendIPConfiguration: pulumi.Output<outputs.network.v20180401.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    readonly frontendIPConfiguration: pulumi.Output<outputs.network.v20180401.SubResourceResponse | undefined>;
    /**
...
export interface InboundNatRuleArgs {
     ...
     * A reference to frontend IP addresses.
     */
    frontendIPConfiguration?: pulumi.Input<inputs.network.v20180401.SubResourceArgs>;
    /**
     * The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values range from 1 to 65534.
     */
     ...
     * The transport protocol for the endpoint. Possible values are 'Udp' or 'Tcp' or 'All'.
     */
    protocol?: pulumi.Input<string | enums.network.v20180401.TransportProtocol>;
    /**
     * Gets the provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
