...
export interface ListActiveConnectivityConfigurationResult {
     ...
     */
    readonly value?: outputs.network.v20210201preview.ActiveConnectivityConfigurationResponse[];
}
export declare function listActiveConnectivityConfigurationOutput(args: ListActiveConnectivityConfigurationOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListActiveConnectivityConfigurationResult>;
