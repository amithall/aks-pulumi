 ...
 */
export declare class NspProfile extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NspProfile;
    /**
     * Returns true if the given object is an instance of NspProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NspProfile;
    /**
     * Version number that increases with every update to access rules within the profile.
     */
    readonly accessRulesVersion: pulumi.Output<string>;
    /**
     * Gets the enabled log categories.
     */
    readonly enabledLogCategories: pulumi.Output<outputs.network.v20210201preview.LoggingCategoryResponse[] | undefined>;
    /**
     * Resource location.
     */
