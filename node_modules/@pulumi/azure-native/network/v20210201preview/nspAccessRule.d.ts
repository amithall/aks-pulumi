 ...
 */
export declare class NspAccessRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NspAccessRule;
    /**
     * Returns true if the given object is an instance of NspAccessRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NspAccessRule;
    /**
     ...
     */
    readonly fullyQualifiedDomainNames: pulumi.Output<string[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly networkSecurityPerimeters: pulumi.Output<outputs.network.v20210201preview.PerimeterBasedAccessRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly subscriptions: pulumi.Output<string[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface NspAccessRuleArgs {
     ...
     * Direction that specifies whether the access rules is inbound/outbound.
     */
    direction?: pulumi.Input<string | enums.network.v20210201preview.AccessRuleDirection>;
    /**
     * Outbound rules fully qualified domain name format.
     */
     ...
     * Inbound rule specified by the perimeter id.
     */
    networkSecurityPerimeters?: pulumi.Input<pulumi.Input<inputs.network.v20210201preview.PerimeterBasedAccessRuleArgs>[]>;
    /**
