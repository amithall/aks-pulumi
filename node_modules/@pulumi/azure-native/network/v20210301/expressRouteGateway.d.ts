...
export declare class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    readonly autoScaleConfiguration: pulumi.Output<outputs.network.v20210301.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    readonly expressRouteConnections: pulumi.Output<outputs.network.v20210301.ExpressRouteConnectionResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly virtualHub: pulumi.Output<outputs.network.v20210301.VirtualHubIdResponse>;
    /**
...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    autoScaleConfiguration?: pulumi.Input<inputs.network.v20210301.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    virtualHub: pulumi.Input<inputs.network.v20210301.VirtualHubIdArgs>;
}
