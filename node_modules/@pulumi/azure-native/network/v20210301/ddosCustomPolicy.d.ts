...
export declare class DdosCustomPolicy extends pulumi.CustomResource {
     ...
     */
    readonly protocolCustomSettings: pulumi.Output<outputs.network.v20210301.ProtocolCustomSettingsFormatResponse[] | undefined>;
    /**
     ...
     */
    readonly publicIPAddresses: pulumi.Output<outputs.network.v20210301.SubResourceResponse[]>;
    /**
...
export interface DdosCustomPolicyArgs {
     ...
     * The protocol-specific DDoS policy customization parameters.
     */
    protocolCustomSettings?: pulumi.Input<pulumi.Input<inputs.network.v20210301.ProtocolCustomSettingsFormatArgs>[]>;
    /**
