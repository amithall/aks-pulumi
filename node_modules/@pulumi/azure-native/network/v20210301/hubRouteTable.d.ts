...
export declare class HubRouteTable extends pulumi.CustomResource {
     ...
     * List of all routes.
     */
    readonly routes: pulumi.Output<outputs.network.v20210301.HubRouteResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface HubRouteTableArgs {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20210301.HubRouteArgs>[]>;
    /**
