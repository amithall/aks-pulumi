...
export interface GetFirewallPolicyRuleCollectionGroupResult {
     ...
     */
    readonly ruleCollections?: (outputs.network.v20210301.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20210301.FirewallPolicyNatRuleCollectionResponse)[];
    /**
     * Rule Group type.
     */
    readonly type: string;
}
export declare function getFirewallPolicyRuleCollectionGroupOutput(args: GetFirewallPolicyRuleCollectionGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFirewallPolicyRuleCollectionGroupResult>;
