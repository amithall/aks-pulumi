...
export declare class VirtualHubBgpConnection extends pulumi.CustomResource {
     ...
     */
    readonly hubVirtualNetworkConnection: pulumi.Output<outputs.network.v20210301.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<inputs.network.v20210301.SubResourceArgs>;
    /**
     * Resource ID.
     */
