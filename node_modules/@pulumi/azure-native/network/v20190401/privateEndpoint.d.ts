...
export declare class PrivateEndpoint extends pulumi.CustomResource {
     ...
     */
    readonly manualPrivateLinkServiceConnections: pulumi.Output<outputs.network.v20190401.PrivateLinkServiceConnectionResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    readonly privateLinkServiceConnections: pulumi.Output<outputs.network.v20190401.PrivateLinkServiceConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly subnet: pulumi.Output<outputs.network.v20190401.SubnetResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PrivateEndpointArgs {
     ...
     * A grouping of information about the connection to the remote resource. Used when the network admin does not have access to approve connections to the remote resource.
     */
    manualPrivateLinkServiceConnections?: pulumi.Input<pulumi.Input<inputs.network.v20190401.PrivateLinkServiceConnectionArgs>[]>;
    /**
     ...
     * A grouping of information about the connection to the remote resource.
     */
    privateLinkServiceConnections?: pulumi.Input<pulumi.Input<inputs.network.v20190401.PrivateLinkServiceConnectionArgs>[]>;
    /**
     ...
     * The ID of the subnet from which the private IP will be allocated.
     */
    subnet?: pulumi.Input<inputs.network.v20190401.SubnetArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
