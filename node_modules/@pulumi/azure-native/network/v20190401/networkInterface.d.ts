...
export declare class NetworkInterface extends pulumi.CustomResource {
     ...
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20190401.NetworkInterfaceDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20190401.NetworkInterfaceIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.network.v20190401.PrivateEndpointResponse>;
    /**
     ...
     */
    readonly tapConfigurations: pulumi.Output<outputs.network.v20190401.NetworkInterfaceTapConfigurationResponse[] | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualMachine: pulumi.Output<outputs.network.v20190401.SubResourceResponse>;
    /**
...
export interface NetworkInterfaceArgs {
     ...
     * The DNS settings in network interface.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20190401.NetworkInterfaceDnsSettingsArgs>;
    /**
     * If the network interface is accelerated networking enabled.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190401.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference of the NetworkSecurityGroup resource.
     */
    networkSecurityGroup?: pulumi.Input<inputs.network.v20190401.NetworkSecurityGroupArgs>;
    /**
     * Gets whether this is a primary network interface on a virtual machine.
     */
     ...
     * A list of TapConfigurations of the network interface.
     */
    tapConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190401.NetworkInterfaceTapConfigurationArgs>[]>;
}
