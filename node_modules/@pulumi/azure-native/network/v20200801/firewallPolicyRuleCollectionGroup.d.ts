...
export declare class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
     ...
     */
    readonly ruleCollections: pulumi.Output<(outputs.network.v20200801.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20200801.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20200801.FirewallPolicyFilterRuleCollectionArgs | inputs.network.v20200801.FirewallPolicyNatRuleCollectionArgs>[]>;
}
