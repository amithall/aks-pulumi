...
export declare class FirewallPolicyRuleGroup extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<(outputs.network.v20190701.FirewallPolicyFilterRuleResponse | outputs.network.v20190701.FirewallPolicyNatRuleResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * Group of Firewall Policy rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20190701.FirewallPolicyFilterRuleArgs | inputs.network.v20190701.FirewallPolicyNatRuleArgs>[]>;
}
