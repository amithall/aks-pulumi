...
export declare class VirtualNetworkGateway extends pulumi.CustomResource {
     ...
     */
    readonly bgpSettings: pulumi.Output<outputs.network.v20190701.BgpSettingsResponse | undefined>;
    /**
     ...
     */
    readonly gatewayDefaultSite: pulumi.Output<outputs.network.v20190701.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20190701.VirtualNetworkGatewayIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20190701.VirtualNetworkGatewaySkuResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    readonly vpnClientConfiguration: pulumi.Output<outputs.network.v20190701.VpnClientConfigurationResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayArgs {
     ...
     * The reference of the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
     */
    customRoutes?: pulumi.Input<inputs.network.v20190701.AddressSpaceArgs>;
    /**
     * Whether BGP is enabled for this virtual network gateway or not.
     */
     ...
     * The reference of the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    gatewayDefaultSite?: pulumi.Input<inputs.network.v20190701.SubResourceArgs>;
    /**
     * The type of this virtual network gateway.
     */
    gatewayType?: pulumi.Input<string | enums.network.v20190701.VirtualNetworkGatewayType>;
    /**
     * Resource ID.
     */
     ...
     * IP configurations for virtual network gateway.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190701.VirtualNetworkGatewayIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference of the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
     */
    sku?: pulumi.Input<inputs.network.v20190701.VirtualNetworkGatewaySkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    vpnClientConfiguration?: pulumi.Input<inputs.network.v20190701.VpnClientConfigurationArgs>;
    /**
     * The generation for this VirtualNetworkGateway. Must be None if gatewayType is not VPN.
     */
    vpnGatewayGeneration?: pulumi.Input<string | enums.network.v20190701.VpnGatewayGeneration>;
    /**
     * The type of this virtual network gateway.
     */
    vpnType?: pulumi.Input<string | enums.network.v20190701.VpnType>;
}
