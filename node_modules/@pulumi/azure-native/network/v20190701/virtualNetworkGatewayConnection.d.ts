...
export declare class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
     ...
     */
    readonly ipsecPolicies: pulumi.Output<outputs.network.v20190701.IpsecPolicyResponse[] | undefined>;
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2: pulumi.Output<outputs.network.v20190701.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly peer: pulumi.Output<outputs.network.v20190701.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly trafficSelectorPolicies: pulumi.Output<outputs.network.v20190701.TrafficSelectorPolicyResponse[] | undefined>;
    /**
     * Collection of all tunnels' connection health status.
     */
    readonly tunnelConnectionStatus: pulumi.Output<outputs.network.v20190701.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualNetworkGateway1: pulumi.Output<outputs.network.v20190701.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2: pulumi.Output<outputs.network.v20190701.VirtualNetworkGatewayResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * Connection protocol used for this connection.
     */
    connectionProtocol?: pulumi.Input<string | enums.network.v20190701.VirtualNetworkGatewayConnectionProtocol>;
    /**
     * Gateway connection type.
     */
    connectionType: pulumi.Input<string | enums.network.v20190701.VirtualNetworkGatewayConnectionType>;
    /**
     * EnableBgp flag.
     */
     ...
     * The IPSec Policies to be considered by this connection.
     */
    ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20190701.IpsecPolicyArgs>[]>;
    /**
     * The reference to local network gateway resource.
     */
    localNetworkGateway2?: pulumi.Input<inputs.network.v20190701.LocalNetworkGatewayArgs>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    peer?: pulumi.Input<inputs.network.v20190701.SubResourceArgs>;
    /**
     ...
     * The Traffic Selector Policies to be considered by this connection.
     */
    trafficSelectorPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20190701.TrafficSelectorPolicyArgs>[]>;
    /**
     * Enable policy-based traffic selectors.
     */
     ...
     * The reference to virtual network gateway resource.
     */
    virtualNetworkGateway1: pulumi.Input<inputs.network.v20190701.VirtualNetworkGatewayArgs>;
    /**
     * The reference to virtual network gateway resource.
     */
    virtualNetworkGateway2?: pulumi.Input<inputs.network.v20190701.VirtualNetworkGatewayArgs>;
    /**
