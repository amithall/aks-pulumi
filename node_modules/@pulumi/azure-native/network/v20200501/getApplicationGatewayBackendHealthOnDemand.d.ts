...
export interface GetApplicationGatewayBackendHealthOnDemandArgs {
     ...
     */
    backendAddressPool?: inputs.network.v20200501.SubResource;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: inputs.network.v20200501.SubResource;
    /**
     ...
     */
    match?: inputs.network.v20200501.ApplicationGatewayProbeHealthResponseMatch;
    /**
     ...
     */
    protocol?: string | enums.network.v20200501.ApplicationGatewayProtocol;
    /**
...
export interface GetApplicationGatewayBackendHealthOnDemandOutputArgs {
     ...
     * Reference to backend pool of application gateway to which probe request will be sent.
     */
    backendAddressPool?: pulumi.Input<inputs.network.v20200501.SubResourceArgs>;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: pulumi.Input<inputs.network.v20200501.SubResourceArgs>;
    /**
     * Expands BackendAddressPool and BackendHttpSettings referenced in backend health.
     */
     ...
     * Criterion for classifying a healthy probe response.
     */
    match?: pulumi.Input<inputs.network.v20200501.ApplicationGatewayProbeHealthResponseMatchArgs>;
    /**
     * Relative path of probe. Valid path starts from '/'. Probe is sent to <Protocol>://<host>:<port><path>.
     */
     ...
     * The protocol used for the probe.
     */
    protocol?: pulumi.Input<string | enums.network.v20200501.ApplicationGatewayProtocol>;
    /**
     * The name of the resource group.
     */
