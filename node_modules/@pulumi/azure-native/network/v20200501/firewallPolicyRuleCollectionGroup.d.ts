...
export declare class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
     ...
     */
    readonly ruleCollections: pulumi.Output<(outputs.network.v20200501.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20200501.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20200501.FirewallPolicyFilterRuleCollectionArgs | inputs.network.v20200501.FirewallPolicyNatRuleCollectionArgs>[]>;
}
