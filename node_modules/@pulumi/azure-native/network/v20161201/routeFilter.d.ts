...
export declare class RouteFilter extends pulumi.CustomResource {
     ...
     */
    readonly peerings: pulumi.Output<outputs.network.v20161201.ExpressRouteCircuitPeeringResponse[]>;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.network.v20161201.RouteFilterRuleResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20161201.RouteFilterRuleArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
