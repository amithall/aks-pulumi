...
export declare class ExpressRouteCircuit extends pulumi.CustomResource {
     ...
     */
    readonly authorizations: pulumi.Output<outputs.network.v20161201.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    readonly peerings: pulumi.Output<outputs.network.v20161201.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    readonly serviceProviderProperties: pulumi.Output<outputs.network.v20161201.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    readonly sku: pulumi.Output<outputs.network.v20161201.ExpressRouteCircuitSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface ExpressRouteCircuitArgs {
     ...
     * The list of authorizations.
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.network.v20161201.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     ...
     * The list of peerings.
     */
    peerings?: pulumi.Input<pulumi.Input<inputs.network.v20161201.ExpressRouteCircuitPeeringArgs>[]>;
    /**
     * Gets the provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<inputs.network.v20161201.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource. Possible values are 'NotProvisioned', 'Provisioning', 'Provisioned', and 'Deprovisioning'.
     */
    serviceProviderProvisioningState?: pulumi.Input<string | enums.network.v20161201.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    sku?: pulumi.Input<inputs.network.v20161201.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
