...
export declare class NetworkManager extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkManager;
    /**
     ...
     * Scope Access.
     */
    readonly networkManagerScopeAccesses: pulumi.Output<string[]>;
    /**
     * Scope of Network Manager.
     */
    readonly networkManagerScopes: pulumi.Output<outputs.network.v20210501preview.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | enums.network.v20210501preview.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<inputs.network.v20210501preview.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**
