 ...
 */
export declare class UserRuleCollection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserRuleCollection;
    /**
     * Returns true if the given object is an instance of UserRuleCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is UserRuleCollection;
    /**
     * Groups for configuration
     */
    readonly appliesToGroups: pulumi.Output<outputs.network.v20210501preview.NetworkManagerSecurityGroupItemResponse[]>;
    /**
...
export interface UserRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20210501preview.NetworkManagerSecurityGroupItemArgs>[]>;
    /**
