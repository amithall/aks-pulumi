...
export interface GetExpressRouteConnectionResult {
     ...
     */
    readonly expressRouteCircuitPeering: outputs.network.v20210201.ExpressRouteCircuitPeeringIdResponse;
    /**
...
export declare function getExpressRouteConnectionOutput(args: GetExpressRouteConnectionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetExpressRouteConnectionResult>;
