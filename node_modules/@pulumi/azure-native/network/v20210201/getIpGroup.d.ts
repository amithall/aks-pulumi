...
export interface GetIpGroupResult {
     ...
     */
    readonly firewallPolicies: outputs.network.v20210201.SubResourceResponse[];
    /**
...
export declare function getIpGroupOutput(args: GetIpGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetIpGroupResult>;
