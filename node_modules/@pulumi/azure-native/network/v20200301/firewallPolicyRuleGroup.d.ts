...
export declare class FirewallPolicyRuleGroup extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<(outputs.network.v20200301.FirewallPolicyFilterRuleResponse | outputs.network.v20200301.FirewallPolicyNatRuleResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * Group of Firewall Policy rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20200301.FirewallPolicyFilterRuleArgs | inputs.network.v20200301.FirewallPolicyNatRuleArgs>[]>;
}
