...
export declare class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
     ...
     */
    readonly ipsecPolicies: pulumi.Output<outputs.network.v20170301.IpsecPolicyResponse[] | undefined>;
    /**
     * A common class for general resource information
     */
    readonly localNetworkGateway2: pulumi.Output<outputs.network.v20170301.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly peer: pulumi.Output<outputs.network.v20170301.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly tunnelConnectionStatus: pulumi.Output<outputs.network.v20170301.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     * A common class for general resource information
     */
    readonly virtualNetworkGateway1: pulumi.Output<outputs.network.v20170301.VirtualNetworkGatewayResponse>;
    /**
     * A common class for general resource information
     */
    readonly virtualNetworkGateway2: pulumi.Output<outputs.network.v20170301.VirtualNetworkGatewayResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * Gateway connection type. Possible values are: 'IPsec','Vnet2Vnet','ExpressRoute', and 'VPNClient.
     */
    connectionType: pulumi.Input<string | enums.network.v20170301.VirtualNetworkGatewayConnectionType>;
    /**
     * EnableBgp flag
     */
     ...
     * The IPSec Policies to be considered by this connection.
     */
    ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20170301.IpsecPolicyArgs>[]>;
    /**
     * A common class for general resource information
     */
    localNetworkGateway2?: pulumi.Input<inputs.network.v20170301.LocalNetworkGatewayArgs>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    peer?: pulumi.Input<inputs.network.v20170301.SubResourceArgs>;
    /**
     ...
     * A common class for general resource information
     */
    virtualNetworkGateway1: pulumi.Input<inputs.network.v20170301.VirtualNetworkGatewayArgs>;
    /**
     * A common class for general resource information
     */
    virtualNetworkGateway2?: pulumi.Input<inputs.network.v20170301.VirtualNetworkGatewayArgs>;
    /**
