...
export interface GetApplicationGatewayBackendHealthOnDemandResult {
     ...
     */
    readonly backendAddressPool?: outputs.network.v20190901.ApplicationGatewayBackendAddressPoolResponse;
    /**
     * Application gateway BackendHealthHttp settings.
     */
    readonly backendHealthHttpSettings?: outputs.network.v20190901.ApplicationGatewayBackendHealthHttpSettingsResponse;
}
...
export interface GetApplicationGatewayBackendHealthOnDemandOutputArgs {
     ...
     * Reference of backend pool of application gateway to which probe request will be sent.
     */
    backendAddressPool?: pulumi.Input<inputs.network.v20190901.SubResourceArgs>;
    /**
     * Reference of backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: pulumi.Input<inputs.network.v20190901.SubResourceArgs>;
    /**
     * Expands BackendAddressPool and BackendHttpSettings referenced in backend health.
     */
     ...
     * Criterion for classifying a healthy probe response.
     */
    match?: pulumi.Input<inputs.network.v20190901.ApplicationGatewayProbeHealthResponseMatchArgs>;
    /**
     * Relative path of probe. Valid path starts from '/'. Probe is sent to <Protocol>://<host>:<port><path>.
     */
     ...
     * The protocol used for the probe.
     */
    protocol?: pulumi.Input<string | enums.network.v20190901.ApplicationGatewayProtocol>;
    /**
     * The name of the resource group.
     */
