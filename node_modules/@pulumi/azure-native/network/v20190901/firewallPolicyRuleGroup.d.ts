...
export declare class FirewallPolicyRuleGroup extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<(outputs.network.v20190901.FirewallPolicyFilterRuleResponse | outputs.network.v20190901.FirewallPolicyNatRuleResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * Group of Firewall Policy rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20190901.FirewallPolicyFilterRuleArgs | inputs.network.v20190901.FirewallPolicyNatRuleArgs>[]>;
}
