...
export declare class Zone extends pulumi.CustomResource {
     ...
     */
    readonly registrationVirtualNetworks: pulumi.Output<outputs.network.SubResourceResponse[] | undefined>;
    /**
     * A list of references to virtual networks that resolve records in this DNS zone. This is a only when ZoneType is Private.
     */
    readonly resolutionVirtualNetworks: pulumi.Output<outputs.network.SubResourceResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface ZoneArgs {
     ...
     * A list of references to virtual networks that register hostnames in this DNS zone. This is a only when ZoneType is Private.
     */
    registrationVirtualNetworks?: pulumi.Input<pulumi.Input<inputs.network.SubResourceArgs>[]>;
    /**
     * A list of references to virtual networks that resolve records in this DNS zone. This is a only when ZoneType is Private.
     */
     ...
     * The type of this DNS zone (Public or Private).
     */
    zoneType?: pulumi.Input<enums.network.ZoneType>;
}
