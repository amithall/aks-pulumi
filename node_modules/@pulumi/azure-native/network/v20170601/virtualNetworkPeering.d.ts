...
export declare class VirtualNetworkPeering extends pulumi.CustomResource {
     ...
     */
    readonly remoteVirtualNetwork: pulumi.Output<outputs.network.v20170601.SubResourceResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering. Possible values are 'Initiated', 'Connected', and 'Disconnected'.
     */
    peeringState?: pulumi.Input<string | enums.network.v20170601.VirtualNetworkPeeringState>;
    /**
     * The provisioning state of the resource.
     */
     ...
     * The reference of the remote virtual network.
     */
    remoteVirtualNetwork?: pulumi.Input<inputs.network.v20170601.SubResourceArgs>;
    /**
