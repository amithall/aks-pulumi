...
export interface ListDatabasePrincipalsResult {
     ...
     */
    readonly value?: outputs.kusto.v20170907privatepreview.DatabasePrincipalResponse[];
}
export declare function listDatabasePrincipalsOutput(args: ListDatabasePrincipalsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListDatabasePrincipalsResult>;
