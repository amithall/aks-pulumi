 ...
 */
export declare class DataConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataConnection;
    /**
     * Returns true if the given object is an instance of DataConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataConnection;
    /**
...
export interface DataConnectionArgs {
     ...
     * Kind of the endpoint for the data connection
     */
    kind: pulumi.Input<string | enums.kusto.v20220201.DataConnectionKind>;
    /**
     * Resource location.
     */
