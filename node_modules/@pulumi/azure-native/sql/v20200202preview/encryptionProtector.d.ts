 ...
 */
export declare class EncryptionProtector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EncryptionProtector;
    /**
     * Returns true if the given object is an instance of EncryptionProtector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EncryptionProtector;
    /**
     ...
     */
    readonly serverKeyName: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly subregion: pulumi.Output<string>;
    /**
...
export interface EncryptionProtectorArgs {
     ...
     * The encryption protector type like 'ServiceManaged', 'AzureKeyVault'.
     */
    serverKeyType: pulumi.Input<string | enums.sql.v20200202preview.ServerKeyType>;
    /**
