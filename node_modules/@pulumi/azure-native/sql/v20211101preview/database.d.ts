...
export declare class Database extends pulumi.CustomResource {
     ...
     */
    readonly autoPauseDelay: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly currentSku: pulumi.Output<outputs.sql.v20211101preview.SkuResponse>;
    /**
     ...
     */
    readonly highAvailabilityReplicaCount: pulumi.Output<number | undefined>;
    /**
     * The Azure Active Directory identity of the database.
     */
    readonly identity: pulumi.Output<outputs.sql.v20211101preview.DatabaseIdentityResponse | undefined>;
    /**
     * Infra encryption is enabled for this database.
     */
    readonly isInfraEncryptionEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly maxLogSizeBytes: pulumi.Output<number>;
    /**
     ...
     */
    readonly minCapacity: pulumi.Output<number | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    readonly pausedDate: pulumi.Output<string>;
    /**
     * The Primary Delegated Identity Client id used for per database CMK - for internal use only
     */
    readonly primaryDelegatedIdentityClientId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly resumedDate: pulumi.Output<string>;
    /**
     ...
     * ````
     */
    readonly sku: pulumi.Output<outputs.sql.v20211101preview.SkuResponse | undefined>;
    /**
...
export interface DatabaseArgs {
     ...
     * Collation of the metadata catalog.
     */
    catalogCollation?: pulumi.Input<string | enums.sql.v20211101preview.CatalogCollationType>;
    /**
     * The collation of the database.
     */
     ...
     */
    createMode?: pulumi.Input<string | enums.sql.v20211101preview.CreateMode>;
    /**
     ...
     * The Azure Active Directory identity of the database.
     */
    identity?: pulumi.Input<inputs.sql.v20211101preview.DatabaseIdentityArgs>;
    /**
     * Whether or not this database is a ledger database, which means all tables in the database are ledger tables. Note: the value of this property cannot be changed after the database has been created.
     */
     ...
     * The license type to apply for this database. `LicenseIncluded` if you need a license, or `BasePrice` if you have a license and are eligible for the Azure Hybrid Benefit.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20211101preview.DatabaseLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region. Not applicable to a Hyperscale database within an elastic pool.
     */
    readScale?: pulumi.Input<string | enums.sql.v20211101preview.DatabaseReadScale>;
    /**
     ...
     * The storage account type to be used to store backups for this database.
     */
    requestedBackupStorageRedundancy?: pulumi.Input<string | enums.sql.v20211101preview.BackupStorageRedundancy>;
    /**
     ...
     */
    sampleName?: pulumi.Input<string | enums.sql.v20211101preview.SampleName>;
    /**
     * The secondary type of the database if it is a secondary.  Valid values are Geo and Named.
     */
    secondaryType?: pulumi.Input<string | enums.sql.v20211101preview.SecondaryType>;
    /**
     ...
     * ````
     */
    sku?: pulumi.Input<inputs.sql.v20211101preview.SkuArgs>;
    /**
