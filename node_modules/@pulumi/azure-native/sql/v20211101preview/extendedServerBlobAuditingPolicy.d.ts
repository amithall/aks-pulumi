 ...
 */
export declare class ExtendedServerBlobAuditingPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExtendedServerBlobAuditingPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExtendedServerBlobAuditingPolicy;
    /**
     ...
     * or [Diagnostic Settings PowerShell](https://go.microsoft.com/fwlink/?linkid=2033043)
     */
    readonly isDevopsAuditEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    constructor(name: string, args: ExtendedServerBlobAuditingPolicyArgs, opts?: pulumi.CustomResourceOptions);
}
/**
