 ...
 */
export declare class ExtendedDatabaseBlobAuditingPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExtendedDatabaseBlobAuditingPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExtendedDatabaseBlobAuditingPolicy;
    /**
     ...
     */
    readonly isAzureMonitorTargetEnabled: pulumi.Output<boolean | undefined>;
    /**
     * Specifies whether Managed Identity is used to access blob storage
     */
    readonly isManagedIdentityInUse: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly queueDelayMs: pulumi.Output<number | undefined>;
    /**
     ...
     */
    constructor(name: string, args: ExtendedDatabaseBlobAuditingPolicyArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * The set of arguments for constructing a ExtendedDatabaseBlobAuditingPolicy resource.
 */
export interface ExtendedDatabaseBlobAuditingPolicyArgs {
    /**
     * Specifies the Actions-Groups and Actions to audit.
     *
     * The recommended set of action groups to use is the following combination - this will audit all the queries and stored procedures executed against the database, as well as successful and failed logins:
     ...
     * Specifies the state of the audit. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
     */
    state: pulumi.Input<enums.sql.v20211101preview.BlobAuditingPolicyState>;
    /**
