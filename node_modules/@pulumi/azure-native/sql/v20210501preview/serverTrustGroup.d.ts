...
export declare class ServerTrustGroup extends pulumi.CustomResource {
     ...
     */
    readonly groupMembers: pulumi.Output<outputs.sql.v20210501preview.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<inputs.sql.v20210501preview.ServerInfoArgs>[]>;
    /**
