...
export declare class Database extends pulumi.CustomResource {
     ...
     */
    readonly currentSku: pulumi.Output<outputs.sql.v20210501preview.SkuResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20210501preview.DatabaseIdentityResponse | undefined>;
    /**
     ...
     * ````
     */
    readonly sku: pulumi.Output<outputs.sql.v20210501preview.SkuResponse | undefined>;
    /**
...
export interface DatabaseArgs {
     ...
     * Collation of the metadata catalog.
     */
    catalogCollation?: pulumi.Input<string | enums.sql.v20210501preview.CatalogCollationType>;
    /**
     * The collation of the database.
     */
     ...
     */
    createMode?: pulumi.Input<string | enums.sql.v20210501preview.CreateMode>;
    /**
     ...
     * The Azure Active Directory identity of the database.
     */
    identity?: pulumi.Input<inputs.sql.v20210501preview.DatabaseIdentityArgs>;
    /**
     * Whether or not this database is a ledger database, which means all tables in the database are ledger tables. Note: the value of this property cannot be changed after the database has been created.
     */
     ...
     * The license type to apply for this database. `LicenseIncluded` if you need a license, or `BasePrice` if you have a license and are eligible for the Azure Hybrid Benefit.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20210501preview.DatabaseLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The storage account type to be used to store backups for this database.
     */
    requestedBackupStorageRedundancy?: pulumi.Input<string | enums.sql.v20210501preview.BackupStorageRedundancy>;
    /**
     ...
     */
    sampleName?: pulumi.Input<string | enums.sql.v20210501preview.SampleName>;
    /**
     * The secondary type of the database if it is a secondary.  Valid values are Geo and Named.
     */
    secondaryType?: pulumi.Input<string | enums.sql.v20210501preview.SecondaryType>;
    /**
     ...
     * ````
     */
    sku?: pulumi.Input<inputs.sql.v20210501preview.SkuArgs>;
    /**
