...
export declare class ElasticPool extends pulumi.CustomResource {
     ...
     */
    readonly perDatabaseSettings: pulumi.Output<outputs.sql.v20210501preview.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
...
export interface ElasticPoolArgs {
     ...
     * The license type to apply for this elastic pool.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20210501preview.ElasticPoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The per database settings for the elastic pool.
     */
    perDatabaseSettings?: pulumi.Input<inputs.sql.v20210501preview.ElasticPoolPerDatabaseSettingsArgs>;
    /**
