 ...
 * A sensitivity label.
 */
export declare class ManagedDatabaseSensitivityLabel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedDatabaseSensitivityLabel;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedDatabaseSensitivityLabel;
    /**
     * The column name.
     */
...
export interface ManagedDatabaseSensitivityLabelArgs {
    ...
    rank?: pulumi.Input<enums.sql.v20210501preview.SensitivityLabelRank>;
    /**
