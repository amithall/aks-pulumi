 ...
 */
export declare class ServerTrustGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerTrustGroup;
    /**
     * Returns true if the given object is an instance of ServerTrustGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServerTrustGroup;
    /**
     * Group members information for the server trust group.
     */
    readonly groupMembers: pulumi.Output<outputs.sql.v20210801preview.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    readonly trustScopes: pulumi.Output<string[]>;
    /**
     * Resource type.
     */
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<inputs.sql.v20210801preview.ServerInfoArgs>[]>;
    /**
