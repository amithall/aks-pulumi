 ...
 */
export declare class JobTargetGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobTargetGroup;
    /**
     * Returns true if the given object is an instance of JobTargetGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is JobTargetGroup;
    /**
     * Members of the target group.
     */
    readonly members: pulumi.Output<outputs.sql.v20210801preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    members: pulumi.Input<pulumi.Input<inputs.sql.v20210801preview.JobTargetArgs>[]>;
    /**
