 ...
 */
export declare class ManagedServerDnsAlias extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedServerDnsAlias;
    /**
     * Returns true if the given object is an instance of ManagedServerDnsAlias.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ManagedServerDnsAlias;
    /**
     * The fully qualified DNS record for managed server alias
     */
    readonly azureDnsRecord: pulumi.Output<string>;
    /**
     * Resource name.
     */
