...
export declare class BlobContainer extends pulumi.CustomResource {
     ...
     */
    readonly immutabilityPolicy: pulumi.Output<outputs.storage.v20190401.ImmutabilityPolicyPropertiesResponse>;
    /**
     ...
     */
    readonly legalHold: pulumi.Output<outputs.storage.v20190401.LegalHoldPropertiesResponse>;
    /**
...
export interface BlobContainerArgs {
     ...
     * Specifies whether data in the container may be accessed publicly and the level of access.
     */
    publicAccess?: pulumi.Input<enums.storage.v20190401.PublicAccess>;
    /**
