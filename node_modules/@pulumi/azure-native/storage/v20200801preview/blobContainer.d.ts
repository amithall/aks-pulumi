...
export declare class BlobContainer extends pulumi.CustomResource {
     ...
     */
    readonly immutabilityPolicy: pulumi.Output<outputs.storage.v20200801preview.ImmutabilityPolicyPropertiesResponse>;
    /**
     ...
     */
    readonly legalHold: pulumi.Output<outputs.storage.v20200801preview.LegalHoldPropertiesResponse>;
    /**
...
export interface BlobContainerArgs {
     ...
     * Specifies whether data in the container may be accessed publicly and the level of access.
     */
    publicAccess?: pulumi.Input<enums.storage.v20200801preview.PublicAccess>;
    /**
