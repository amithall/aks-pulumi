...
export interface ListStorageAccountKeysResult {
     ...
     */
    readonly keys: outputs.storage.v20200801preview.StorageAccountKeyResponse[];
}
export declare function listStorageAccountKeysOutput(args: ListStorageAccountKeysOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListStorageAccountKeysResult>;
