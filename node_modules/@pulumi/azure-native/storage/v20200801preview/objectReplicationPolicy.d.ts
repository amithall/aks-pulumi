...
export declare class ObjectReplicationPolicy extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<outputs.storage.v20200801preview.ObjectReplicationPolicyRuleResponse[] | undefined>;
    /**
...
export interface ObjectReplicationPolicyArgs {
     ...
     * The storage account object replication rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.storage.v20200801preview.ObjectReplicationPolicyRuleArgs>[]>;
    /**
     * Required. Source account name.
     */
