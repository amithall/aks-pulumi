...
export declare class BlobInventoryPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobInventoryPolicy;
    /**
     ...
     */
    readonly policy: pulumi.Output<outputs.storage.v20200801preview.BlobInventoryPolicySchemaResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: pulumi.Output<outputs.storage.v20200801preview.SystemDataResponse>;
    /**
...
export interface BlobInventoryPolicyArgs {
     ...
     * The storage account blob inventory policy object. It is composed of policy rules.
     */
    policy: pulumi.Input<inputs.storage.v20200801preview.BlobInventoryPolicySchemaArgs>;
    /**
