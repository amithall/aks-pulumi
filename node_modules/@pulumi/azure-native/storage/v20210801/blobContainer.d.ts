...
export declare class BlobContainer extends pulumi.CustomResource {
     ...
     */
    readonly immutabilityPolicy: pulumi.Output<outputs.storage.v20210801.ImmutabilityPolicyPropertiesResponse>;
    /**
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    readonly immutableStorageWithVersioning: pulumi.Output<outputs.storage.v20210801.ImmutableStorageWithVersioningResponse | undefined>;
    /**
     ...
     */
    readonly legalHold: pulumi.Output<outputs.storage.v20210801.LegalHoldPropertiesResponse>;
    /**
...
export interface BlobContainerArgs {
     ...
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    immutableStorageWithVersioning?: pulumi.Input<inputs.storage.v20210801.ImmutableStorageWithVersioningArgs>;
    /**
     * A name-value pair to associate with the container as metadata.
     */
     ...
     * Specifies whether data in the container may be accessed publicly and the level of access.
     */
    publicAccess?: pulumi.Input<enums.storage.v20210801.PublicAccess>;
    /**
