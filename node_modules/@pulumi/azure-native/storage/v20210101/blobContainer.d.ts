...
export declare class BlobContainer extends pulumi.CustomResource {
     ...
     */
    readonly immutabilityPolicy: pulumi.Output<outputs.storage.v20210101.ImmutabilityPolicyPropertiesResponse>;
    /**
     ...
     */
    readonly legalHold: pulumi.Output<outputs.storage.v20210101.LegalHoldPropertiesResponse>;
    /**
...
export interface BlobContainerArgs {
     ...
     * Specifies whether data in the container may be accessed publicly and the level of access.
     */
    publicAccess?: pulumi.Input<enums.storage.v20210101.PublicAccess>;
    /**
