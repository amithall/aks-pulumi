...
export declare class BlobServiceProperties extends pulumi.CustomResource {
     ...
     */
    readonly changeFeed: pulumi.Output<outputs.storage.v20210101.ChangeFeedResponse | undefined>;
    /**
     * The blob service properties for container soft delete.
     */
    readonly containerDeleteRetentionPolicy: pulumi.Output<outputs.storage.v20210101.DeleteRetentionPolicyResponse | undefined>;
    /**
     * Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service.
     */
    readonly cors: pulumi.Output<outputs.storage.v20210101.CorsRulesResponse | undefined>;
    /**
     ...
     */
    readonly deleteRetentionPolicy: pulumi.Output<outputs.storage.v20210101.DeleteRetentionPolicyResponse | undefined>;
    /**
     ...
     */
    readonly lastAccessTimeTrackingPolicy: pulumi.Output<outputs.storage.v20210101.LastAccessTimeTrackingPolicyResponse | undefined>;
    /**
     ...
     */
    readonly restorePolicy: pulumi.Output<outputs.storage.v20210101.RestorePolicyPropertiesResponse | undefined>;
    /**
     * Sku name and tier.
     */
...
export interface BlobServicePropertiesArgs {
     ...
     * The blob service properties for change feed events.
     */
    changeFeed?: pulumi.Input<inputs.storage.v20210101.ChangeFeedArgs>;
    /**
     * The blob service properties for container soft delete.
     */
    containerDeleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210101.DeleteRetentionPolicyArgs>;
    /**
     * Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service.
     */
    cors?: pulumi.Input<inputs.storage.v20210101.CorsRulesArgs>;
    /**
     * DefaultServiceVersion indicates the default version to use for requests to the Blob service if an incoming request’s version is not specified. Possible values include version 2008-10-27 and all more recent versions.
     */
     ...
     * The blob service properties for blob soft delete.
     */
    deleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210101.DeleteRetentionPolicyArgs>;
    /**
     * Versioning is enabled if set to true.
     */
     ...
     * The blob service property to configure last access time based tracking policy.
     */
    lastAccessTimeTrackingPolicy?: pulumi.Input<inputs.storage.v20210101.LastAccessTimeTrackingPolicyArgs>;
    /**
     ...
     * The blob service properties for blob restore policy.
     */
    restorePolicy?: pulumi.Input<inputs.storage.v20210101.RestorePolicyPropertiesArgs>;
}
