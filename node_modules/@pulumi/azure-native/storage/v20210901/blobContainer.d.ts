...
export declare class BlobContainer extends pulumi.CustomResource {
     ...
     */
    readonly enableNfsV3AllSquash: pulumi.Output<boolean | undefined>;
    /**
     * Enable NFSv3 root squash on blob container.
     */
    readonly enableNfsV3RootSquash: pulumi.Output<boolean | undefined>;
    /**
     * Resource Etag.
     */
     ...
     */
    readonly immutabilityPolicy: pulumi.Output<outputs.storage.v20210901.ImmutabilityPolicyPropertiesResponse>;
    /**
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    readonly immutableStorageWithVersioning: pulumi.Output<outputs.storage.v20210901.ImmutableStorageWithVersioningResponse | undefined>;
    /**
     ...
     */
    readonly legalHold: pulumi.Output<outputs.storage.v20210901.LegalHoldPropertiesResponse>;
    /**
...
export interface BlobContainerArgs {
     ...
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    immutableStorageWithVersioning?: pulumi.Input<inputs.storage.v20210901.ImmutableStorageWithVersioningArgs>;
    /**
     * A name-value pair to associate with the container as metadata.
     */
     ...
     * Specifies whether data in the container may be accessed publicly and the level of access.
     */
    publicAccess?: pulumi.Input<enums.storage.v20210901.PublicAccess>;
    /**
