 ...
 */
export declare class CustomAssessmentAutomation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomAssessmentAutomation;
    /**
     ...
     */
    readonly supportedCloud: pulumi.Output<string | undefined>;
    /**
