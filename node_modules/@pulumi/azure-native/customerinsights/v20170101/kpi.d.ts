...
export declare class Kpi extends pulumi.CustomResource {
     ...
     * The aliases.
     */
    readonly aliases: pulumi.Output<outputs.customerinsights.v20170101.KpiAliasResponse[] | undefined>;
    /**
     ...
     * The KPI extracts.
     */
    readonly extracts: pulumi.Output<outputs.customerinsights.v20170101.KpiExtractResponse[] | undefined>;
    /**
     ...
     */
    readonly groupByMetadata: pulumi.Output<outputs.customerinsights.v20170101.KpiGroupByMetadataResponse[]>;
    /**
     * The KPI name.
     */
     ...
     */
    readonly participantProfilesMetadata: pulumi.Output<outputs.customerinsights.v20170101.KpiParticipantProfilesMetadataResponse[]>;
    /**
     * Provisioning state.
     */
     ...
     * The KPI thresholds.
     */
    readonly thresHolds: pulumi.Output<outputs.customerinsights.v20170101.KpiThresholdsResponse | undefined>;
    /**
     * Resource type.
     */
...
export interface KpiArgs {
     ...
     * The aliases.
     */
    aliases?: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170101.KpiAliasArgs>[]>;
    /**
     * The calculation window.
     */
    calculationWindow: pulumi.Input<enums.customerinsights.v20170101.CalculationWindowTypes>;
    /**
     * Name of calculation window field.
     */
     ...
     * The KPI extracts.
     */
    extracts?: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170101.KpiExtractArgs>[]>;
    /**
     * The filter expression for the KPI.
     */
     ...
     * The computation function for the KPI.
     */
    function: pulumi.Input<enums.customerinsights.v20170101.KpiFunctions>;
    /**
     * the group by properties for the KPI.
     */
     ...
     * The KPI thresholds.
     */
    thresHolds?: pulumi.Input<inputs.customerinsights.v20170101.KpiThresholdsArgs>;
    /**
     * The unit of measurement for the KPI.
     */
