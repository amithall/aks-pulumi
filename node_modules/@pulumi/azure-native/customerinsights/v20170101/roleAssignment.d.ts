...
export interface RoleAssignmentArgs {
     ...
     * Widget types set for the assignment.
     */
    conflationPolicies?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * Connectors set for the assignment.
     */
    connectors?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * Localized description for the metadata.
     */
     ...
     * Interactions set for the assignment.
     */
    interactions?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * Kpis set for the assignment.
     */
    kpis?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * Links set for the assignment.
     */
    links?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * The principals being assigned to.
     */
    principals: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170101.AssignmentPrincipalArgs>[]>;
    /**
     * Profiles set for the assignment.
     */
    profiles?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * The Role assignments set for the relationship links.
     */
    relationshipLinks?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * The Role assignments set for the relationships.
     */
    relationships?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     ...
     * Type of roles.
     */
    role: pulumi.Input<enums.customerinsights.v20170101.RoleTypes>;
    /**
     * The Role assignments set for the assignment.
     */
    roleAssignments?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * Sas Policies set for the assignment.
     */
    sasPolicies?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * The Role assignments set for the assignment.
     */
    segments?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * Views set for the assignment.
     */
    views?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
    /**
     * Widget types set for the assignment.
     */
    widgetTypes?: pulumi.Input<inputs.customerinsights.v20170101.ResourceSetDescriptionArgs>;
}
