...
export declare class SqlPool extends pulumi.CustomResource {
     ...
     * SQL pool SKU
     */
    readonly sku: pulumi.Output<outputs.synapse.v20210401preview.SkuResponse | undefined>;
    /**
...
export interface SqlPoolArgs {
     ...
     * Restore: Creates a sql pool by restoring a backup of a deleted sql  pool. SourceDatabaseId should be the sql pool's original resource ID. SourceDatabaseId and sourceDatabaseDeletionDate must be specified.
     */
    createMode?: pulumi.Input<string | enums.synapse.v20210401preview.CreateMode>;
    /**
     * Date the SQL pool was created
     */
     ...
     * SQL pool SKU
     */
    sku?: pulumi.Input<inputs.synapse.v20210401preview.SkuArgs>;
    /**
     * Source database to create from
     */
     ...
     * The storage account type used to store backups for this sql pool.
     */
    storageAccountType?: pulumi.Input<string | enums.synapse.v20210401preview.StorageAccountType>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
