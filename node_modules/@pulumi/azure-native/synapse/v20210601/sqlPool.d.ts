...
export declare class SqlPool extends pulumi.CustomResource {
     ...
     * SQL pool SKU
     */
    readonly sku: pulumi.Output<outputs.synapse.v20210601.SkuResponse | undefined>;
    /**
...
export interface SqlPoolArgs {
     ...
     */
    createMode?: pulumi.Input<string | enums.synapse.v20210601.CreateMode>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * SQL pool SKU
     */
    sku?: pulumi.Input<inputs.synapse.v20210601.SkuArgs>;
    /**
     * Specifies the time that the sql pool was deleted
     */
     ...
     * The storage account type used to store backups for this sql pool.
     */
    storageAccountType?: pulumi.Input<string | enums.synapse.v20210601.StorageAccountType>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
