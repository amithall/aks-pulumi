...
export declare class SqlDatabase extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlDatabase;
    /**
     ...
     */
    readonly dataRetention: pulumi.Output<outputs.synapse.v20200401preview.SqlDatabaseDataRetentionResponse | undefined>;
    /**
     * The Guid of the database.
     */
    readonly databaseGuid: pulumi.Output<string>;
    /**
     ...
     */
    readonly storageRedundancy: pulumi.Output<string | undefined>;
    /**
