 ...
 */
export declare class EventHubDataConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventHubDataConnection;
    /**
     * Returns true if the given object is an instance of EventHubDataConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EventHubDataConnection;
    /**
     ...
     */
    readonly kind: pulumi.Output<"EventHub">;
    /**
     * Resource location.
     */
     ...
     */
    readonly managedIdentityResourceId: pulumi.Output<string | undefined>;
    /**
...
export interface EventHubDataConnectionArgs {
     ...
     * The event hub messages compression type
     */
    compression?: pulumi.Input<string | enums.synapse.v20210601preview.Compression>;
    /**
     * The event hub consumer group.
     */
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    dataFormat?: pulumi.Input<string | enums.synapse.v20210601preview.EventHubDataFormat>;
    /**
