...
export declare class SqlPool extends pulumi.CustomResource {
     ...
     * SQL pool SKU
     */
    readonly sku: pulumi.Output<outputs.synapse.v20210601preview.SkuResponse | undefined>;
    /**
...
export interface SqlPoolArgs {
     ...
     */
    createMode?: pulumi.Input<string | enums.synapse.v20210601preview.CreateMode>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The storage account type used to store backups for this sql pool.
     */
    storageAccountType?: pulumi.Input<string | enums.synapse.v20210601preview.StorageAccountType>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
