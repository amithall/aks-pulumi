...
export declare class IntegrationRuntime extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.synapse.v20190601preview.ManagedIntegrationRuntimeResponse | outputs.synapse.v20190601preview.SelfHostedIntegrationRuntimeResponse>;
    /**
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    properties: pulumi.Input<inputs.synapse.v20190601preview.ManagedIntegrationRuntimeArgs | inputs.synapse.v20190601preview.SelfHostedIntegrationRuntimeArgs>;
    /**
