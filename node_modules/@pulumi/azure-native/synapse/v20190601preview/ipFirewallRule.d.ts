 ...
 */
export declare class IpFirewallRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IpFirewallRule;
    /**
     * Returns true if the given object is an instance of IpFirewallRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IpFirewallRule;
    /**
     * The end IP address of the firewall rule. Must be IPv4 format. Must be greater than or equal to startIpAddress
     */
    readonly endIpAddress: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly startIpAddress: pulumi.Output<string | undefined>;
    /**
