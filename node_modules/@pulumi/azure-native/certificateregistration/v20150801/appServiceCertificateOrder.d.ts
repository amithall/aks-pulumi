...
export interface AppServiceCertificateOrderArgs {
    ...
    certificates?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.certificateregistration.v20150801.AppServiceCertificateArgs>;
    }>;
    /**
     * Last CSR that was created for this order.
     */
     ...
     * Certificate product type.
     */
    productType: pulumi.Input<enums.certificateregistration.v20150801.CertificateProductType>;
    /**
