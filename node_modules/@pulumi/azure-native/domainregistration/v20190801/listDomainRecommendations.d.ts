...
export interface ListDomainRecommendationsResult {
     ...
     */
    readonly value: outputs.domainregistration.v20190801.NameIdentifierResponse[];
}
export declare function listDomainRecommendationsOutput(args?: ListDomainRecommendationsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListDomainRecommendationsResult>;
