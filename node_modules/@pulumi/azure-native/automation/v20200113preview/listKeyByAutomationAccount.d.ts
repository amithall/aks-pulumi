...
export interface ListKeyByAutomationAccountResult {
     ...
     */
    readonly keys?: outputs.automation.v20200113preview.KeyResponse[];
}
export declare function listKeyByAutomationAccountOutput(args: ListKeyByAutomationAccountOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListKeyByAutomationAccountResult>;
