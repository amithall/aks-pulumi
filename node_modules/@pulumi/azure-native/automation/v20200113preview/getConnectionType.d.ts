...
export interface GetConnectionTypeResult {
    ...
    readonly fieldDefinitions: {
        [key: string]: outputs.automation.v20200113preview.FieldDefinitionResponse;
    };
    /**
...
export declare function getConnectionTypeOutput(args: GetConnectionTypeOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetConnectionTypeResult>;
