...
export interface GetPackageResult {
     ...
     */
    readonly targetOSList: outputs.testbase.v20201216preview.TargetOSInfoResponse[];
    /**
     ...
     */
    readonly tests: outputs.testbase.v20201216preview.TestResponse[];
    /**
     * Resource type.
     */
     ...
     */
    readonly validationResults: outputs.testbase.v20201216preview.PackageValidationResultResponse[];
    /**
     * Application version
     */
    readonly version: string;
}
export declare function getPackageOutput(args: GetPackageOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPackageResult>;
