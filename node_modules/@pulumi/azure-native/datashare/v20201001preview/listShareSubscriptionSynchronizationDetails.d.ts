...
export interface ListShareSubscriptionSynchronizationDetailsResult {
     ...
     */
    readonly value: outputs.datashare.v20201001preview.SynchronizationDetailsResponse[];
}
export declare function listShareSubscriptionSynchronizationDetailsOutput(args: ListShareSubscriptionSynchronizationDetailsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListShareSubscriptionSynchronizationDetailsResult>;
