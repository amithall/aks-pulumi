...
export interface ListShareSubscriptionSourceShareSynchronizationSettingsResult {
     ...
     */
    readonly value: outputs.datashare.v20200901.ScheduledSourceSynchronizationSettingResponse[];
}
export declare function listShareSubscriptionSourceShareSynchronizationSettingsOutput(args: ListShareSubscriptionSourceShareSynchronizationSettingsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListShareSubscriptionSourceShareSynchronizationSettingsResult>;
