 ...
 */
export declare class SynapseWorkspaceSqlPoolTableDataSetMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SynapseWorkspaceSqlPoolTableDataSetMapping;
    /**
     ...
     */
    static isInstance(obj: any): obj is SynapseWorkspaceSqlPoolTableDataSetMapping;
    /**
     ...
     */
    readonly kind: pulumi.Output<"SynapseWorkspaceSqlPoolTable">;
    /**
     ...
     */
    readonly synapseWorkspaceSqlPoolTableResourceId: pulumi.Output<string>;
    /**
