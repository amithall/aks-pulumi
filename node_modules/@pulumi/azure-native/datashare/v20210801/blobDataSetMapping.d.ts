 ...
 */
export declare class BlobDataSetMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobDataSetMapping;
    /**
     * Returns true if the given object is an instance of BlobDataSetMapping.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BlobDataSetMapping;
    /**
     ...
     */
    readonly kind: pulumi.Output<"Blob">;
    /**
...
export interface BlobDataSetMappingArgs {
     ...
     * File output type
     */
    outputType?: pulumi.Input<string | enums.datashare.v20210801.OutputType>;
    /**
     * Resource group of storage account.
     */
