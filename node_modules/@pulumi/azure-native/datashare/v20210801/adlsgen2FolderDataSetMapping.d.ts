 ...
 */
export declare class ADLSGen2FolderDataSetMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ADLSGen2FolderDataSetMapping;
    /**
     ...
     */
    static isInstance(obj: any): obj is ADLSGen2FolderDataSetMapping;
    /**
     ...
     */
    readonly kind: pulumi.Output<"AdlsGen2Folder">;
    /**
