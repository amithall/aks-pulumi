 ...
 */
export declare class BlobFolderDataSetMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobFolderDataSetMapping;
    /**
     * Returns true if the given object is an instance of BlobFolderDataSetMapping.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BlobFolderDataSetMapping;
    /**
     ...
     */
    readonly kind: pulumi.Output<"BlobFolder">;
    /**
