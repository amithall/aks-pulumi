 ...
 */
export declare class KustoClusterDataSetMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KustoClusterDataSetMapping;
    /**
     ...
     */
    static isInstance(obj: any): obj is KustoClusterDataSetMapping;
    /**
     ...
     */
    readonly kind: pulumi.Output<"KustoCluster">;
    /**
