...
export declare class Experiment extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.chaos.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.chaos.ExperimentPropertiesResponse>;
    /**
     * The system metadata of the experiment resource.
     */
    readonly systemData: pulumi.Output<outputs.chaos.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ExperimentArgs {
     ...
     * The identity of the experiment resource.
     */
    identity?: pulumi.Input<inputs.chaos.ResourceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The properties of the experiment resource.
     */
    properties: pulumi.Input<inputs.chaos.ExperimentPropertiesArgs>;
    /**
