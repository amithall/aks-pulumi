...
export interface GetBackupScheduleResult {
     ...
     */
    readonly scheduleRecurrence: outputs.storsimple.ScheduleRecurrenceResponse;
    /**
     * The schedule status.
     */
...
export declare function getBackupScheduleOutput(args: GetBackupScheduleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetBackupScheduleResult>;
