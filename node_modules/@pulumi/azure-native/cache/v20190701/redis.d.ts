...
export declare class Redis extends pulumi.CustomResource {
     ...
     */
    readonly accessKeys: pulumi.Output<outputs.cache.v20190701.RedisAccessKeysResponse>;
    /**
     ...
     */
    readonly instances: pulumi.Output<outputs.cache.v20190701.RedisInstanceDetailsResponse[]>;
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: pulumi.Output<outputs.cache.v20190701.RedisLinkedServerResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.v20190701.SkuResponse>;
    /**
     * Redis SSL port.
     */
...
export interface RedisArgs {
     ...
     * Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.0', '1.1', '1.2')
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20190701.TlsVersion>;
    /**
     ...
     * The SKU of the Redis cache to deploy.
     */
    sku: pulumi.Input<inputs.cache.v20190701.SkuArgs>;
    /**
     * Static IP address. Required when deploying a Redis cache inside an existing Azure Virtual Network.
     */
