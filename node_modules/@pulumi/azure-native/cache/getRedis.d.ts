...
export interface GetRedisResult {
     ...
     */
    readonly instances: outputs.cache.RedisInstanceDetailsResponse[];
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: outputs.cache.RedisLinkedServerResponse[];
    /**
     ...
     */
    readonly sku: outputs.cache.SkuResponse;
    /**
     * Redis SSL port.
     */
