...
export declare class Redis extends pulumi.CustomResource {
     ...
     */
    readonly accessKeys: pulumi.Output<outputs.cache.v20170201.RedisAccessKeysResponse>;
    /**
     ...
     */
    readonly linkedServers: pulumi.Output<outputs.cache.v20170201.RedisLinkedServerListResponse>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.v20170201.SkuResponse | undefined>;
    /**
     * Redis SSL port.
     */
...
export interface RedisArgs {
     ...
     * The SKU of the Redis cache to deploy.
     */
    sku: pulumi.Input<inputs.cache.v20170201.SkuArgs>;
    /**
     * Static IP address. Required when deploying a Redis cache inside an existing Azure Virtual Network.
     */
