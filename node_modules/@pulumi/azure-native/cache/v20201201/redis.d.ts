...
export declare class Redis extends pulumi.CustomResource {
     ...
     */
    readonly accessKeys: pulumi.Output<outputs.cache.v20201201.RedisAccessKeysResponse>;
    /**
     ...
     */
    readonly instances: pulumi.Output<outputs.cache.v20201201.RedisInstanceDetailsResponse[]>;
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: pulumi.Output<outputs.cache.v20201201.RedisLinkedServerResponse[]>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.cache.v20201201.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly redisConfiguration: pulumi.Output<outputs.cache.v20201201.RedisCommonPropertiesResponseRedisConfiguration | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.v20201201.SkuResponse>;
    /**
     * Redis SSL port.
     */
...
export interface RedisArgs {
     ...
     * Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.0', '1.1', '1.2')
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20201201.TlsVersion>;
    /**
     ...
     * Whether or not public endpoint access is allowed for this cache.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default value is 'Enabled'
     */
    publicNetworkAccess?: pulumi.Input<string | enums.cache.v20201201.PublicNetworkAccess>;
    /**
     * All Redis Settings. Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.
     */
