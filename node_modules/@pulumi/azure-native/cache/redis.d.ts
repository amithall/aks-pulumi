...
export declare class Redis extends pulumi.CustomResource {
     ...
     */
    readonly accessKeys: pulumi.Output<outputs.cache.RedisAccessKeysResponse>;
    /**
     ...
     */
    readonly instances: pulumi.Output<outputs.cache.RedisInstanceDetailsResponse[]>;
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: pulumi.Output<outputs.cache.RedisLinkedServerResponse[]>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.cache.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly redisConfiguration: pulumi.Output<outputs.cache.RedisCommonPropertiesResponseRedisConfiguration | undefined>;
    /**
     * Redis version.
     */
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.SkuResponse>;
    /**
     * Redis SSL port.
     */
...
export interface RedisArgs {
     ...
     * The SKU of the Redis cache to deploy.
     */
    sku: pulumi.Input<inputs.cache.SkuArgs>;
    /**
     * Static IP address. Optionally, may be specified when deploying a Redis cache inside an existing Azure Virtual Network; auto assigned by default.
     */
