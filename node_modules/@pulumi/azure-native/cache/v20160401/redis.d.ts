...
export declare class Redis extends pulumi.CustomResource {
     ...
     */
    readonly accessKeys: pulumi.Output<outputs.cache.v20160401.RedisAccessKeysResponse>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.v20160401.SkuResponse | undefined>;
    /**
     * Redis SSL port.
     */
...
export interface RedisArgs {
     ...
     * The SKU of the Redis cache to deploy.
     */
    sku: pulumi.Input<inputs.cache.v20160401.SkuArgs>;
    /**
     * Static IP address. Required when deploying a Redis cache inside an existing Azure Virtual Network.
     */
