...
export declare class RedisEnterprise extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.cache.v20220101.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.v20220101.EnterpriseSkuResponse>;
    /**
     * Resource tags.
     */
...
export interface RedisEnterpriseArgs {
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20220101.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<inputs.cache.v20220101.EnterpriseSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
