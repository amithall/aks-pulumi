...
export declare class PatchSchedule extends pulumi.CustomResource {
     ...
     */
    readonly scheduleEntries: pulumi.Output<outputs.cache.v20171001.ScheduleEntryResponse[]>;
    /**
     * Resource type.
     */
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    scheduleEntries: pulumi.Input<pulumi.Input<inputs.cache.v20171001.ScheduleEntryArgs>[]>;
}
