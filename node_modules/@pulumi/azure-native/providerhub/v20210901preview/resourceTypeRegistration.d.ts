...
export declare class ResourceTypeRegistration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceTypeRegistration;
    /**
     * Returns true if the given object is an instance of ResourceTypeRegistration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ResourceTypeRegistration;
    /**
     * The name of the resource
     */
    readonly name: pulumi.Output<string>;
    readonly properties: pulumi.Output<outputs.providerhub.v20210901preview.ResourceTypeRegistrationResponseProperties>;
    /**
