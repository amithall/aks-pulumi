 ...
 */
export declare class NotificationRegistration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotificationRegistration;
    /**
     * Returns true if the given object is an instance of NotificationRegistration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NotificationRegistration;
    /**
     * The name of the resource
     */
    readonly name: pulumi.Output<string>;
    readonly properties: pulumi.Output<outputs.providerhub.v20210901preview.NotificationRegistrationResponseProperties>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: pulumi.Output<outputs.providerhub.v20210901preview.SystemDataResponse>;
    /**
...
export interface NotificationRegistrationArgs {
    ...
    properties?: pulumi.Input<inputs.providerhub.v20210901preview.NotificationRegistrationPropertiesArgs>;
    /**
