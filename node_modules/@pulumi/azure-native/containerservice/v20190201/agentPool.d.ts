...
export interface AgentPoolArgs {
     ...
     */
    managedClusterName: pulumi.Input<string>;
    /**
     * Maximum number of nodes for auto-scaling
     */
     ...
     * OsType to be used to specify os type. Choose from Linux and Windows. Default to Linux.
     */
    osType?: pulumi.Input<string | enums.containerservice.v20190201.OSType>;
    /**
     ...
     * AgentPoolType represents types of an agent pool
     */
    type?: pulumi.Input<string | enums.containerservice.v20190201.AgentPoolType>;
    /**
     * Size of agent VMs.
     */
    vmSize: pulumi.Input<string | enums.containerservice.v20190201.ContainerServiceVMSizeTypes>;
    /**
     * VNet SubnetID specifies the VNet's subnet identifier.
     */
