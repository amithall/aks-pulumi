...
export declare class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly notAllowedTime: pulumi.Output<outputs.containerservice.v20220302preview.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    readonly timeInWeek: pulumi.Output<outputs.containerservice.v20220302preview.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
...
export interface MaintenanceConfigurationArgs {
     ...
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220302preview.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220302preview.TimeInWeekArgs>[]>;
}
