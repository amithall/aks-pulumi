...
export declare class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly notAllowedTime: pulumi.Output<outputs.containerservice.v20210801.TimeSpanResponse[] | undefined>;
    /**
     * The system metadata relating to this resource.
     */
    readonly systemData: pulumi.Output<outputs.containerservice.v20210801.SystemDataResponse>;
    /**
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    readonly timeInWeek: pulumi.Output<outputs.containerservice.v20210801.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
...
export interface MaintenanceConfigurationArgs {
     ...
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<inputs.containerservice.v20210801.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<inputs.containerservice.v20210801.TimeInWeekArgs>[]>;
}
