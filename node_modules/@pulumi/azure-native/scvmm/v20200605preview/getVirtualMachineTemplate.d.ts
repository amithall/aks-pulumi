 ...
 */
export declare function getVirtualMachineTemplate(args: GetVirtualMachineTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineTemplateResult>;
...
export interface GetVirtualMachineTemplateResult {
     ...
     */
    readonly disks: outputs.scvmm.v20200605preview.VirtualDiskResponse[];
    /**
     ...
     */
    readonly networkInterfaces: outputs.scvmm.v20200605preview.NetworkInterfacesResponse[];
    /**
...
export declare function getVirtualMachineTemplateOutput(args: GetVirtualMachineTemplateOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVirtualMachineTemplateResult>;
