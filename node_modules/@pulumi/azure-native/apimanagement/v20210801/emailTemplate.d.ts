...
export declare class EmailTemplate extends pulumi.CustomResource {
     ...
     */
    readonly parameters: pulumi.Output<outputs.apimanagement.v20210801.EmailTemplateParametersContractPropertiesResponse[] | undefined>;
    /**
...
export interface EmailTemplateArgs {
     ...
     * Email Template Parameter values.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210801.EmailTemplateParametersContractPropertiesArgs>[]>;
    /**
