 ...
 * API details.
 */
export declare class GatewayApiEntityTag extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayApiEntityTag;
    /**
     * Returns true if the given object is an instance of GatewayApiEntityTag.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GatewayApiEntityTag;
    /**
...
export interface GatewayApiEntityTagArgs {
     ...
     * Provisioning state.
     */
    provisioningState?: pulumi.Input<enums.apimanagement.v20211201preview.ProvisioningState>;
    /**
