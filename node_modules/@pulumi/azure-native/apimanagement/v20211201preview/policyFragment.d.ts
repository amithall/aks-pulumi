...
export declare class PolicyFragment extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyFragment;
    /**
...
export interface PolicyFragmentArgs {
     ...
     * Format of the policy fragment content.
     */
    format?: pulumi.Input<string | enums.apimanagement.v20211201preview.PolicyFragmentContentFormat>;
    /**
