...
export { aad, aadiam, alertsmanagement, analysisservices, apimanagement, app, appconfiguration, appplatform, attestation, authorization, automanage, automation, autonomousdevelopmentplatform, avs, azureactivedirectory, azurearcdata, azurestack, azurestackhci, batch, blockchain, blueprint, botservice, cache, cdn, certificateregistration, changeanalysis, chaos, cognitiveservices, compute, confidentialledger, connectedvmwarevsphere, consumption, containerinstance, containerregistry, containerservice, costmanagement, customerinsights, customproviders, dashboard, databox, databoxedge, databricks, datacatalog, datadog, datafactory, datalakeanalytics, datalakestore, datamigration, dataprotection, datashare, dbformariadb, dbformysql, dbforpostgresql, delegatednetwork, deploymentmanager, desktopvirtualization, devices, deviceupdate, devops, devspaces, devtestlab, digitaltwins, documentdb, domainregistration, edgeorder, education, elastic, elasticsan, enterpriseknowledgegraph, eventgrid, eventhub, extendedlocation, features, fluidrelay, guestconfiguration, hardwaresecuritymodules, hdinsight, healthbot, healthcareapis, hybridcompute, hybridconnectivity, hybriddata, hybridnetwork, importexport, insights, iotcentral, iotsecurity, keyvault, kubernetes, kubernetesconfiguration, kusto, labservices, loadtestservice, logic, logz, m365securityandcompliance, machinelearning, machinelearningcompute, machinelearningservices, maintenance, managednetwork, managedservices, maps, marketplace, media, migrate, mixedreality, mobilenetwork, netapp, network, notificationhubs, operationalinsights, orbital, peering, policyinsights, portal, powerbi, powerbidedicated, powerplatform, providerhub, purview, quantum, recommendationsservice, recoveryservices, redhatopenshift, relay, resourceconnector, resources, saas, scheduler, scvmm, search, security, securityandcompliance, securityinsights, serialconsole, servicebus, servicefabric, servicefabricmesh, servicelinker, signalrservice, solutions, sql, sqlvirtualmachine, storage, storagecache, storagepool, storagesync, storsimple, streamanalytics, subscription, synapse, testbase, timeseriesinsights, videoanalyzer, videoindexer, virtualmachineimages, visualstudio, vmwarecloudsimple, web, webpubsub, windowsesu, };
