...
export { v20210501preview, v20211101preview, };
export declare const AccessPolicyEccAlgo: {
    /**
     * ES265
     */
 ...
 */
export declare type AccessPolicyEccAlgo = (typeof AccessPolicyEccAlgo)[keyof typeof AccessPolicyEccAlgo];
...
export declare const AccessPolicyRsaAlgo: {
    /**
     * RS256
     */
 ...
 */
export declare type AccessPolicyRsaAlgo = (typeof AccessPolicyRsaAlgo)[keyof typeof AccessPolicyRsaAlgo];
...
export declare const EncoderSystemPresetType: {
    /**
     ...
     */
    readonly SingleLayer_540p_H264_AAC: "SingleLayer_540p_H264_AAC";
    /**
     ...
     */
    readonly SingleLayer_720p_H264_AAC: "SingleLayer_720p_H264_AAC";
    /**
     ...
     */
    readonly SingleLayer_1080p_H264_AAC: "SingleLayer_1080p_H264_AAC";
    /**
     ...
     */
    readonly SingleLayer_2160p_H264_AAC: "SingleLayer_2160p_H264_AAC";
};
/**
 * Name of the built-in encoding preset.
 */
export declare type EncoderSystemPresetType = (typeof EncoderSystemPresetType)[keyof typeof EncoderSystemPresetType];
...
export declare const RtspTransport: {
    /**
 ...
 */
export declare type RtspTransport = (typeof RtspTransport)[keyof typeof RtspTransport];
 ...
 */
export declare type VideoScaleMode = (typeof VideoScaleMode)[keyof typeof VideoScaleMode];
