...
export declare const DataBoxEdgeDeviceKind: {
    readonly AzureDataBoxGateway: "AzureDataBoxGateway";
    readonly AzureStackEdge: "AzureStackEdge";
    readonly AzureStackHub: "AzureStackHub";
    readonly AzureModularDataCentre: "AzureModularDataCentre";
};
/**
 * The kind of the device.
 */
export declare type DataBoxEdgeDeviceKind = (typeof DataBoxEdgeDeviceKind)[keyof typeof DataBoxEdgeDeviceKind];
 ...
 */
export declare type DataResidencyType = (typeof DataResidencyType)[keyof typeof DataResidencyType];
 ...
 * Identity type
 */
export declare type MsiIdentityType = (typeof MsiIdentityType)[keyof typeof MsiIdentityType];
...
export declare const RoleTypes: {
    ...
    readonly MEC: "MEC";
    readonly CloudEdgeManagement: "CloudEdgeManagement";
 ...
 */
export declare type ShipmentType = (typeof ShipmentType)[keyof typeof ShipmentType];
 ...
 */
export declare type StorageAccountStatus = (typeof StorageAccountStatus)[keyof typeof StorageAccountStatus];
 ...
 * Type of the user.
 */
export declare type UserType = (typeof UserType)[keyof typeof UserType];
