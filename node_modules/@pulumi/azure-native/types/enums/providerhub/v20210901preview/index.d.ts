...
export declare type ExtensionCategory = (typeof ExtensionCategory)[keyof typeof ExtensionCategory];
...
export declare type ExtensionOptionType = (typeof ExtensionOptionType)[keyof typeof ExtensionOptionType];
export declare const FeaturesPolicy: {
    readonly Any: "Any";
    readonly All: "All";
};
export declare type FeaturesPolicy = (typeof FeaturesPolicy)[keyof typeof FeaturesPolicy];
...
export declare type IdentityManagementTypes = (typeof IdentityManagementTypes)[keyof typeof IdentityManagementTypes];
export declare const LoggingDetails: {
    readonly None: "None";
    readonly Body: "Body";
};
export declare type LoggingDetails = (typeof LoggingDetails)[keyof typeof LoggingDetails];
export declare const LoggingDirections: {
    readonly None: "None";
    readonly Request: "Request";
    readonly Response: "Response";
};
export declare type LoggingDirections = (typeof LoggingDirections)[keyof typeof LoggingDirections];
export declare const MessageScope: {
    readonly NotSpecified: "NotSpecified";
    readonly RegisteredSubscriptions: "RegisteredSubscriptions";
};
export declare type MessageScope = (typeof MessageScope)[keyof typeof MessageScope];
export declare const NotificationMode: {
    readonly NotSpecified: "NotSpecified";
    readonly EventHub: "EventHub";
    readonly WebHook: "WebHook";
};
export declare type NotificationMode = (typeof NotificationMode)[keyof typeof NotificationMode];
...
export declare type OptInHeaderType = (typeof OptInHeaderType)[keyof typeof OptInHeaderType];
export declare const Policy: {
    readonly NotSpecified: "NotSpecified";
    readonly SynchronizeBeginExtension: "SynchronizeBeginExtension";
};
export declare type Policy = (typeof Policy)[keyof typeof Policy];
...
export declare type PreflightOption = (typeof PreflightOption)[keyof typeof PreflightOption];
...
export declare type Readiness = (typeof Readiness)[keyof typeof Readiness];
export declare const Regionality: {
    readonly NotSpecified: "NotSpecified";
    readonly Global: "Global";
    readonly Regional: "Regional";
};
export declare type Regionality = (typeof Regionality)[keyof typeof Regionality];
...
export declare type ResourceDeletionPolicy = (typeof ResourceDeletionPolicy)[keyof typeof ResourceDeletionPolicy];
export declare const ResourceProviderCapabilitiesEffect: {
    readonly NotSpecified: "NotSpecified";
    readonly Allow: "Allow";
    readonly Disallow: "Disallow";
};
export declare type ResourceProviderCapabilitiesEffect = (typeof ResourceProviderCapabilitiesEffect)[keyof typeof ResourceProviderCapabilitiesEffect];
...
export declare type ResourceProviderType = (typeof ResourceProviderType)[keyof typeof ResourceProviderType];
...
export declare type RoutingType = (typeof RoutingType)[keyof typeof RoutingType];
export declare const SkuScaleType: {
    readonly None: "None";
    readonly Manual: "Manual";
    readonly Automatic: "Automatic";
};
export declare type SkuScaleType = (typeof SkuScaleType)[keyof typeof SkuScaleType];
...
export declare type SubscriptionNotificationOperation = (typeof SubscriptionNotificationOperation)[keyof typeof SubscriptionNotificationOperation];
...
export declare type SubscriptionReregistrationResult = (typeof SubscriptionReregistrationResult)[keyof typeof SubscriptionReregistrationResult];
...
export declare type SubscriptionTransitioningState = (typeof SubscriptionTransitioningState)[keyof typeof SubscriptionTransitioningState];
...
export declare type ThrottlingMetricType = (typeof ThrottlingMetricType)[keyof typeof ThrottlingMetricType];
...
export declare type TrafficRegionCategory = (typeof TrafficRegionCategory)[keyof typeof TrafficRegionCategory];
