...
export declare const KeyPermissions: {
    ...
    readonly Getrotationpolicy: "getrotationpolicy";
    readonly Setrotationpolicy: "setrotationpolicy";
};
export declare type KeyPermissions = (typeof KeyPermissions)[keyof typeof KeyPermissions];
export declare const KeyRotationPolicyActionType: {
    readonly Rotate: "rotate";
 ...
 * The type of action.
 */
export declare type KeyRotationPolicyActionType = (typeof KeyRotationPolicyActionType)[keyof typeof KeyRotationPolicyActionType];
export declare const ManagedHsmSkuFamily: {
    readonly B: "B";
};
/**
 * SKU Family of the managed HSM Pool
 */
export declare type ManagedHsmSkuFamily = (typeof ManagedHsmSkuFamily)[keyof typeof ManagedHsmSkuFamily];
export declare const ManagedHsmSkuName: {
    readonly Standard_B1: "Standard_B1";
    readonly Custom_B32: "Custom_B32";
};
/**
 * SKU of the managed HSM Pool
 */
export declare type ManagedHsmSkuName = (typeof ManagedHsmSkuName)[keyof typeof ManagedHsmSkuName];
