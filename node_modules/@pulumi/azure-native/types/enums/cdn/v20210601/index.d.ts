 ...
 */
export declare type AutoGeneratedDomainNameLabelScope = (typeof AutoGeneratedDomainNameLabelScope)[keyof typeof AutoGeneratedDomainNameLabelScope];
 ...
 */
export declare type ClientPortOperator = (typeof ClientPortOperator)[keyof typeof ClientPortOperator];
 ...
 * Describes operator to be matched
 */
export declare type HostNameOperator = (typeof HostNameOperator)[keyof typeof HostNameOperator];
 ...
 * Caching behavior for the requests
 */
export declare type RuleCacheBehavior = (typeof RuleCacheBehavior)[keyof typeof RuleCacheBehavior];
 ...
 */
export declare type RuleIsCompressionEnabled = (typeof RuleIsCompressionEnabled)[keyof typeof RuleIsCompressionEnabled];
 ...
 * Defines how Frontdoor caches requests that include query strings. You can ignore any query strings when caching, ignore specific query strings, cache every request with a unique URL, or cache specific query strings.
 */
export declare type RuleQueryStringCachingBehavior = (typeof RuleQueryStringCachingBehavior)[keyof typeof RuleQueryStringCachingBehavior];
 ...
 * Describes operator to be matched
 */
export declare type ServerPortOperator = (typeof ServerPortOperator)[keyof typeof ServerPortOperator];
 ...
 * Describes operator to be matched
 */
export declare type SocketAddrOperator = (typeof SocketAddrOperator)[keyof typeof SocketAddrOperator];
 ...
 */
export declare type SslProtocol = (typeof SslProtocol)[keyof typeof SslProtocol];
 ...
 * Describes operator to be matched
 */
export declare type SslProtocolOperator = (typeof SslProtocolOperator)[keyof typeof SslProtocolOperator];
 ...
 */
export declare type WafMatchVariable = (typeof WafMatchVariable)[keyof typeof WafMatchVariable];
