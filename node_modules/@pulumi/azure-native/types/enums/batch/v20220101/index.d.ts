 ...
 */
export declare type AutoStorageAuthenticationMode = (typeof AutoStorageAuthenticationMode)[keyof typeof AutoStorageAuthenticationMode];
...
export declare type ContainerWorkingDirectory = (typeof ContainerWorkingDirectory)[keyof typeof ContainerWorkingDirectory];
 ...
 */
export declare type DiskEncryptionTarget = (typeof DiskEncryptionTarget)[keyof typeof DiskEncryptionTarget];
export declare const DynamicVNetAssignmentScope: {
    ...
    readonly None: "none";
    /**
     * Dynamic VNet assignment is done per-job. Don't use this option unless your batch account has been approved to use this feature.
     */
    readonly Job: "job";
};
export declare type DynamicVNetAssignmentScope = (typeof DynamicVNetAssignmentScope)[keyof typeof DynamicVNetAssignmentScope];
 ...
 */
export declare type IPAddressProvisioningType = (typeof IPAddressProvisioningType)[keyof typeof IPAddressProvisioningType];
 ...
 */
export declare type NodePlacementPolicyType = (typeof NodePlacementPolicyType)[keyof typeof NodePlacementPolicyType];
 ...
 */
export declare type PoolIdentityType = (typeof PoolIdentityType)[keyof typeof PoolIdentityType];
