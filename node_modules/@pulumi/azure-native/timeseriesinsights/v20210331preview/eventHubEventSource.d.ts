 ...
 */
export declare class EventHubEventSource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventHubEventSource;
    /**
     * Returns true if the given object is an instance of EventHubEventSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EventHubEventSource;
    /**
     ...
     */
    readonly kind: pulumi.Output<"Microsoft.EventHub">;
    /**
     * An object that represents the local timestamp property. It contains the format of local timestamp that needs to be used and the corresponding timezone offset information. If a value isn't specified for localTimestamp, or if null, then the local timestamp will not be ingressed with the events.
     */
    readonly localTimestamp: pulumi.Output<outputs.timeseriesinsights.v20210331preview.LocalTimestampResponse | undefined>;
    /**
     * Resource location
     */
...
export interface EventHubEventSourceArgs {
     ...
     * An object that represents the local timestamp property. It contains the format of local timestamp that needs to be used and the corresponding timezone offset information. If a value isn't specified for localTimestamp, or if null, then the local timestamp will not be ingressed with the events.
     */
    localTimestamp?: pulumi.Input<inputs.timeseriesinsights.v20210331preview.LocalTimestampArgs>;
    /**
     ...
     */
    type?: pulumi.Input<string | enums.timeseriesinsights.v20210331preview.IngressStartAtType>;
}
