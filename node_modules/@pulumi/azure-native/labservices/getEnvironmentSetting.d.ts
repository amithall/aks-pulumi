...
export interface GetEnvironmentSettingResult {
     ...
     */
    readonly resourceSettings: outputs.labservices.ResourceSettingsResponse;
    /**
...
export declare function getEnvironmentSettingOutput(args: GetEnvironmentSettingOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetEnvironmentSettingResult>;
