 ...
 * A custom API
 */
export declare class CustomApi extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomApi;
    /**
     * Returns true if the given object is an instance of CustomApi.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CustomApi;
    /**
     * Resource ETag
     */
     ...
     */
    readonly properties: pulumi.Output<outputs.web.v20160601.CustomApiPropertiesDefinitionResponse>;
    /**
     * Resource tags
     */
...
export interface CustomApiArgs {
     ...
     * Custom API properties
     */
    properties?: pulumi.Input<inputs.web.v20160601.CustomApiPropertiesDefinitionArgs>;
    /**
     * The resource group
     */
