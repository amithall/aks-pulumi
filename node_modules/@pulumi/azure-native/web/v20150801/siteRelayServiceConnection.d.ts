 ...
 */
export declare class SiteRelayServiceConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SiteRelayServiceConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is SiteRelayServiceConnection;
