 ...
 */
export declare function listSiteAuthSettingsSlot(args: ListSiteAuthSettingsSlotArgs, opts?: pulumi.InvokeOptions): Promise<ListSiteAuthSettingsSlotResult>;
export interface ListSiteAuthSettingsSlotArgs {
    /**
     * Name of web app
     */
    name: string;
 ...
 * Configuration settings for the Azure App Service Authentication / Authorization feature.
 */
export interface ListSiteAuthSettingsSlotResult {
...
export declare function listSiteAuthSettingsSlotOutput(args: ListSiteAuthSettingsSlotOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListSiteAuthSettingsSlotResult>;
