...
export declare class StaticSite extends pulumi.CustomResource {
     ...
     */
    readonly buildProperties: pulumi.Output<outputs.web.v20210301.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.web.v20210301.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.web.v20210301.SkuDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly templateProperties: pulumi.Output<outputs.web.v20210301.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    readonly userProvidedFunctionApps: pulumi.Output<outputs.web.v20210301.StaticSiteUserProvidedFunctionAppResponse[]>;
    /**
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    buildProperties?: pulumi.Input<inputs.web.v20210301.StaticSiteBuildPropertiesArgs>;
    /**
     * State indicating the status of the enterprise grade CDN serving traffic to the static web app.
     */
    enterpriseGradeCdnStatus?: pulumi.Input<string | enums.web.v20210301.EnterpriseGradeCdnStatus>;
    /**
     * Managed service identity.
     */
     ...
     * Description of a SKU for a scalable resource.
     */
    sku?: pulumi.Input<inputs.web.v20210301.SkuDescriptionArgs>;
    /**
     * State indicating whether staging environments are allowed or not allowed for a static web app.
     */
    stagingEnvironmentPolicy?: pulumi.Input<enums.web.v20210301.StagingEnvironmentPolicy>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * Template options for generating a new repository.
     */
    templateProperties?: pulumi.Input<inputs.web.v20210301.StaticSiteTemplateOptionsArgs>;
}
