 ...
 */
export declare class WebAppSourceControlSlot extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSourceControlSlot;
    /**
     * Returns true if the given object is an instance of WebAppSourceControlSlot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebAppSourceControlSlot;
    /**
     ...
     */
    readonly gitHubActionConfiguration: pulumi.Output<outputs.web.v20210301.GitHubActionConfigurationResponse | undefined>;
    /**
...
export interface WebAppSourceControlSlotArgs {
     ...
     * If GitHub Action is selected, than the associated configuration.
     */
    gitHubActionConfiguration?: pulumi.Input<inputs.web.v20210301.GitHubActionConfigurationArgs>;
    /**
     * <code>true</code> if this is deployed via GitHub action.
     */
