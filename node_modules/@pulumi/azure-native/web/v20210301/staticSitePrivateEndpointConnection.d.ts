 ...
 */
export declare class StaticSitePrivateEndpointConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticSitePrivateEndpointConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is StaticSitePrivateEndpointConnection;
    /**
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.web.v20210301.ArmIdWrapperResponse | undefined>;
    /**
     * The state of a private link connection
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.web.v20210301.PrivateLinkConnectionStateResponse | undefined>;
...
export interface StaticSitePrivateEndpointConnectionArgs {
     ...
     * The state of a private link connection
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.web.v20210301.PrivateLinkConnectionStateArgs>;
    /**
