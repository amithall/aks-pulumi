...
export interface ListStaticSiteUsersResult {
     ...
     */
    readonly value: outputs.web.v20210115.StaticSiteUserARMResourceResponse[];
}
export declare function listStaticSiteUsersOutput(args: ListStaticSiteUsersOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListStaticSiteUsersResult>;
