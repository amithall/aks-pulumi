...
export interface WebAppSlotArgs {
     ...
     */
    cloningInfo?: pulumi.Input<inputs.web.v20180201.CloningInfoArgs>;
    /**
     * Size of the function container.
     */
     ...
     * GeoDistributions for this site
     */
    geoDistributions?: pulumi.Input<pulumi.Input<inputs.web.v20180201.GeoDistributionArgs>[]>;
    /**
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    hostNameSslStates?: pulumi.Input<pulumi.Input<inputs.web.v20180201.HostNameSslStateArgs>[]>;
    /**
     * <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
     *  If <code>true</code>, the app is only accessible via API management process.
     */
     ...
     * App Service Environment to use for the app.
     */
    hostingEnvironmentProfile?: pulumi.Input<inputs.web.v20180201.HostingEnvironmentProfileArgs>;
    /**
     * HttpsOnly: configures a web site to accept only https requests. Issues redirect for
     * http requests
     */
     ...
     * Managed service identity.
     */
    identity?: pulumi.Input<inputs.web.v20180201.ManagedServiceIdentityArgs>;
    /**
     * Obsolete: Hyper-V sandbox.
     */
     ...
     * Site redundancy mode
     */
    redundancyMode?: pulumi.Input<enums.web.v20180201.RedundancyMode>;
    /**
     * <code>true</code> if reserved; otherwise, <code>false</code>.
     */
     ...
     * Configuration of the app.
     */
    siteConfig?: pulumi.Input<inputs.web.v20180201.SiteConfigArgs>;
    /**
