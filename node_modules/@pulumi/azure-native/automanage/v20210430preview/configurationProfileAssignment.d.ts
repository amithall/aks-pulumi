 ...
 */
export declare class ConfigurationProfileAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationProfileAssignment;
    /**
     ...
     */
    static isInstance(obj: any): obj is ConfigurationProfileAssignment;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.automanage.v20210430preview.ConfigurationProfileAssignmentPropertiesResponse>;
    /**
...
export interface ConfigurationProfileAssignmentArgs {
     ...
     * Properties of the configuration profile assignment.
     */
    properties?: pulumi.Input<inputs.automanage.v20210430preview.ConfigurationProfileAssignmentPropertiesArgs>;
    /**
