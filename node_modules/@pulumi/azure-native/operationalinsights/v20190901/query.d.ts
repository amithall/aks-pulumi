...
export declare class Query extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Query;
    /**
     ...
     */
    readonly related: pulumi.Output<outputs.operationalinsights.v20190901.LogAnalyticsQueryPackQueryPropertiesResponseRelated | undefined>;
    /**
     * Read only system data
     */
    readonly systemData: pulumi.Output<outputs.operationalinsights.v20190901.SystemDataResponse>;
    /**
...
export interface QueryArgs {
     ...
     * The related metadata items for the function.
     */
    related?: pulumi.Input<inputs.operationalinsights.v20190901.LogAnalyticsQueryPackQueryPropertiesRelatedArgs>;
    /**
