...
export declare class MachineGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MachineGroup;
    /**
     ...
     */
    readonly kind: pulumi.Output<"machineGroup">;
    /**
     * References of the machines in this group. The hints within each reference do not represent the current value of the corresponding fields. They are a snapshot created during the last time the machine group was updated.
     */
    readonly machines: pulumi.Output<outputs.operationalinsights.v20151101preview.MachineReferenceWithHintsResponse[] | undefined>;
    /**
     * Resource name.
     */
