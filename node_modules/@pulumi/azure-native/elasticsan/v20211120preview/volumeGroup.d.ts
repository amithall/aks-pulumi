...
export declare class VolumeGroup extends pulumi.CustomResource {
     ...
     */
    readonly networkAcls: pulumi.Output<outputs.elasticsan.v20211120preview.NetworkRuleSetResponse | undefined>;
    /**
...
export interface VolumeGroupArgs {
     ...
     * A collection of rules governing the accessibility from specific network locations.
     */
    networkAcls?: pulumi.Input<inputs.elasticsan.v20211120preview.NetworkRuleSetArgs>;
    /**
     * Type of storage target
     */
