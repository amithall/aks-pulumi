 ...
 */
export declare class MoveResource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MoveResource;
    /**
     * Returns true if the given object is an instance of MoveResource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MoveResource;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.migrate.v20210801.MoveResourcePropertiesResponse>;
    /**
