...
export declare class EventHub extends pulumi.CustomResource {
     ...
     */
    readonly captureDescription: pulumi.Output<outputs.eventhub.v20180101preview.CaptureDescriptionResponse | undefined>;
    /**
...
export interface EventHubArgs {
     ...
     * Properties of capture description
     */
    captureDescription?: pulumi.Input<inputs.eventhub.v20180101preview.CaptureDescriptionArgs>;
    /**
     * The Event Hub name
     */
     ...
     * Enumerates the possible values for the status of the Event Hub.
     */
    status?: pulumi.Input<enums.eventhub.v20180101preview.EntityStatus>;
}
