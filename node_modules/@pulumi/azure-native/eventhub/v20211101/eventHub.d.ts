...
export declare class EventHub extends pulumi.CustomResource {
     ...
     */
    readonly captureDescription: pulumi.Output<outputs.eventhub.v20211101.CaptureDescriptionResponse | undefined>;
    /**
...
export interface EventHubArgs {
     ...
     * Properties of capture description
     */
    captureDescription?: pulumi.Input<inputs.eventhub.v20211101.CaptureDescriptionArgs>;
    /**
     * The Event Hub name
     */
     ...
     * Enumerates the possible values for the status of the Event Hub.
     */
    status?: pulumi.Input<enums.eventhub.v20211101.EntityStatus>;
}
