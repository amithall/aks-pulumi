...
export declare class EventSubscription extends pulumi.CustomResource {
     ...
     */
    readonly deadLetterDestination: pulumi.Output<outputs.eventgrid.v20190101.StorageBlobDeadLetterDestinationResponse | undefined>;
    /**
...
export interface EventSubscriptionArgs {
     ...
     * The DeadLetter destination of the event subscription.
     */
    deadLetterDestination?: pulumi.Input<inputs.eventgrid.v20190101.StorageBlobDeadLetterDestinationArgs>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     */
    destination?: pulumi.Input<inputs.eventgrid.v20190101.EventHubEventSubscriptionDestinationArgs | inputs.eventgrid.v20190101.HybridConnectionEventSubscriptionDestinationArgs | inputs.eventgrid.v20190101.StorageQueueEventSubscriptionDestinationArgs | inputs.eventgrid.v20190101.WebHookEventSubscriptionDestinationArgs>;
    /**
     ...
     * Information about the filter for the event subscription.
     */
    filter?: pulumi.Input<inputs.eventgrid.v20190101.EventSubscriptionFilterArgs>;
    /**
     * List of user defined labels.
     */
     ...
     * The retry policy for events. This can be used to configure maximum number of delivery attempts and time to live for events.
     */
    retryPolicy?: pulumi.Input<inputs.eventgrid.v20190101.RetryPolicyArgs>;
    /**
