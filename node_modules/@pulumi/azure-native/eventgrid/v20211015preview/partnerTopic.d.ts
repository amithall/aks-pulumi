...
export declare class PartnerTopic extends pulumi.CustomResource {
     ...
     */
    readonly eventTypeInfo: pulumi.Output<outputs.eventgrid.v20211015preview.EventTypeInfoResponse | undefined>;
    /**
...
export interface PartnerTopicArgs {
     ...
     * Activation state of the partner topic.
     */
    activationState?: pulumi.Input<string | enums.eventgrid.v20211015preview.PartnerTopicActivationState>;
    /**
     * Event Type information from the corresponding event channel.
     */
    eventTypeInfo?: pulumi.Input<inputs.eventgrid.v20211015preview.EventTypeInfoArgs>;
    /**
     * Expiration time of the partner topic. If this timer expires while the partner topic is still never activated,
     * the partner topic and corresponding event channel are deleted.
     */
