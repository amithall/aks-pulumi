 ...
 */
export declare function getPartnerTopic(args: GetPartnerTopicArgs, opts?: pulumi.InvokeOptions): Promise<GetPartnerTopicResult>;
...
export interface GetPartnerTopicResult {
     ...
     */
    readonly eventTypeInfo?: outputs.eventgrid.v20211015preview.EventTypeInfoResponse;
    /**
...
export declare function getPartnerTopicOutput(args: GetPartnerTopicOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPartnerTopicResult>;
