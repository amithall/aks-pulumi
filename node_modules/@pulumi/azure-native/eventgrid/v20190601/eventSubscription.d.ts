...
export declare class EventSubscription extends pulumi.CustomResource {
     ...
     */
    readonly deadLetterDestination: pulumi.Output<outputs.eventgrid.v20190601.StorageBlobDeadLetterDestinationResponse | undefined>;
    /**
     ...
     */
    readonly filter: pulumi.Output<outputs.eventgrid.v20190601.EventSubscriptionFilterResponse | undefined>;
    /**
     ...
     */
    readonly retryPolicy: pulumi.Output<outputs.eventgrid.v20190601.RetryPolicyResponse | undefined>;
    /**
...
export interface EventSubscriptionArgs {
     ...
     * The DeadLetter destination of the event subscription.
     */
    deadLetterDestination?: pulumi.Input<inputs.eventgrid.v20190601.StorageBlobDeadLetterDestinationArgs>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     */
    destination?: pulumi.Input<inputs.eventgrid.v20190601.EventHubEventSubscriptionDestinationArgs | inputs.eventgrid.v20190601.HybridConnectionEventSubscriptionDestinationArgs | inputs.eventgrid.v20190601.ServiceBusQueueEventSubscriptionDestinationArgs | inputs.eventgrid.v20190601.StorageQueueEventSubscriptionDestinationArgs | inputs.eventgrid.v20190601.WebHookEventSubscriptionDestinationArgs>;
    /**
     ...
     * Information about the filter for the event subscription.
     */
    filter?: pulumi.Input<inputs.eventgrid.v20190601.EventSubscriptionFilterArgs>;
    /**
     * List of user defined labels.
     */
     ...
     * The retry policy for events. This can be used to configure maximum number of delivery attempts and time to live for events.
     */
    retryPolicy?: pulumi.Input<inputs.eventgrid.v20190601.RetryPolicyArgs>;
    /**
