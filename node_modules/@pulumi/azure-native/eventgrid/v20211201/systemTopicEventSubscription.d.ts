...
export declare class SystemTopicEventSubscription extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SystemTopicEventSubscription;
    /**
     ...
     */
    readonly deadLetterDestination: pulumi.Output<outputs.eventgrid.v20211201.StorageBlobDeadLetterDestinationResponse | undefined>;
    /**
     * The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to the dead letter destination.
     * Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
     */
    readonly deadLetterWithResourceIdentity: pulumi.Output<outputs.eventgrid.v20211201.DeadLetterWithResourceIdentityResponse | undefined>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     * Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
     */
    readonly deliveryWithResourceIdentity: pulumi.Output<outputs.eventgrid.v20211201.DeliveryWithResourceIdentityResponse | undefined>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     */
     ...
     */
    readonly filter: pulumi.Output<outputs.eventgrid.v20211201.EventSubscriptionFilterResponse | undefined>;
    /**
     ...
     */
    readonly retryPolicy: pulumi.Output<outputs.eventgrid.v20211201.RetryPolicyResponse | undefined>;
    /**
     * The system metadata relating to Event Subscription resource.
     */
    readonly systemData: pulumi.Output<outputs.eventgrid.v20211201.SystemDataResponse>;
    /**
...
export interface SystemTopicEventSubscriptionArgs {
     ...
     * Information about the destination where events have to be delivered for the event subscription.
     */
    destination?: pulumi.Input<inputs.eventgrid.v20211201.AzureFunctionEventSubscriptionDestinationArgs | inputs.eventgrid.v20211201.EventHubEventSubscriptionDestinationArgs | inputs.eventgrid.v20211201.HybridConnectionEventSubscriptionDestinationArgs | inputs.eventgrid.v20211201.ServiceBusQueueEventSubscriptionDestinationArgs | inputs.eventgrid.v20211201.ServiceBusTopicEventSubscriptionDestinationArgs | inputs.eventgrid.v20211201.StorageQueueEventSubscriptionDestinationArgs | inputs.eventgrid.v20211201.WebHookEventSubscriptionDestinationArgs>;
    /**
     * The event delivery schema for the event subscription.
     */
    eventDeliverySchema?: pulumi.Input<string | enums.eventgrid.v20211201.EventDeliverySchema>;
    /**
     ...
     * Information about the filter for the event subscription.
     */
    filter?: pulumi.Input<inputs.eventgrid.v20211201.EventSubscriptionFilterArgs>;
    /**
     * List of user defined labels.
     */
     ...
     * The retry policy for events. This can be used to configure maximum number of delivery attempts and time to live for events.
     */
    retryPolicy?: pulumi.Input<inputs.eventgrid.v20211201.RetryPolicyArgs>;
    /**
