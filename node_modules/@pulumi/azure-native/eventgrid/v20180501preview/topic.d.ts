...
export declare class Topic extends pulumi.CustomResource {
     ...
     */
    readonly inputSchemaMapping: pulumi.Output<outputs.eventgrid.v20180501preview.JsonInputSchemaMappingResponse | undefined>;
    /**
...
export interface TopicArgs {
     ...
     * This determines the format that Event Grid should expect for incoming events published to the topic.
     */
    inputSchema?: pulumi.Input<string | enums.eventgrid.v20180501preview.InputSchema>;
    /**
     * This enables publishing using custom event schemas. An InputSchemaMapping can be specified to map various properties of a source schema to various required properties of the EventGridEvent schema.
     */
    inputSchemaMapping?: pulumi.Input<inputs.eventgrid.v20180501preview.JsonInputSchemaMappingArgs>;
    /**
     * Location of the resource
     */
