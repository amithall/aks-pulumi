...
export interface ListJobCredentialsResult {
     ...
     */
    readonly value?: outputs.databox.v20200401.UnencryptedCredentialsResponse[];
}
export declare function listJobCredentialsOutput(args: ListJobCredentialsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListJobCredentialsResult>;
