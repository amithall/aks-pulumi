...
export declare class ContentKeyPolicy extends pulumi.CustomResource {
     ...
     */
    readonly options: pulumi.Output<outputs.media.v20211101.ContentKeyPolicyOptionResponse[]>;
    /**
...
export interface ContentKeyPolicyArgs {
     ...
     * The Key Policy options.
     */
    options: pulumi.Input<pulumi.Input<inputs.media.v20211101.ContentKeyPolicyOptionArgs>[]>;
    /**
