...
export interface ListAssetStreamingLocatorsResult {
     ...
     */
    readonly streamingLocators: outputs.media.v20200501.AssetStreamingLocatorResponse[];
}
export declare function listAssetStreamingLocatorsOutput(args: ListAssetStreamingLocatorsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListAssetStreamingLocatorsResult>;
