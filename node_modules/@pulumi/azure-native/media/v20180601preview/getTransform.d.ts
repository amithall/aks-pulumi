...
export interface GetTransformResult {
     ...
     */
    readonly outputs: outputs.media.v20180601preview.TransformOutputResponse[];
    /**
     * The type of the resource.
     */
    readonly type: string;
}
export declare function getTransformOutput(args: GetTransformOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetTransformResult>;
