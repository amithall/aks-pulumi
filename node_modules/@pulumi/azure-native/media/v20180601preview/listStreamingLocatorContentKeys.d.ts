...
export interface ListStreamingLocatorContentKeysResult {
     ...
     */
    readonly contentKeys?: outputs.media.v20180601preview.StreamingLocatorContentKeyResponse[];
}
export declare function listStreamingLocatorContentKeysOutput(args: ListStreamingLocatorContentKeysOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListStreamingLocatorContentKeysResult>;
