...
export interface GetJobResult {
     ...
     */
    readonly input: outputs.media.JobInputAssetResponse | outputs.media.JobInputClipResponse | outputs.media.JobInputHttpResponse | outputs.media.JobInputSequenceResponse | outputs.media.JobInputsResponse;
    /**
     ...
     */
    readonly outputs: outputs.media.JobOutputAssetResponse[];
    /**
