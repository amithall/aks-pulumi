...
export declare class ArtifactSource extends pulumi.CustomResource {
     ...
     */
    readonly artifactRoot: pulumi.Output<string | undefined>;
    /**
     * The authentication method to use to access the artifact source.
     */
    readonly authentication: pulumi.Output<outputs.deploymentmanager.v20180901preview.SasAuthenticationResponse>;
    /**
...
export interface ArtifactSourceArgs {
     ...
     * The authentication method to use to access the artifact source.
     */
    authentication: pulumi.Input<inputs.deploymentmanager.v20180901preview.SasAuthenticationArgs>;
    /**
     * The geo-location where the resource lives
     */
