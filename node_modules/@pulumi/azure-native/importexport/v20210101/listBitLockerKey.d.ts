...
export interface ListBitLockerKeyResult {
     ...
     * drive status
     */
    readonly value?: outputs.importexport.v20210101.DriveBitLockerKeyResponse[];
}
export declare function listBitLockerKeyOutput(args: ListBitLockerKeyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListBitLockerKeyResult>;
