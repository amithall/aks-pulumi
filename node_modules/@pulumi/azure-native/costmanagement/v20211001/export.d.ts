...
export declare class Export extends pulumi.CustomResource {
     ...
     */
    readonly definition: pulumi.Output<outputs.costmanagement.v20211001.ExportDefinitionResponse>;
    /**
     * Has delivery information for the export.
     */
    readonly deliveryInfo: pulumi.Output<outputs.costmanagement.v20211001.ExportDeliveryInfoResponse>;
    /**
     ...
     */
    readonly partitionData: pulumi.Output<boolean | undefined>;
    /**
     * If requested, has the most recent execution history for the export.
     */
    readonly runHistory: pulumi.Output<outputs.costmanagement.v20211001.ExportExecutionListResultResponse | undefined>;
    /**
     * Has schedule information for the export.
     */
    readonly schedule: pulumi.Output<outputs.costmanagement.v20211001.ExportScheduleResponse | undefined>;
    /**
     * Resource type.
     */
...
export interface ExportArgs {
     ...
     * Has the definition for the export.
     */
    definition: pulumi.Input<inputs.costmanagement.v20211001.ExportDefinitionArgs>;
    /**
     * Has delivery information for the export.
     */
    deliveryInfo: pulumi.Input<inputs.costmanagement.v20211001.ExportDeliveryInfoArgs>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * The format of the export being delivered. Currently only 'Csv' is supported.
     */
    format?: pulumi.Input<string | enums.costmanagement.v20211001.FormatType>;
    /**
     * If set to true, exported data will be partitioned by size and placed in a blob directory together with a manifest file. Note: this option is currently available only for modern commerce scopes.
     */
     ...
     * Has schedule information for the export.
     */
    schedule?: pulumi.Input<inputs.costmanagement.v20211001.ExportScheduleArgs>;
    /**
