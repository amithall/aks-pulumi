...
export declare class VendorSkus extends pulumi.CustomResource {
     ...
     */
    readonly networkFunctionTemplate: pulumi.Output<outputs.hybridnetwork.v20220101preview.NetworkFunctionTemplateResponse | undefined>;
    /**
...
export interface VendorSkusArgs {
     ...
     * The sku deployment mode.
     */
    deploymentMode?: pulumi.Input<string | enums.hybridnetwork.v20220101preview.SkuDeploymentMode>;
    /**
     * The parameters for the managed application to be supplied by the vendor.
     */
     ...
     * The template definition of the network function.
     */
    networkFunctionTemplate?: pulumi.Input<inputs.hybridnetwork.v20220101preview.NetworkFunctionTemplateArgs>;
    /**
     * The network function type.
     */
    networkFunctionType?: pulumi.Input<string | enums.hybridnetwork.v20220101preview.NetworkFunctionType>;
    /**
     * Indicates if the vendor sku is in preview mode.
     */
     ...
     * The sku type.
     */
    skuType?: pulumi.Input<string | enums.hybridnetwork.v20220101preview.SkuType>;
    /**
