...
export declare class NetworkFunction extends pulumi.CustomResource {
     ...
     */
    readonly device: pulumi.Output<outputs.hybridnetwork.v20210501.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly managedApplication: pulumi.Output<outputs.hybridnetwork.v20210501.SubResourceResponse>;
    /**
     ...
     */
    readonly networkFunctionUserConfigurations: pulumi.Output<outputs.hybridnetwork.v20210501.NetworkFunctionUserConfigurationResponse[] | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.hybridnetwork.v20210501.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkFunctionArgs {
     ...
     * The reference to the device resource. Once set, it cannot be updated.
     */
    device?: pulumi.Input<inputs.hybridnetwork.v20210501.SubResourceArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The network function configurations from the user.
     */
    networkFunctionUserConfigurations?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20210501.NetworkFunctionUserConfigurationArgs>[]>;
    /**
