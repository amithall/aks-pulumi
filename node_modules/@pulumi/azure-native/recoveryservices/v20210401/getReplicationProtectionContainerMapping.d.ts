...
export interface GetReplicationProtectionContainerMappingResult {
     ...
     * The custom data.
     */
    readonly properties: outputs.recoveryservices.v20210401.ProtectionContainerMappingPropertiesResponse;
    /**
     * Resource Type
     */
    readonly type: string;
}
export declare function getReplicationProtectionContainerMappingOutput(args: GetReplicationProtectionContainerMappingOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetReplicationProtectionContainerMappingResult>;
