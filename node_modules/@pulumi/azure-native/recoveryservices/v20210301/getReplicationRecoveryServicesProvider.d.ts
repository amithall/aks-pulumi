...
export interface GetReplicationRecoveryServicesProviderResult {
     ...
     * Provider properties.
     */
    readonly properties: outputs.recoveryservices.v20210301.RecoveryServicesProviderPropertiesResponse;
    /**
     * Resource Type
     */
    readonly type: string;
}
export declare function getReplicationRecoveryServicesProviderOutput(args: GetReplicationRecoveryServicesProviderOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetReplicationRecoveryServicesProviderResult>;
