...
export declare class ReplicationRecoveryPlan extends pulumi.CustomResource {
     ...
     * The custom details.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20211001.RecoveryPlanPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryPlanArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20211001.CreateRecoveryPlanInputPropertiesArgs>;
    /**
     * Recovery plan name.
     */
