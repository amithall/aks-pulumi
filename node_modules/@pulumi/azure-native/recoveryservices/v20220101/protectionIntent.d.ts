...
export declare class ProtectionIntent extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20220101.AzureRecoveryServiceVaultProtectionIntentResponse | outputs.recoveryservices.v20220101.AzureResourceProtectionIntentResponse | outputs.recoveryservices.v20220101.AzureWorkloadAutoProtectionIntentResponse | outputs.recoveryservices.v20220101.AzureWorkloadContainerAutoProtectionIntentResponse | outputs.recoveryservices.v20220101.AzureWorkloadSQLAutoProtectionIntentResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectionIntentArgs {
     ...
     * ProtectionIntentResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20220101.AzureRecoveryServiceVaultProtectionIntentArgs | inputs.recoveryservices.v20220101.AzureResourceProtectionIntentArgs | inputs.recoveryservices.v20220101.AzureWorkloadAutoProtectionIntentArgs | inputs.recoveryservices.v20220101.AzureWorkloadContainerAutoProtectionIntentArgs | inputs.recoveryservices.v20220101.AzureWorkloadSQLAutoProtectionIntentArgs>;
    /**
