...
export declare class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
     ...
     * Provider properties.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20211201.RecoveryServicesProviderPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryServicesProviderArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20211201.AddRecoveryServicesProviderInputPropertiesArgs>;
    /**
