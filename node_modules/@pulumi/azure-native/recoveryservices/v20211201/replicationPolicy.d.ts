...
export declare class ReplicationPolicy extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20211201.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationPolicyArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20211201.CreatePolicyInputPropertiesArgs>;
    /**
