...
export declare class ReplicationProtectedItem extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20211201.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectedItemArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20211201.EnableProtectionInputPropertiesArgs>;
    /**
