...
export interface GetReplicationStorageClassificationMappingResult {
     ...
     */
    readonly properties: outputs.recoveryservices.v20160810.StorageClassificationMappingPropertiesResponse;
    /**
     * Resource Type
     */
    readonly type: string;
}
export declare function getReplicationStorageClassificationMappingOutput(args: GetReplicationStorageClassificationMappingOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetReplicationStorageClassificationMappingResult>;
