...
export declare class ProtectionPolicy extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20220201.AzureFileShareProtectionPolicyResponse | outputs.recoveryservices.v20220201.AzureIaaSVMProtectionPolicyResponse | outputs.recoveryservices.v20220201.AzureSqlProtectionPolicyResponse | outputs.recoveryservices.v20220201.AzureVmWorkloadProtectionPolicyResponse | outputs.recoveryservices.v20220201.GenericProtectionPolicyResponse | outputs.recoveryservices.v20220201.MabProtectionPolicyResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectionPolicyArgs {
     ...
     * ProtectionPolicyResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20220201.AzureFileShareProtectionPolicyArgs | inputs.recoveryservices.v20220201.AzureIaaSVMProtectionPolicyArgs | inputs.recoveryservices.v20220201.AzureSqlProtectionPolicyArgs | inputs.recoveryservices.v20220201.AzureVmWorkloadProtectionPolicyArgs | inputs.recoveryservices.v20220201.GenericProtectionPolicyArgs | inputs.recoveryservices.v20220201.MabProtectionPolicyArgs>;
    /**
