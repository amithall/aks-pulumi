...
export declare class ReplicationProtectionContainerMapping extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20210701.ProtectionContainerMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectionContainerMappingArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20210701.CreateProtectionContainerMappingInputPropertiesArgs>;
    /**
