...
export declare class ReplicationFabric extends pulumi.CustomResource {
     ...
     * Fabric related data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20211101.FabricPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationFabricArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20211101.FabricCreationInputPropertiesArgs>;
    /**
