...
export declare class SignalRPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.signalrservice.v20210901preview.PrivateEndpointResponse | undefined>;
    /**
     * Connection state
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.signalrservice.v20210901preview.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface SignalRPrivateEndpointConnectionArgs {
     ...
     * Private endpoint associated with the private endpoint connection
     */
    privateEndpoint?: pulumi.Input<inputs.signalrservice.v20210901preview.PrivateEndpointArgs>;
    /**
     ...
     * Connection state
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.signalrservice.v20210901preview.PrivateLinkServiceConnectionStateArgs>;
    /**
