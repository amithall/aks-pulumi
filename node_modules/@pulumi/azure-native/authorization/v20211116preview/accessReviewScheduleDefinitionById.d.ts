...
export declare class AccessReviewScheduleDefinitionById extends pulumi.CustomResource {
     ...
     */
    readonly assignmentState: pulumi.Output<string>;
    /**
     ...
     */
    readonly backupReviewers: pulumi.Output<outputs.authorization.v20211116preview.AccessReviewReviewerResponse[] | undefined>;
    /**
     ...
     */
    readonly expandNestedMemberships: pulumi.Output<boolean | undefined>;
    /**
     * Duration users are inactive for. The value should be in ISO  8601 format (http://en.wikipedia.org/wiki/ISO_8601#Durations).This code can be used to convert TimeSpan to a valid interval string: XmlConvert.ToString(new TimeSpan(hours, minutes, seconds))
     */
    readonly inactiveDuration: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly instances: pulumi.Output<outputs.authorization.v20211116preview.AccessReviewInstanceResponse[] | undefined>;
    /**
     ...
     */
    readonly reviewers: pulumi.Output<outputs.authorization.v20211116preview.AccessReviewReviewerResponse[] | undefined>;
    /**
...
export interface AccessReviewScheduleDefinitionByIdArgs {
     ...
     * This specifies the behavior for the autoReview feature when an access review completes.
     */
    defaultDecision?: pulumi.Input<string | enums.authorization.v20211116preview.DefaultDecisionType>;
    /**
     * Flag to indicate whether reviewers are required to provide a justification when reviewing access.
     */
     ...
     * This is the collection of instances returned when one does an expand on it.
     */
    instances?: pulumi.Input<pulumi.Input<inputs.authorization.v20211116preview.AccessReviewInstanceArgs>[]>;
    /**
     * The interval for recurrence. For a quarterly review, the interval is 3 for type : absoluteMonthly.
     */
