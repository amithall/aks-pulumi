 ...
 */
export declare class AccessReviewHistoryDefinitionById extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessReviewHistoryDefinitionById;
    /**
     ...
     */
    static isInstance(obj: any): obj is AccessReviewHistoryDefinitionById;
    /**
     ...
     */
    readonly instances: pulumi.Output<outputs.authorization.v20211116preview.AccessReviewHistoryInstanceResponse[] | undefined>;
    /**
     ...
     */
    readonly scopes: pulumi.Output<outputs.authorization.v20211116preview.AccessReviewScopeResponse[] | undefined>;
    /**
...
export interface AccessReviewHistoryDefinitionByIdArgs {
     ...
     * Collection of review decisions which the history data should be filtered on. For example if Approve and Deny are supplied the data will only contain review results in which the decision maker approved or denied a review request.
     */
    decisions?: pulumi.Input<pulumi.Input<string | enums.authorization.v20211116preview.AccessReviewResult>[]>;
    /**
     * The display name for the history definition.
     */
     ...
     * Set of access review history instances for this history definition.
     */
    instances?: pulumi.Input<pulumi.Input<inputs.authorization.v20211116preview.AccessReviewHistoryInstanceArgs>[]>;
    /**
     * The interval for recurrence. For a quarterly review, the interval is 3 for type : absoluteMonthly.
     */
     ...
     * A collection of scopes used when selecting review history data
     */
    scopes?: pulumi.Input<pulumi.Input<inputs.authorization.v20211116preview.AccessReviewScopeArgs>[]>;
    /**
     * The DateTime when the review is scheduled to be start. This could be a date in the future. Required on create.
     */
     ...
     */
    type?: pulumi.Input<string | enums.authorization.v20211116preview.AccessReviewRecurrenceRangeType>;
}
