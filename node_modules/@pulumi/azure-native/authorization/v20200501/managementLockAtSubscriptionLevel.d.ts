 ...
 */
export declare class ManagementLockAtSubscriptionLevel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagementLockAtSubscriptionLevel;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagementLockAtSubscriptionLevel;
    /**
     ...
     */
    readonly owners: pulumi.Output<outputs.authorization.v20200501.ManagementLockOwnerResponse[] | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: pulumi.Output<outputs.authorization.v20200501.SystemDataResponse>;
    /**
...
export interface ManagementLockAtSubscriptionLevelArgs {
     ...
     * The level of the lock. Possible values are: NotSpecified, CanNotDelete, ReadOnly. CanNotDelete means authorized users are able to read and modify the resources, but not delete. ReadOnly means authorized users can only read from a resource, but they can't modify or delete it.
     */
    level: pulumi.Input<string | enums.authorization.v20200501.LockLevel>;
    /**
     ...
     * The owners of the lock.
     */
    owners?: pulumi.Input<pulumi.Input<inputs.authorization.v20200501.ManagementLockOwnerArgs>[]>;
}
