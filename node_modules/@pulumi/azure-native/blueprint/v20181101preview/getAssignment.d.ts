...
export interface GetAssignmentResult {
    ...
    readonly resourceGroups: {
        [key: string]: outputs.blueprint.v20181101preview.ResourceGroupValueResponse;
    };
    /**
...
export declare function getAssignmentOutput(args: GetAssignmentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAssignmentResult>;
