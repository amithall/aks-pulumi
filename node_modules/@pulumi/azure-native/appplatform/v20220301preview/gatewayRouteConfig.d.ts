 ...
 */
export declare class GatewayRouteConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayRouteConfig;
    /**
     * Returns true if the given object is an instance of GatewayRouteConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GatewayRouteConfig;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.appplatform.v20220301preview.GatewayRouteConfigPropertiesResponse>;
    /**
...
export interface GatewayRouteConfigArgs {
     ...
     * API route config of the Spring Cloud Gateway
     */
    properties?: pulumi.Input<inputs.appplatform.v20220301preview.GatewayRouteConfigPropertiesArgs>;
    /**
