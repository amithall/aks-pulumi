 ...
 */
export declare class ProductSetting extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProductSetting;
    /**
     * Returns true if the given object is an instance of ProductSetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProductSetting;
    /**
...
export interface ProductSettingArgs {
     ...
     * The kind of the setting
     */
    kind: pulumi.Input<string | enums.securityinsights.v20210901preview.SettingKind>;
    /**
