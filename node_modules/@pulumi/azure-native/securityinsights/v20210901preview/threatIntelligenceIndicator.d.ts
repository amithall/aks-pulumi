...
export interface ThreatIntelligenceIndicatorArgs {
     ...
     * External References
     */
    externalReferences?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20210901preview.ThreatIntelligenceExternalReferenceArgs>[]>;
    /**
     * Granular Markings
     */
    granularMarkings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20210901preview.ThreatIntelligenceGranularMarkingModelArgs>[]>;
    /**
     ...
     * Kill chain phases
     */
    killChainPhases?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20210901preview.ThreatIntelligenceKillChainPhaseArgs>[]>;
    /**
     * The kind of the entity.
     */
    kind: pulumi.Input<string | enums.securityinsights.v20210901preview.ThreatIntelligenceResourceKindEnum>;
    /**
     ...
     * Parsed patterns
     */
    parsedPattern?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20210901preview.ThreatIntelligenceParsedPatternArgs>[]>;
    /**
