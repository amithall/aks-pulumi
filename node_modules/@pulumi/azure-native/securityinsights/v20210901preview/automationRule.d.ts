...
export declare class AutomationRule extends pulumi.CustomResource {
     ...
     */
    readonly actions: pulumi.Output<(outputs.securityinsights.v20210901preview.AutomationRuleModifyPropertiesActionResponse | outputs.securityinsights.v20210901preview.AutomationRuleRunPlaybookActionResponse)[]>;
    /**
     * Describes the client that created the automation rule
     */
    readonly createdBy: pulumi.Output<outputs.securityinsights.v20210901preview.ClientInfoResponse>;
    /**
     ...
     */
    readonly lastModifiedBy: pulumi.Output<outputs.securityinsights.v20210901preview.ClientInfoResponse>;
    /**
     ...
     */
    readonly triggeringLogic: pulumi.Output<outputs.securityinsights.v20210901preview.AutomationRuleTriggeringLogicResponse>;
    /**
...
export interface AutomationRuleArgs {
     ...
     * The actions to execute when the automation rule is triggered
     */
    actions: pulumi.Input<pulumi.Input<inputs.securityinsights.v20210901preview.AutomationRuleModifyPropertiesActionArgs | inputs.securityinsights.v20210901preview.AutomationRuleRunPlaybookActionArgs>[]>;
    /**
     * Automation rule ID
     */
     ...
     * The triggering logic of the automation rule
     */
    triggeringLogic: pulumi.Input<inputs.securityinsights.v20210901preview.AutomationRuleTriggeringLogicArgs>;
    /**
