 ...
 */
export declare function getAwsS3DataConnector(args: GetAwsS3DataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetAwsS3DataConnectorResult>;
...
export interface GetAwsS3DataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20211001preview.AwsS3DataConnectorDataTypesResponse;
    /**
...
export declare function getAwsS3DataConnectorOutput(args: GetAwsS3DataConnectorOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAwsS3DataConnectorResult>;
