 ...
 */
export declare function getTiTaxiiDataConnector(args: GetTiTaxiiDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetTiTaxiiDataConnectorResult>;
...
export interface GetTiTaxiiDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20211001preview.TiTaxiiDataConnectorDataTypesResponse;
    /**
...
export declare function getTiTaxiiDataConnectorOutput(args: GetTiTaxiiDataConnectorOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetTiTaxiiDataConnectorResult>;
