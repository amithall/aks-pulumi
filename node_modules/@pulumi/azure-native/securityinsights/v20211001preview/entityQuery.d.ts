 ...
 */
export declare class EntityQuery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EntityQuery;
    /**
     * Returns true if the given object is an instance of EntityQuery.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EntityQuery;
    /**
...
export interface EntityQueryArgs {
     ...
     * the entity query kind
     */
    kind: pulumi.Input<string | enums.securityinsights.v20211001preview.CustomEntityQueryKind>;
    /**
