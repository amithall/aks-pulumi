...
export declare class ScheduledAlertRule extends pulumi.CustomResource {
     ...
     */
    readonly alertDetailsOverride: pulumi.Output<outputs.securityinsights.v20211001preview.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    readonly customDetails: pulumi.Output<{
        [key: string]: string;
    } | undefined>;
    /**
     ...
     */
    readonly entityMappings: pulumi.Output<outputs.securityinsights.v20211001preview.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    readonly eventGroupingSettings: pulumi.Output<outputs.securityinsights.v20211001preview.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    readonly incidentConfiguration: pulumi.Output<outputs.securityinsights.v20211001preview.IncidentConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.securityinsights.v20211001preview.SystemDataResponse>;
    /**
     ...
     */
    readonly templateVersion: pulumi.Output<string | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<inputs.securityinsights.v20211001preview.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20211001preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20211001preview.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | enums.securityinsights.v20211001preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20211001preview.AttackTactic>[]>;
    /**
     * The techniques of the alert rule
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20211001preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
