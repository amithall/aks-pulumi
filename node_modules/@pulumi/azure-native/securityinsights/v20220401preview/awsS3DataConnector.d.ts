 ...
 */
export declare class AwsS3DataConnector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AwsS3DataConnector;
    /**
     * Returns true if the given object is an instance of AwsS3DataConnector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AwsS3DataConnector;
    /**
     * The available data types for the connector.
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20220401preview.AwsS3DataConnectorDataTypesResponse>;
    /**
     ...
     */
    readonly kind: pulumi.Output<"AmazonWebServicesS3">;
    /**
...
export interface AwsS3DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20220401preview.AwsS3DataConnectorDataTypesArgs>;
    /**
     * The logs destination table name in LogAnalytics.
     */
