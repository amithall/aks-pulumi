...
export declare class Incident extends pulumi.CustomResource {
     ...
     */
    readonly additionalData: pulumi.Output<outputs.securityinsights.v20210401.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    readonly labels: pulumi.Output<outputs.securityinsights.v20210401.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    readonly owner: pulumi.Output<outputs.securityinsights.v20210401.IncidentOwnerInfoResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.securityinsights.v20210401.SystemDataResponse>;
    /**
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    classification?: pulumi.Input<string | enums.securityinsights.v20210401.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    classificationReason?: pulumi.Input<string | enums.securityinsights.v20210401.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20210401.IncidentLabelArgs>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    owner?: pulumi.Input<inputs.securityinsights.v20210401.IncidentOwnerInfoArgs>;
    /**
     ...
     * The severity of the incident
     */
    severity: pulumi.Input<string | enums.securityinsights.v20210401.IncidentSeverity>;
    /**
     * The status of the incident
     */
    status: pulumi.Input<string | enums.securityinsights.v20210401.IncidentStatus>;
    /**
     * The title of the incident
     */
