...
export interface ListSourceControlRepositoriesResult {
     ...
     */
    readonly value: outputs.securityinsights.v20220101preview.RepoResponse[];
}
export declare function listSourceControlRepositoriesOutput(args: ListSourceControlRepositoriesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListSourceControlRepositoriesResult>;
