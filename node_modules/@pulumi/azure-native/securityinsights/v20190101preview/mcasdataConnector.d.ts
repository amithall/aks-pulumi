...
export declare class MCASDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20190101preview.MCASDataConnectorDataTypesResponse>;
    /**
...
export interface MCASDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20190101preview.MCASDataConnectorDataTypesArgs>;
    /**
     *
     * Expected value is 'MicrosoftCloudAppSecurity'.
     */
