 ...
 */
export declare class Ueba extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ueba;
    /**
     * Returns true if the given object is an instance of Ueba.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Ueba;
    /**
     ...
     */
    readonly kind: pulumi.Output<"Ueba">;
    /**
     * Azure resource name
     */
...
export interface UebaArgs {
     ...
     * The relevant data sources that enriched by ueba
     */
    dataSources?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20210301preview.UebaDataSources>[]>;
    /**
     * The kind of the setting
     * Expected value is 'Ueba'.
     */
