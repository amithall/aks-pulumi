...
export interface GetComponentResult {
     ...
     */
    readonly privateLinkScopedResources: outputs.insights.v20200202preview.PrivateLinkScopedResourceResponse[];
    /**
...
export declare function getComponentOutput(args: GetComponentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetComponentResult>;
