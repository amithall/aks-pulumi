...
export declare class ScheduledQueryRule extends pulumi.CustomResource {
     ...
     */
    readonly actions: pulumi.Output<outputs.insights.v20210801.ActionsResponse | undefined>;
    /**
     ...
     */
    readonly checkWorkspaceAlertsStorageConfigured: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly criteria: pulumi.Output<outputs.insights.v20210801.ScheduledQueryRuleCriteriaResponse>;
    /**
     ...
     */
    readonly isWorkspaceAlertsStorageConfigured: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly skipQueryValidation: pulumi.Output<boolean | undefined>;
    /**
     * SystemData of ScheduledQueryRule.
     */
    readonly systemData: pulumi.Output<outputs.insights.v20210801.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ScheduledQueryRuleArgs {
     ...
     * Actions to invoke when the alert fires.
     */
    actions?: pulumi.Input<inputs.insights.v20210801.ActionsArgs>;
    /**
     * The flag that indicates whether the alert should be automatically resolved or not. The default is true. Relevant only for rules of the kind LogAlert.
     */
     ...
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    criteria: pulumi.Input<inputs.insights.v20210801.ScheduledQueryRuleCriteriaArgs>;
    /**
     * The description of the scheduled query rule.
     */
