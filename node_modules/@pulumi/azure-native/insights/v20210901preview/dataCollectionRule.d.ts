...
export declare class DataCollectionRule extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataCollectionRule;
    /**
     ...
     */
    readonly dataFlows: pulumi.Output<outputs.insights.v20210901preview.DataFlowResponse[] | undefined>;
    /**
     * The specification of data sources.
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    readonly dataSources: pulumi.Output<outputs.insights.v20210901preview.DataCollectionRuleResponseDataSources | undefined>;
    /**
     ...
     */
    readonly destinations: pulumi.Output<outputs.insights.v20210901preview.DataCollectionRuleResponseDestinations | undefined>;
    /**
     ...
     */
    readonly metadata: pulumi.Output<outputs.insights.v20210901preview.DataCollectionRuleResponseMetadata>;
    /**
     ...
     */
    readonly streamDeclarations: pulumi.Output<{
        [key: string]: outputs.insights.v20210901preview.StreamDeclarationResponse;
    } | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: pulumi.Output<outputs.insights.v20210901preview.DataCollectionRuleResourceResponseSystemData>;
    /**
     * Resource tags.
     */
...
export interface DataCollectionRuleArgs {
     ...
     * Declaration of custom streams used in this rule.
     */
    streamDeclarations?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.insights.v20210901preview.StreamDeclarationArgs>;
    }>;
    /**
     * Resource tags.
     */
