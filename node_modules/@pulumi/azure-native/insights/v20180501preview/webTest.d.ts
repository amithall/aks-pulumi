...
export declare class WebTest extends pulumi.CustomResource {
     ...
     */
    readonly configuration: pulumi.Output<outputs.insights.v20180501preview.WebTestPropertiesResponseConfiguration | undefined>;
    /**
     ...
     */
    readonly locations: pulumi.Output<outputs.insights.v20180501preview.WebTestGeolocationResponse[]>;
    /**
     * Azure resource name
     */
     ...
     */
    readonly request: pulumi.Output<outputs.insights.v20180501preview.WebTestPropertiesResponseRequest | undefined>;
    /**
     ...
     */
    readonly validationRules: pulumi.Output<outputs.insights.v20180501preview.WebTestPropertiesResponseValidationRules | undefined>;
    /**
...
export interface WebTestArgs {
     ...
     * An XML configuration specification for a WebTest.
     */
    configuration?: pulumi.Input<inputs.insights.v20180501preview.WebTestPropertiesConfigurationArgs>;
    /**
     * User defined description for this WebTest.
     */
     ...
     * The kind of WebTest that this web test watches. Choices are ping and multistep.
     */
    kind?: pulumi.Input<enums.insights.v20180501preview.WebTestKind>;
    /**
     * Resource location
     */
     ...
     * A list of where to physically run the tests from to give global coverage for accessibility of your application.
     */
    locations: pulumi.Input<pulumi.Input<inputs.insights.v20180501preview.WebTestGeolocationArgs>[]>;
    /**
     * The collection of request properties
     */
    request?: pulumi.Input<inputs.insights.v20180501preview.WebTestPropertiesRequestArgs>;
    /**
     ...
     * The collection of validation rule properties
     */
    validationRules?: pulumi.Input<inputs.insights.v20180501preview.WebTestPropertiesValidationRulesArgs>;
    /**
     * The kind of web test this is, valid choices are ping, multistep, basic, and standard.
     */
    webTestKind: pulumi.Input<enums.insights.v20180501preview.WebTestKindEnum>;
    /**
     * User defined name if this WebTest.
     */
