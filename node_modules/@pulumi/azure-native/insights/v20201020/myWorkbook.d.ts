...
export declare class MyWorkbook extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.insights.v20201020.MyWorkbookManagedIdentityResponse | undefined>;
    /**
...
export interface MyWorkbookArgs {
     ...
     * Identity used for BYOS
     */
    identity?: pulumi.Input<inputs.insights.v20201020.MyWorkbookManagedIdentityArgs>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
    kind?: pulumi.Input<string | enums.insights.v20201020.Kind>;
    /**
     * Resource location
     */
