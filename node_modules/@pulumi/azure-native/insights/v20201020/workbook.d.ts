...
export declare class Workbook extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.insights.v20201020.WorkbookManagedIdentityResponse | undefined>;
    /**
...
export interface WorkbookArgs {
     ...
     * Identity used for BYOS
     */
    identity?: pulumi.Input<inputs.insights.v20201020.WorkbookManagedIdentityArgs>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
