...
export declare class AutoscaleSetting extends pulumi.CustomResource {
     ...
     */
    readonly notifications: pulumi.Output<outputs.insights.v20140401.AutoscaleNotificationResponse[] | undefined>;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    readonly profiles: pulumi.Output<outputs.insights.v20140401.AutoscaleProfileResponse[]>;
    /**
     * Resource tags
     */
...
export interface AutoscaleSettingArgs {
     ...
     * the collection of notifications.
     */
    notifications?: pulumi.Input<pulumi.Input<inputs.insights.v20140401.AutoscaleNotificationArgs>[]>;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    profiles: pulumi.Input<pulumi.Input<inputs.insights.v20140401.AutoscaleProfileArgs>[]>;
    /**
