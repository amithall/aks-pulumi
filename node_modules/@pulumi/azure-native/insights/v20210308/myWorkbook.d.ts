...
export declare class MyWorkbook extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.insights.v20210308.MyWorkbookManagedIdentityResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.insights.v20210308.SystemDataResponse>;
    /**
     * Resource tags
     */
...
export interface MyWorkbookArgs {
     ...
     * Identity used for BYOS
     */
    identity?: pulumi.Input<inputs.insights.v20210308.MyWorkbookManagedIdentityArgs>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
