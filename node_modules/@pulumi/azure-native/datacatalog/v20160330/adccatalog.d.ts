...
export interface ADCCatalogArgs {
     ...
     * Azure data catalog admin list.
     */
    admins?: pulumi.Input<pulumi.Input<inputs.datacatalog.v20160330.PrincipalsArgs>[]>;
    /**
     ...
     * Azure data catalog SKU.
     */
    sku?: pulumi.Input<string | enums.datacatalog.v20160330.SkuType>;
    /**
     * Azure data catalog provision status.
     */
     ...
     * Azure data catalog user list.
     */
    users?: pulumi.Input<pulumi.Input<inputs.datacatalog.v20160330.PrincipalsArgs>[]>;
}
