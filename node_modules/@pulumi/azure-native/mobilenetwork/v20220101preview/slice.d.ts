...
export declare class Slice extends pulumi.CustomResource {
     ...
     */
    readonly snssai: pulumi.Output<outputs.mobilenetwork.v20220101preview.SnssaiResponse>;
    /**
     * Resource tags.
     */
...
export interface SliceArgs {
     ...
     * The S-NSSAI (single network slice selection assistance information). Unique at the scope of a MobileNetwork.
     */
    snssai: pulumi.Input<inputs.mobilenetwork.v20220101preview.SnssaiArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
