 ...
 */
export declare function getPacketCoreDataPlane(args: GetPacketCoreDataPlaneArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCoreDataPlaneResult>;
...
export interface GetPacketCoreDataPlaneResult {
     ...
     */
    readonly userPlaneAccessInterface: outputs.mobilenetwork.v20220101preview.InterfacePropertiesResponse;
}
export declare function getPacketCoreDataPlaneOutput(args: GetPacketCoreDataPlaneOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPacketCoreDataPlaneResult>;
