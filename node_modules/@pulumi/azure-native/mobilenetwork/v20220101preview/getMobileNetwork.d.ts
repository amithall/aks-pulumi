 ...
 */
export declare function getMobileNetwork(args: GetMobileNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetMobileNetworkResult>;
...
export interface GetMobileNetworkResult {
     ...
     */
    readonly publicLandMobileNetworkIdentifier: outputs.mobilenetwork.v20220101preview.PlmnIdResponse;
    /**
...
export declare function getMobileNetworkOutput(args: GetMobileNetworkOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMobileNetworkResult>;
