...
export declare class PacketCoreDataPlane extends pulumi.CustomResource {
     ...
     */
    readonly userPlaneAccessInterface: pulumi.Output<outputs.mobilenetwork.v20220101preview.InterfacePropertiesResponse>;
    /**
...
export interface PacketCoreDataPlaneArgs {
     ...
     * The user plane interface on the access network. In 5G networks this is called as N3 interface whereas in 4G networks this is called the S1-U interface.
     */
    userPlaneAccessInterface: pulumi.Input<inputs.mobilenetwork.v20220101preview.InterfacePropertiesArgs>;
}
