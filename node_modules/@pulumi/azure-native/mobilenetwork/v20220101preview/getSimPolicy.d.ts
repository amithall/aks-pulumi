 ...
 * Sim policy resource.
 */
export declare function getSimPolicy(args: GetSimPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetSimPolicyResult>;
...
export interface GetSimPolicyResult {
     ...
     */
    readonly defaultSlice: outputs.mobilenetwork.v20220101preview.SliceResourceIdResponse;
    /**
     ...
     */
    readonly sliceConfigurations: outputs.mobilenetwork.v20220101preview.SliceConfigurationResponse[];
    /**
     * Resource tags.
     */
    readonly tags?: {
     ...
     */
    readonly ueAmbr: outputs.mobilenetwork.v20220101preview.AmbrResponse;
}
export declare function getSimPolicyOutput(args: GetSimPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSimPolicyResult>;
