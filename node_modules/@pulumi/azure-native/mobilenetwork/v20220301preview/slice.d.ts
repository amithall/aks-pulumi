 ...
 */
export declare class Slice extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Slice;
    /**
     * Returns true if the given object is an instance of Slice.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Slice;
    /**
     ...
     */
    readonly snssai: pulumi.Output<outputs.mobilenetwork.v20220301preview.SnssaiResponse>;
    /**
...
export interface SliceArgs {
     ...
     * The S-NSSAI (single network slice selection assistance information). Unique at the scope of a MobileNetwork.
     */
    snssai: pulumi.Input<inputs.mobilenetwork.v20220301preview.SnssaiArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
