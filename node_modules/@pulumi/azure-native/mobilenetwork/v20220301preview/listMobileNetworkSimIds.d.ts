...
export interface ListMobileNetworkSimIdsResult {
     ...
     */
    readonly value?: outputs.mobilenetwork.v20220301preview.SubResourceResponse[];
}
export declare function listMobileNetworkSimIdsOutput(args: ListMobileNetworkSimIdsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListMobileNetworkSimIdsResult>;
