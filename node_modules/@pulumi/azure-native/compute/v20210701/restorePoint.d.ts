...
export declare class RestorePoint extends pulumi.CustomResource {
     ...
     */
    readonly excludeDisks: pulumi.Output<outputs.compute.v20210701.ApiEntityReferenceResponse[] | undefined>;
    /**
     * Resource name
     */
     ...
     */
    readonly sourceMetadata: pulumi.Output<outputs.compute.v20210701.RestorePointSourceMetadataResponse>;
    /**
...
export interface RestorePointArgs {
     ...
     * List of disk resource ids that the customer wishes to exclude from the restore point. If no disks are specified, all disks will be included.
     */
    excludeDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20210701.ApiEntityReferenceArgs>[]>;
    /**
