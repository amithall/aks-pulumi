...
export declare class DiskEncryptionSet extends pulumi.CustomResource {
     ...
     */
    readonly activeKey: pulumi.Output<outputs.compute.v20200630.KeyVaultAndKeyReferenceResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.compute.v20200630.EncryptionSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    readonly previousKeys: pulumi.Output<outputs.compute.v20200630.KeyVaultAndKeyReferenceResponse[]>;
    /**
...
export interface DiskEncryptionSetArgs {
     ...
     * The key vault key which is currently used by this disk encryption set.
     */
    activeKey?: pulumi.Input<inputs.compute.v20200630.KeyVaultAndKeyReferenceArgs>;
    /**
     ...
     * The type of key used to encrypt the data of the disk.
     */
    encryptionType?: pulumi.Input<string | enums.compute.v20200630.DiskEncryptionSetType>;
    /**
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    identity?: pulumi.Input<inputs.compute.v20200630.EncryptionSetIdentityArgs>;
    /**
     * Resource location
     */
