...
export declare class DiskEncryptionSet extends pulumi.CustomResource {
     ...
     */
    readonly activeKey: pulumi.Output<outputs.compute.v20191101.KeyVaultAndKeyReferenceResponse | undefined>;
    /**
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    readonly identity: pulumi.Output<outputs.compute.v20191101.EncryptionSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    readonly previousKeys: pulumi.Output<outputs.compute.v20191101.KeyVaultAndKeyReferenceResponse[]>;
    /**
...
export interface DiskEncryptionSetArgs {
     ...
     * The key vault key which is currently used by this disk encryption set.
     */
    activeKey?: pulumi.Input<inputs.compute.v20191101.KeyVaultAndKeyReferenceArgs>;
    /**
     ...
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    identity?: pulumi.Input<inputs.compute.v20191101.EncryptionSetIdentityArgs>;
    /**
     * Resource location
     */
