...
export declare class VirtualMachineScaleSet extends pulumi.CustomResource {
     ...
     */
    readonly automaticRepairsPolicy: pulumi.Output<outputs.compute.v20190301.AutomaticRepairsPolicyResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.compute.v20190301.VirtualMachineScaleSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    readonly scaleInPolicy: pulumi.Output<outputs.compute.v20190301.ScaleInPolicyResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.compute.v20190301.SkuResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    readonly upgradePolicy: pulumi.Output<outputs.compute.v20190301.UpgradePolicyResponse | undefined>;
    /**
     * The virtual machine profile.
     */
    readonly virtualMachineProfile: pulumi.Output<outputs.compute.v20190301.VirtualMachineScaleSetVMProfileResponse | undefined>;
    /**
...
export interface VirtualMachineScaleSetArgs {
     ...
     * Specifies additional capabilities enabled or disabled on the Virtual Machines in the Virtual Machine Scale Set. For instance: whether the Virtual Machines have the capability to support attaching managed data disks with UltraSSD_LRS storage account type.
     */
    additionalCapabilities?: pulumi.Input<inputs.compute.v20190301.AdditionalCapabilitiesArgs>;
    /**
     * Policy for automatic repairs.
     */
    automaticRepairsPolicy?: pulumi.Input<inputs.compute.v20190301.AutomaticRepairsPolicyArgs>;
    /**
     * When Overprovision is enabled, extensions are launched only on the requested number of VMs which are finally kept. This property will hence ensure that the extensions do not run on the extra overprovisioned VMs.
     */
     ...
     * The identity of the virtual machine scale set, if configured.
     */
    identity?: pulumi.Input<inputs.compute.v20190301.VirtualMachineScaleSetIdentityArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use.  In the Azure portal, find the marketplace image that you want to use and then click **Want to deploy programmatically, Get Started ->**. Enter any required information and then click **Save**.
     */
    plan?: pulumi.Input<inputs.compute.v20190301.PlanArgs>;
    /**
     * Fault Domain count for each placement group.
     */
     ...
     * Specifies information about the proximity placement group that the virtual machine scale set should be assigned to. <br><br>Minimum api-version: 2018-04-01.
     */
    proximityPlacementGroup?: pulumi.Input<inputs.compute.v20190301.SubResourceArgs>;
    /**
     ...
     * Specifies the scale-in policy that decides which virtual machines are chosen for removal when a Virtual Machine Scale Set is scaled-in.
     */
    scaleInPolicy?: pulumi.Input<inputs.compute.v20190301.ScaleInPolicyArgs>;
    /**
     * When true this limits the scale set to a single placement group, of max size 100 virtual machines.
     */
     ...
     * The virtual machine scale set sku.
     */
    sku?: pulumi.Input<inputs.compute.v20190301.SkuArgs>;
    /**
     * Resource tags
     */
    tags?: pulumi.Input<{
     ...
     * The upgrade policy.
     */
    upgradePolicy?: pulumi.Input<inputs.compute.v20190301.UpgradePolicyArgs>;
    /**
     * The virtual machine profile.
     */
    virtualMachineProfile?: pulumi.Input<inputs.compute.v20190301.VirtualMachineScaleSetVMProfileArgs>;
    /**
