...
export interface GetProximityPlacementGroupResult {
     ...
     */
    readonly availabilitySets: outputs.compute.v20211101.SubResourceWithColocationStatusResponse[];
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    readonly colocationStatus?: outputs.compute.v20211101.InstanceViewStatusResponse;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly virtualMachineScaleSets: outputs.compute.v20211101.SubResourceWithColocationStatusResponse[];
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    readonly virtualMachines: outputs.compute.v20211101.SubResourceWithColocationStatusResponse[];
}
