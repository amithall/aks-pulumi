 ...
 */
export declare class VirtualMachineRunCommandByVirtualMachine extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineRunCommandByVirtualMachine;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualMachineRunCommandByVirtualMachine;
    /**
     ...
     */
    readonly instanceView: pulumi.Output<outputs.compute.v20211101.VirtualMachineRunCommandInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    readonly parameters: pulumi.Output<outputs.compute.v20211101.RunCommandInputParameterResponse[] | undefined>;
    /**
     * The parameters used by the script.
     */
    readonly protectedParameters: pulumi.Output<outputs.compute.v20211101.RunCommandInputParameterResponse[] | undefined>;
    /**
     ...
     */
    readonly source: pulumi.Output<outputs.compute.v20211101.VirtualMachineRunCommandScriptSourceResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface VirtualMachineRunCommandByVirtualMachineArgs {
     ...
     * The parameters used by the script.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.RunCommandInputParameterArgs>[]>;
    /**
     * The parameters used by the script.
     */
    protectedParameters?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.RunCommandInputParameterArgs>[]>;
    /**
     ...
     * The source of the run command script.
     */
    source?: pulumi.Input<inputs.compute.v20211101.VirtualMachineRunCommandScriptSourceArgs>;
    /**
     * Resource tags
     */
    tags?: pulumi.Input<{
