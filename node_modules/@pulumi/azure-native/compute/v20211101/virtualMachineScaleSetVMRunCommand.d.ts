 ...
 */
export declare class VirtualMachineScaleSetVMRunCommand extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineScaleSetVMRunCommand;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualMachineScaleSetVMRunCommand;
    /**
