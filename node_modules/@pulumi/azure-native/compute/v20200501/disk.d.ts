...
export declare class Disk extends pulumi.CustomResource {
     ...
     */
    readonly creationData: pulumi.Output<outputs.compute.v20200501.CreationDataResponse>;
    /**
     ...
     */
    readonly encryption: pulumi.Output<outputs.compute.v20200501.EncryptionResponse | undefined>;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    readonly encryptionSettingsCollection: pulumi.Output<outputs.compute.v20200501.EncryptionSettingsCollectionResponse | undefined>;
    /**
     ...
     */
    readonly shareInfo: pulumi.Output<outputs.compute.v20200501.ShareInfoElementResponse[]>;
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, or UltraSSD_LRS.
     */
    readonly sku: pulumi.Output<outputs.compute.v20200501.DiskSkuResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface DiskArgs {
     ...
     * Disk source information. CreationData information cannot be changed after the disk has been created.
     */
    creationData: pulumi.Input<inputs.compute.v20200501.CreationDataArgs>;
    /**
     * ARM id of the DiskAccess resource for using private endpoints on disks.
     */
     ...
     * Encryption property can be used to encrypt data at rest with customer managed keys or platform managed keys.
     */
    encryption?: pulumi.Input<inputs.compute.v20200501.EncryptionArgs>;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    encryptionSettingsCollection?: pulumi.Input<inputs.compute.v20200501.EncryptionSettingsCollectionArgs>;
    /**
     * The hypervisor generation of the Virtual Machine. Applicable to OS disks only.
     */
    hyperVGeneration?: pulumi.Input<string | enums.compute.v20200501.HyperVGeneration>;
    /**
     * Resource location
     */
     ...
     * Policy for accessing the disk via network.
     */
    networkAccessPolicy?: pulumi.Input<string | enums.compute.v20200501.NetworkAccessPolicy>;
    /**
     * The Operating System type.
     */
    osType?: pulumi.Input<enums.compute.v20200501.OperatingSystemTypes>;
    /**
     ...
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, or UltraSSD_LRS.
     */
    sku?: pulumi.Input<inputs.compute.v20200501.DiskSkuArgs>;
    /**
     * Resource tags
     */
    tags?: pulumi.Input<{
