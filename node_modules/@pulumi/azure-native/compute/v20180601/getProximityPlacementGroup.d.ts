...
export interface GetProximityPlacementGroupResult {
     ...
     */
    readonly availabilitySets: outputs.compute.v20180601.SubResourceResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly virtualMachineScaleSets: outputs.compute.v20180601.SubResourceResponse[];
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    readonly virtualMachines: outputs.compute.v20180601.SubResourceResponse[];
}
