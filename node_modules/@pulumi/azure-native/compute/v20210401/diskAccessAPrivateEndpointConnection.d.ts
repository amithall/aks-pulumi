...
export declare class DiskAccessAPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.compute.v20210401.PrivateEndpointResponse>;
    /**
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.compute.v20210401.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface DiskAccessAPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.compute.v20210401.PrivateLinkServiceConnectionStateArgs>;
    /**
