...
export declare class MachineExtension extends pulumi.CustomResource {
     ...
     */
    readonly instanceView: pulumi.Output<outputs.hybridcompute.v20191212.MachineExtensionPropertiesResponseInstanceView | undefined>;
    /**
...
export interface MachineExtensionArgs {
     ...
     * The machine extension instance view.
     */
    instanceView?: pulumi.Input<inputs.hybridcompute.v20191212.MachineExtensionPropertiesInstanceViewArgs>;
    /**
     * The geo-location where the resource lives
     */
