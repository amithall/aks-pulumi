...
export declare class MachineExtension extends pulumi.CustomResource {
     ...
     */
    readonly instanceView: pulumi.Output<outputs.hybridcompute.v20200730preview.MachineExtensionPropertiesResponseInstanceView | undefined>;
    /**
...
export interface MachineExtensionArgs {
     ...
     * The machine extension instance view.
     */
    instanceView?: pulumi.Input<inputs.hybridcompute.v20200730preview.MachineExtensionPropertiesInstanceViewArgs>;
    /**
     * The geo-location where the resource lives
     */
