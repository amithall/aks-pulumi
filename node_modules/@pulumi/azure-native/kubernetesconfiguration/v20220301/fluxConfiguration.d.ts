...
export declare class FluxConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly bucket: pulumi.Output<outputs.kubernetesconfiguration.v20220301.BucketDefinitionResponse | undefined>;
    /**
     ...
     */
    readonly gitRepository: pulumi.Output<outputs.kubernetesconfiguration.v20220301.GitRepositoryDefinitionResponse | undefined>;
    /**
     ...
     */
    readonly sourceSyncedCommitId: pulumi.Output<string>;
    /**
     * Datetime the fluxConfiguration synced its source on the cluster.
     */
    readonly sourceUpdatedAt: pulumi.Output<string>;
    /**
     ...
     */
    readonly statuses: pulumi.Output<outputs.kubernetesconfiguration.v20220301.ObjectStatusDefinitionResponse[]>;
    /**
...
export interface FluxConfigurationArgs {
    ...
    kustomizations?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.kubernetesconfiguration.v20220301.KustomizationDefinitionArgs>;
    }>;
    /**
     * The namespace to which this configuration is installed to. Maximum of 253 lower case alphanumeric characters, hyphen and period only.
     */
