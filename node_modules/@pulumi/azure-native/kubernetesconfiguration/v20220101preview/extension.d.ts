...
export declare class Extension extends pulumi.CustomResource {
     ...
     */
    readonly aksAssignedIdentity: pulumi.Output<outputs.kubernetesconfiguration.v20220101preview.ExtensionResponseAksAssignedIdentity | undefined>;
    /**
     ...
     */
    readonly errorInfo: pulumi.Output<outputs.kubernetesconfiguration.v20220101preview.ErrorDetailResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.kubernetesconfiguration.v20220101preview.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly scope: pulumi.Output<outputs.kubernetesconfiguration.v20220101preview.ScopeResponse | undefined>;
    /**
     * Status from this extension.
     */
    readonly statuses: pulumi.Output<outputs.kubernetesconfiguration.v20220101preview.ExtensionStatusResponse[] | undefined>;
    /**
...
export interface ExtensionArgs {
     ...
     * Identity of the Extension resource in an AKS cluster
     */
    aksAssignedIdentity?: pulumi.Input<inputs.kubernetesconfiguration.v20220101preview.ExtensionAksAssignedIdentityArgs>;
    /**
     * Flag to note if this extension participates in auto upgrade of minor version, or not.
     */
     ...
     * Identity of the Extension resource
     */
    identity?: pulumi.Input<inputs.kubernetesconfiguration.v20220101preview.IdentityArgs>;
    /**
     * ReleaseTrain this extension participates in for auto-upgrade (e.g. Stable, Preview, etc.) - only if autoUpgradeMinorVersion is 'true'.
     */
     ...
     * Scope at which the extension is installed.
     */
    scope?: pulumi.Input<inputs.kubernetesconfiguration.v20220101preview.ScopeArgs>;
    /**
     * Status from this extension.
     */
    statuses?: pulumi.Input<pulumi.Input<inputs.kubernetesconfiguration.v20220101preview.ExtensionStatusArgs>[]>;
    /**
     * Version of the extension for this extension, if it is 'pinned' to a specific version. autoUpgradeMinorVersion must be 'false'.
     */
