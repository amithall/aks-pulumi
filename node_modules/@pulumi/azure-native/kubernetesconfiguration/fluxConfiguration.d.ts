...
export declare class FluxConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly gitRepository: pulumi.Output<outputs.kubernetesconfiguration.GitRepositoryDefinitionResponse | undefined>;
    /**
     ...
     */
    readonly statuses: pulumi.Output<outputs.kubernetesconfiguration.ObjectStatusDefinitionResponse[]>;
    /**
...
export interface FluxConfigurationArgs {
    ...
    kustomizations?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.kubernetesconfiguration.KustomizationDefinitionArgs>;
    }>;
    /**
     * The namespace to which this configuration is installed to. Maximum of 253 lower case alphanumeric characters, hyphen and period only.
     */
