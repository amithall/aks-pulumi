...
export declare class FluxConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly gitRepository: pulumi.Output<outputs.kubernetesconfiguration.v20211101preview.GitRepositoryDefinitionResponse | undefined>;
    /**
     * Array of kustomizations used to reconcile the artifact pulled by the source type on the cluster.
     */
    readonly kustomizations: pulumi.Output<{
        [key: string]: outputs.kubernetesconfiguration.v20211101preview.KustomizationDefinitionResponse;
    } | undefined>;
    /**
     * Datetime the fluxConfiguration last synced its source on the cluster.
     */
    readonly lastSourceSyncedAt: pulumi.Output<string>;
    /**
     * Branch and SHA of the last source commit synced with the cluster.
     */
    readonly lastSourceSyncedCommitId: pulumi.Output<string>;
    /**
     ...
     */
    readonly statuses: pulumi.Output<outputs.kubernetesconfiguration.v20211101preview.ObjectStatusDefinitionResponse[]>;
    /**
...
export interface FluxConfigurationArgs {
    ...
    kustomizations?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.kubernetesconfiguration.v20211101preview.KustomizationDefinitionArgs>;
    }>;
    /**
     * The namespace to which this configuration is installed to. Maximum of 253 lower case alphanumeric characters, hyphen and period only.
     */
