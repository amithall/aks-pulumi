...
export declare class PeerAsn extends pulumi.CustomResource {
     ...
     */
    readonly peerContactDetail: pulumi.Output<outputs.peering.v20200101preview.ContactDetailResponse[] | undefined>;
    /**
     ...
     */
    readonly validationState: pulumi.Output<string | undefined>;
    /**
...
export interface PeerAsnArgs {
     ...
     * The contact details of the peer.
     */
    peerContactDetail?: pulumi.Input<pulumi.Input<inputs.peering.v20200101preview.ContactDetailArgs>[]>;
    /**
     * The name of the peer.
     */
     ...
     * The validation state of the ASN associated with the peer.
     */
    validationState?: pulumi.Input<string | enums.peering.v20200101preview.ValidationState>;
}
