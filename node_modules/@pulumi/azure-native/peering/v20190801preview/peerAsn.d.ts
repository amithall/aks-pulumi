...
export declare class PeerAsn extends pulumi.CustomResource {
     ...
     */
    readonly peerContactInfo: pulumi.Output<outputs.peering.v20190801preview.ContactInfoResponse | undefined>;
    /**
...
export interface PeerAsnArgs {
     ...
     * The contact information of the peer.
     */
    peerContactInfo?: pulumi.Input<inputs.peering.v20190801preview.ContactInfoArgs>;
    /**
     * The name of the peer.
     */
     ...
     * The validation state of the ASN associated with the peer.
     */
    validationState?: pulumi.Input<string | enums.peering.v20190801preview.ValidationState>;
}
