...
export declare class Peering extends pulumi.CustomResource {
     ...
     */
    readonly direct: pulumi.Output<outputs.peering.v20220101.PeeringPropertiesDirectResponse | undefined>;
    /**
     * The properties that define an exchange peering.
     */
    readonly exchange: pulumi.Output<outputs.peering.v20220101.PeeringPropertiesExchangeResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.peering.v20220101.PeeringSkuResponse>;
    /**
     * The resource tags.
     */
...
export interface PeeringArgs {
     ...
     * The properties that define a direct peering.
     */
    direct?: pulumi.Input<inputs.peering.v20220101.PeeringPropertiesDirectArgs>;
    /**
     * The properties that define an exchange peering.
     */
    exchange?: pulumi.Input<inputs.peering.v20220101.PeeringPropertiesExchangeArgs>;
    /**
     * The kind of the peering.
     */
    kind: pulumi.Input<string | enums.peering.v20220101.Kind>;
    /**
     * The location of the resource.
     */
     ...
     * The SKU that defines the tier and kind of the peering.
     */
    sku: pulumi.Input<inputs.peering.v20220101.PeeringSkuArgs>;
    /**
     * The resource tags.
     */
    tags?: pulumi.Input<{
