...
export declare class PeerAsn extends pulumi.CustomResource {
     ...
     */
    readonly peerContactDetail: pulumi.Output<outputs.peering.v20220101.ContactDetailResponse[] | undefined>;
    /**
...
export interface PeerAsnArgs {
     ...
     * The contact details of the peer.
     */
    peerContactDetail?: pulumi.Input<pulumi.Input<inputs.peering.v20220101.ContactDetailArgs>[]>;
    /**
     * The name of the peer.
     */
