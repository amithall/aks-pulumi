...
export declare class PeerAsn extends pulumi.CustomResource {
     ...
     */
    readonly peerContactDetail: pulumi.Output<outputs.peering.v20201001.ContactDetailResponse[] | undefined>;
    /**
...
export interface PeerAsnArgs {
     ...
     * The contact details of the peer.
     */
    peerContactDetail?: pulumi.Input<pulumi.Input<inputs.peering.v20201001.ContactDetailArgs>[]>;
    /**
     * The name of the peer.
     */
     ...
     * The validation state of the ASN associated with the peer.
     */
    validationState?: pulumi.Input<string | enums.peering.v20201001.ValidationState>;
}
