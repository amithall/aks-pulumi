...
export declare class PeeringService extends pulumi.CustomResource {
     ...
     */
    readonly sku: pulumi.Output<outputs.peering.v20201001.PeeringServiceSkuResponse | undefined>;
    /**
     * The resource tags.
     */
...
export interface PeeringServiceArgs {
     ...
     * The SKU that defines the type of the peering service.
     */
    sku?: pulumi.Input<inputs.peering.v20201001.PeeringServiceSkuArgs>;
    /**
     * The resource tags.
     */
    tags?: pulumi.Input<{
