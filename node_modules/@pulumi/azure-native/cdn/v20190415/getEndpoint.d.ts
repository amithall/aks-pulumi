...
export interface GetEndpointResult {
     ...
     */
    readonly deliveryPolicy?: outputs.cdn.v20190415.EndpointPropertiesUpdateParametersResponseDeliveryPolicy;
    /**
     * List of rules defining the user's geo access within a CDN endpoint. Each geo filter defines an access rule to a specified path or content, e.g. block APAC for path /pictures/
     */
    readonly geoFilters?: outputs.cdn.v20190415.GeoFilterResponse[];
    /**
     ...
     */
    readonly origins: outputs.cdn.v20190415.DeepCreatedOriginResponse[];
    /**
