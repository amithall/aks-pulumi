...
export declare class Endpoint extends pulumi.CustomResource {
     ...
     */
    readonly defaultOriginGroup: pulumi.Output<outputs.cdn.v20191231.ResourceReferenceResponse | undefined>;
    /**
     * A policy that specifies the delivery rules to be used for an endpoint.
     */
    readonly deliveryPolicy: pulumi.Output<outputs.cdn.v20191231.EndpointPropertiesUpdateParametersResponseDeliveryPolicy | undefined>;
    /**
     * List of rules defining the user's geo access within a CDN endpoint. Each geo filter defines an access rule to a specified path or content, e.g. block APAC for path /pictures/
     */
    readonly geoFilters: pulumi.Output<outputs.cdn.v20191231.GeoFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly originGroups: pulumi.Output<outputs.cdn.v20191231.DeepCreatedOriginGroupResponse[] | undefined>;
    /**
     ...
     */
    readonly origins: pulumi.Output<outputs.cdn.v20191231.DeepCreatedOriginResponse[]>;
    /**
...
export interface EndpointArgs {
     ...
     * A reference to the origin group.
     */
    defaultOriginGroup?: pulumi.Input<inputs.cdn.v20191231.ResourceReferenceArgs>;
    /**
     * A policy that specifies the delivery rules to be used for an endpoint.
     */
    deliveryPolicy?: pulumi.Input<inputs.cdn.v20191231.EndpointPropertiesUpdateParametersDeliveryPolicyArgs>;
    /**
     ...
     * List of rules defining the user's geo access within a CDN endpoint. Each geo filter defines an access rule to a specified path or content, e.g. block APAC for path /pictures/
     */
    geoFilters?: pulumi.Input<pulumi.Input<inputs.cdn.v20191231.GeoFilterArgs>[]>;
    /**
     * Indicates whether content compression is enabled on CDN. Default value is false. If compression is enabled, content will be served as compressed if user requests for a compressed version. Content won't be compressed on CDN when requested content is smaller than 1 byte or larger than 1 MB.
     */
     ...
     * Specifies what scenario the customer wants this CDN endpoint to optimize for, e.g. Download, Media services. With this information, CDN can apply scenario driven optimization.
     */
    optimizationType?: pulumi.Input<string | enums.cdn.v20191231.OptimizationType>;
    /**
     * The origin groups comprising of origins that are used for load balancing the traffic based on availability.
     */
    originGroups?: pulumi.Input<pulumi.Input<inputs.cdn.v20191231.DeepCreatedOriginGroupArgs>[]>;
    /**
     * The host header value sent to the origin with each request. This property at Endpoint can only be set allowed when endpoint uses single origin. If you leave this blank, the request hostname determines this value. Azure CDN origins, such as Web Apps, Blob Storage, and Cloud Services require this host header value to match the origin hostname by default.
     */
     ...
     * The source of the content being delivered via CDN.
     */
    origins: pulumi.Input<pulumi.Input<inputs.cdn.v20191231.DeepCreatedOriginArgs>[]>;
    /**
     * Path to a file hosted on the origin which helps accelerate delivery of the dynamic content and calculate the most optimal routes for the CDN. This is relative to the origin path. This property is only relevant when using a single origin.
     */
     ...
     * Defines how CDN caches requests that include query strings. You can ignore any query strings when caching, bypass caching to prevent requests that contain query strings from being cached, or cache every request with a unique URL.
     */
    queryStringCachingBehavior?: pulumi.Input<enums.cdn.v20191231.QueryStringCachingBehavior>;
    /**
