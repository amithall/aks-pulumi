...
export declare class Endpoint extends pulumi.CustomResource {
     ...
     */
    readonly deliveryPolicy: pulumi.Output<outputs.cdn.v20171012.EndpointPropertiesUpdateParametersResponseDeliveryPolicy | undefined>;
    /**
     * List of rules defining the user's geo access within a CDN endpoint. Each geo filter defines an access rule to a specified path or content, e.g. block APAC for path /pictures/
     */
    readonly geoFilters: pulumi.Output<outputs.cdn.v20171012.GeoFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly origins: pulumi.Output<outputs.cdn.v20171012.DeepCreatedOriginResponse[]>;
    /**
