...
export interface EndpointArgs {
     ...
     * The set of origins for the CDN endpoint. When multiple origins exist, the first origin will be used as primary and rest will be used as failover options.
     */
    origins: pulumi.Input<pulumi.Input<inputs.cdn.v20150601.DeepCreatedOriginArgs>[]>;
    /**
     ...
     * Defines the query string caching behavior.
     */
    queryStringCachingBehavior?: pulumi.Input<enums.cdn.v20150601.QueryStringCachingBehavior>;
    /**
