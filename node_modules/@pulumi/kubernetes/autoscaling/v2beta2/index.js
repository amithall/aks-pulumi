...
const _module = {
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:autoscaling/v2beta2:HorizontalPodAutoscaler":
                return new horizontalPodAutoscaler_1.HorizontalPodAutoscaler(name, undefined, { urn });
            case "kubernetes:autoscaling/v2beta2:HorizontalPodAutoscalerList":
...
pulumi.runtime.registerResourceModule("kubernetes", "autoscaling/v2beta2", _module);
