...
class Chart extends yaml.CollectionComponentResource {
    ...
    parseChart(config, releaseName, opts) {
        ...
        let invokeOpts = {
            async: true,
            version: (_b = opts === null || opts === void 0 ? void 0 : opts.version) !== null && _b !== void 0 ? _b : (0, utilities_1.getVersion)(),
            provider: opts === null || opts === void 0 ? void 0 : opts.provider,
            parent: opts === null || opts === void 0 ? void 0 : opts.parent
        };
