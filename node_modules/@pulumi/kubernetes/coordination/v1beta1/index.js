...
__exportStar(require("./leaseList"), exports);
// Import resources to register:
const lease_1 = require("./lease");
const leaseList_1 = require("./leaseList");
const _module = {
    version: utilities.getVersion(),
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:coordination.k8s.io/v1beta1:Lease":
                return new lease_1.Lease(name, undefined, { urn });
            case "kubernetes:coordination.k8s.io/v1beta1:LeaseList":
                return new leaseList_1.LeaseList(name, undefined, { urn });
            default:
