...
__exportStar(require("./cronJobList"), exports);
__exportStar(require("./job"), exports);
__exportStar(require("./jobList"), exports);
// Import resources to register:
const cronJob_1 = require("./cronJob");
const cronJobList_1 = require("./cronJobList");
const job_1 = require("./job");
const jobList_1 = require("./jobList");
const _module = {
    version: utilities.getVersion(),
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:batch/v1:CronJob":
                return new cronJob_1.CronJob(name, undefined, { urn });
            case "kubernetes:batch/v1:CronJobList":
                return new cronJobList_1.CronJobList(name, undefined, { urn });
            case "kubernetes:batch/v1:Job":
                return new job_1.Job(name, undefined, { urn });
            case "kubernetes:batch/v1:JobList":
                return new jobList_1.JobList(name, undefined, { urn });
            default:
